// This is brl/vidpro/process/vidpro_motion_process.h
#ifndef vidpro_motion_process_h_
#define vidpro_motion_process_h_
...
class vidpro_motion_process : public bpro_process {

public:

  vidpro_motion_process();
  virtual ~vidpro_motion_process();
