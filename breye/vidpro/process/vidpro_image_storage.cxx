// This is brl/vidpro/storage/vidpro_image_storage.cxx

//:
// \file

#include "vidpro_image_storage.h"
...
//: Constructor
vidpro_image_storage::vidpro_image_storage()
{
}
...
short 
vidpro_image_storage::version() const
{
  return 3;
}
...
bpro_storage* 
vidpro_image_storage::clone() const
{
  return new vidpro_image_storage(*this);
}


//: Binary save self to stream.
void 
vidpro_image_storage::b_write(vsl_b_ostream &os) const
{
...
void 
vidpro_image_storage::b_read(vsl_b_istream &is)
{
  if (!is) return;
  ...
  default:
    vcl_cerr << "I/O ERROR: vidpro_image_storage::b_read(vsl_b_istream&)\n"
...
vidpro_image_storage::get_image()
{
  return image_;
}
...
void
vidpro_image_storage::set_image( const vil_image_resource_sptr& img )
{
  image_ = img;
}
