// This is breye/vidpro/process/vidpro_equalize_images_process.cxx

//:
// \file

#include "vidpro_equalize_images_process.h"
...
//: Constructor
vidpro_equalize_images_process::vidpro_equalize_images_process()
{
...
//: Clone the process
bpro_process* 
vidpro_equalize_images_process::clone() const
{
  return new vidpro_equalize_images_process(*this);
}


//: Return the name of this process
vcl_string
vidpro_equalize_images_process::name()
{
...
int
vidpro_equalize_images_process::input_frames()
{
  return 1;
}
...
int
vidpro_equalize_images_process::output_frames()
{
  return 1;
}
...
vcl_vector< vcl_string > vidpro_equalize_images_process::get_input_type()
{
  bool mask = false;
...
vcl_vector< vcl_string > vidpro_equalize_images_process::get_output_type()
{  
  vcl_vector<vcl_string > to_return;
  to_return.push_back( "image" );
  return to_return;
...
//: Execute the process
bool
vidpro_equalize_images_process::execute()
{
  if ( input_data_.size() != 1 ){
    vcl_cout << "In vidpro_equalize_images_process::execute() - "
  ...
  if(model_.size() == 0){
    ...
    if(use_mask){
      ...
      vidpro_image_storage_sptr frame_mask;
...
bool
vidpro_equalize_images_process::finish()
{
  model_ = NULL;
  mask_ = NULL;
  return true;
