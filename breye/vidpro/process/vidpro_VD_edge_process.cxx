// This is brl/vidpro/process/vidpro_VD_edge_process.cxx
...
//: Constructor
vidpro_VD_edge_process::vidpro_VD_edge_process()
{
...
//: Clone the process
bpro_process* 
vidpro_VD_edge_process::clone() const
{
  return new vidpro_VD_edge_process(*this);
}


//: Return the name of this process
vcl_string
vidpro_VD_edge_process::name()
{
...
int
vidpro_VD_edge_process::input_frames()
{
  return 1;
}
...
int
vidpro_VD_edge_process::output_frames()
{
  return 1;
}
...
vidpro_VD_edge_process::get_input_type()
{
...
vcl_vector< vcl_string > 
vidpro_VD_edge_process::get_output_type()
{  
  vcl_vector<vcl_string > to_return;
...
//: Execute the process
bool
vidpro_VD_edge_process::execute()
{
  if ( input_data_.size() != 1 ){
    vcl_cout << "In vidpro_VD_Edge_process::execute() - not exactly one"
