// This is brl/vidpro/process/vidpro_save_video_process.cxx
...
//: Constructor
vidpro_save_video_process::vidpro_save_video_process() 
 : bpro_process(), sample_counter_(0), first_frame_(true), num_frames_(0)
{
...
//: Clone the process
bpro_process*
vidpro_save_video_process::clone() const
{
  return new vidpro_save_video_process(*this);
}


//: Return the name of the process
vcl_string vidpro_save_video_process::name()
{
  return "Save Video";
}
...
void
vidpro_save_video_process::clear_output()
{
...
vidpro_save_video_process::get_input_type()
{
...
vcl_vector< vcl_string >
vidpro_save_video_process::get_output_type()
{
  vcl_vector< vcl_string > to_return;
  to_return.clear();
...
int
vidpro_save_video_process::input_frames()
{
  return 1;
}
...
int
vidpro_save_video_process::output_frames()
{
  return 0;
}
...
bool
vidpro_save_video_process::execute()
{
  ...
  vidpro_image_storage_sptr foreground_image;
...
//: Finish
bool
vidpro_save_video_process::finish() 
{
...
vcl_vector<vcl_string> vidpro_save_video_process::list_to_vector(vcl_list<vcl_string>  v)
{
