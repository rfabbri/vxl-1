// This is brl/vidpro/process/vidpro_background_diff_process.cxx

//:
// \file

#include "vidpro_background_diff_process.h"
...
//: Constructor
vidpro_background_diff_process::vidpro_background_diff_process()
{
}
...
int
vidpro_background_diff_process::input_frames()
{
  return 1;
}
...
int
vidpro_background_diff_process::output_frames()
{
  return 1;
}
...
//: Clone the process
bpro_process*
vidpro_background_diff_process::clone() const
{
  return new vidpro_background_diff_process(*this);
}
//: Execute the process
bool
...
bool
vidpro_background_diff_process::finish()
{
  return true;
}
