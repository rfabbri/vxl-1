// This is brcv/mvg/dvpgl/algo/pro/vidpro_vsol_scale_process.cxx

//:
// \file

#include "vidpro_vsol_scale_process.h"
...
//: Constructor
vidpro_vsol_scale_process::vidpro_vsol_scale_process()
{
...
//: Clone the process
bpro_process* 
vidpro_vsol_scale_process::clone() const
{
  return new vidpro_vsol_scale_process(*this);
}


//: Return the name of the process
vcl_string
vidpro_vsol_scale_process::name()
{
  return "Scale vsol";
}
...
vidpro_vsol_scale_process::get_input_type()
{
...
vcl_vector< vcl_string > 
vidpro_vsol_scale_process::get_output_type()
{
  vcl_vector< vcl_string > to_return;
  to_return.push_back( "vsol2D" );
  return to_return;
...
int
vidpro_vsol_scale_process::input_frames()
{
  return 1;
}
...
int
vidpro_vsol_scale_process::output_frames()
{
  return 1;
}
...
bool
vidpro_vsol_scale_process::execute()
{
  ...
  vidpro_vsol2D_storage_sptr frame_vsol;
...
//: Finish
bool
vidpro_vsol_scale_process::finish()
{
  return true;
}
