// This is brl/vidpro/process/vidpro_motion_process.cxx

//:
// \file

#include "vidpro_motion_process.h"
...
//: Constructor
vidpro_motion_process::vidpro_motion_process()
{
...
//: Clone the process
bpro_process* 
vidpro_motion_process::clone() const
{
  return new vidpro_motion_process(*this);
}


//: Return the name of this process
vcl_string
vidpro_motion_process::name()
{
...
int
vidpro_motion_process::input_frames()
{
  return 2;
}
...
int
vidpro_motion_process::output_frames()
{
  return 1;
}
...
vcl_vector< vcl_string > vidpro_motion_process::get_input_type()
{
...
vcl_vector< vcl_string > vidpro_motion_process::get_output_type()
{  
  vcl_vector<vcl_string > to_return;
  to_return.push_back( "image" );
  return to_return;
...
//: Execute the process
bool
vidpro_motion_process::execute()
{
  if ( input_data_.size() != 2 ){
    vcl_cout << "In vidpro_motion_process::execute() - not exactly two"
             << " input images \n";
    return false;
  }
  clear_output();
...
void
vidpro_motion_process::compute_motion( const vil_image_view<float>& img1,
