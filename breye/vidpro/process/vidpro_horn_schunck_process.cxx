// This is brl/vidpro/process/vidpro_horn_schunck_process.cxx

//:
// \file

#include "vidpro_horn_schunck_process.h"
...
//: Constructor
vidpro_horn_schunck_process::vidpro_horn_schunck_process()
{
...
//: Clone the process
bpro_process* 
vidpro_horn_schunck_process::clone() const
{
  return new vidpro_horn_schunck_process(*this);
}


//: Return the name of this process
vcl_string
vidpro_horn_schunck_process::name()
{
...
int
vidpro_horn_schunck_process::input_frames()
{
  return 2;
}
...
int
vidpro_horn_schunck_process::output_frames()
{
  return 1;
}
...
vcl_vector< vcl_string > vidpro_horn_schunck_process::get_input_type()
{
...
vcl_vector< vcl_string > vidpro_horn_schunck_process::get_output_type()
{  
  vcl_vector<vcl_string > to_return;
  to_return.push_back( "image" );
  return to_return;
...
void vidpro_horn_schunck_process::
...
//: Execute the process
bool
vidpro_horn_schunck_process::execute()
{
  if ( input_data_.size() != 2 ){
    vcl_cout << "In vidpro_horn_schunck_process::execute() - not exactly two"
             << " input images \n";
    return false;
  }
    ...
    if(result == -1)
      {
        vcl_cout << "Warning! input images are equal " 
                 << "in vidpro_horn_schunck_process\n";
...
bool
vidpro_horn_schunck_process::finish()
{
  return true;
}
