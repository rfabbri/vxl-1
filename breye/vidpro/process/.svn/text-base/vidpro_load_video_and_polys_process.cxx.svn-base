// This is brl/vidpro/process/vidpro_load_video_and_polys_process.cxx
...
//: Constructor
vidpro_load_video_and_polys_process::vidpro_load_video_and_polys_process() : bpro_process(), num_frames_(0)
{
    if( !parameters()->add( "Video file <filename...>" , "-video_filename", bpro_filepath("","*") )||
        !parameters()->add( "Poly file <filename...>" , "-poly_filename", bpro_filepath("","*.txt") )||
...
//: Destructor
vidpro_load_video_and_polys_process::~vidpro_load_video_and_polys_process()
{
}
...
//: Clone the process
bpro_process*
vidpro_load_video_and_polys_process::clone() const
{
    return new vidpro_load_video_and_polys_process(*this);
}
...
void
vidpro_load_video_and_polys_process::clear_output(int resize)
{
  num_frames_ = 0;
...
int
vidpro_load_video_and_polys_process::input_frames()
{
    return 0;
}
...
int
vidpro_load_video_and_polys_process::output_frames()
{
    return num_frames_;
}
...
bool
vidpro_load_video_and_polys_process::execute()
{
    bpro_filepath video_path;
    bpro_filepath poly_path;
    ...
    //create a new mapper
    /*bvis_mapper_sptr mapper = new bvis_mapper(mina, maxa, gamma);
...
//: Finish
bool
vidpro_load_video_and_polys_process::finish() 
{
    return true;
}
