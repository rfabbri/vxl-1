...
class vidpro_open_live_istream_process : public bpro_process
{
 ...
 ~vidpro_open_live_istream_process();
  ...
  static vidpro_istream_storage_sptr dshow_live_istream(vcl_string const& ,vcl_string const&);
 ...
 void add_parameters();
 vidpro_istream_storage_sptr open_live_istream(int, vcl_string const&, vcl_string const&);
