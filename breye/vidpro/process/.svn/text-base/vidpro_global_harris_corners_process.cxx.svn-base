// This is brl/vidpro/process/vidpro_global_harris_corners_process.cxx

//:
// \file

#include "vidpro_global_harris_corners_process.h"
...
//: Constructor
vidpro_global_harris_corners_process::vidpro_global_harris_corners_process() : bpro_process()
{
...
//: Destructor
vidpro_global_harris_corners_process::~vidpro_global_harris_corners_process()
{
}
...
//: Clone the process
bpro_process* 
vidpro_global_harris_corners_process::clone() const
{
  return new vidpro_global_harris_corners_process(*this);
}


//: Return the name of the process
vcl_string
vidpro_global_harris_corners_process::name()
{
  return "Crazy Global Harris Corners";
}


//: Returns a vector of strings describing the input types to this process
vcl_vector< vcl_string > vidpro_global_harris_corners_process::get_input_type()
{
...
vcl_vector< vcl_string > vidpro_global_harris_corners_process::get_output_type()
{
  vcl_vector< vcl_string > to_return;
...
bool
vidpro_global_harris_corners_process::execute()
{
  if ( input_data_.size() != 1 ){
    vcl_cout << "In vidpro_global_harris_corner_process::execute() - not exactly one"
          << " input image \n";
    return false;
  }
  clear_output();
...
//: Finish
bool
vidpro_global_harris_corners_process::finish()
{
  return true;
}
...
int
vidpro_global_harris_corners_process::input_frames()
{
  return 1;
}
...
int
vidpro_global_harris_corners_process::output_frames()
{
  return 1;
}
