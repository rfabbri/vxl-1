// This is basic/dbil/pro/vidpro_RGB_to_CIELab_process.cxx

//:
// \file

#include "vidpro_RGB_to_CIELab_process.h"
...
//: Constructor
vidpro_RGB_to_CIELab_process::vidpro_RGB_to_CIELab_process()
{
...
//: Clone the process
bpro_process* 
vidpro_RGB_to_CIELab_process::clone() const
{
  return new vidpro_RGB_to_CIELab_process(*this);
}
...
int
vidpro_RGB_to_CIELab_process::input_frames()
{
  return 1;
}
...
int
vidpro_RGB_to_CIELab_process::output_frames()
{
  return 1;
}
...
vidpro_RGB_to_CIELab_process::execute()
{
  ...
  if (bComps){
    ...
    vidpro_image_storage_sptr output_storage1 = vidpro_image_storage_new();
    vidpro_image_storage_sptr output_storage2 = vidpro_image_storage_new();
    vidpro_image_storage_sptr output_storage3 = vidpro_image_storage_new();
...
bool
vidpro_RGB_to_CIELab_process::finish()
{
  return true;
}

void vidpro_RGB_to_CIELab_process::rgb2lab(double R, double G, double B, double &L , double &a, double &b)
{
...
void vidpro_RGB_to_CIELab_process::convert_to_Lab(vil_image_view<unsigned char> const& image,
