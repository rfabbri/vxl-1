...
vidpro_vsol2D_storage::b_read(vsl_b_istream &is)
{
  ...
  default:
    vcl_cerr << "I/O ERROR: vidpro_vsol2D_storage::b_read(vsl_b_istream&)\n"
...
void
vidpro_vsol2D_storage::add_objects( const vcl_vector< vsol_spatial_object_2d_sptr >& objects,  
...
vidpro_vsol2D_storage::data_named( const vcl_string& which) const
{
...
vcl_vector<double> vidpro_vsol2D_storage::
...
vcl_vector< double > vidpro_vsol2D_storage::all_attributes() const
{
  if(!has_attributes_)
    return vcl_vector<double>();
