...
/*************************************************************************
 * Function Name: bvis_vsol2D_tool::bvis_vsol2D_tool
 * Parameters: 
 * Effects: 
 *************************************************************************/

bvis_vsol2D_tool::bvis_vsol2D_tool()
{
}
...
/*************************************************************************
 * Function Name: bvis_vsol2D_tool::set_tableau
 * Parameters:  vgui_tableau_sptr tableau 
 * Returns: void
 * Effects: 
 *************************************************************************/
bool
bvis_vsol2D_tool::set_tableau( const vgui_tableau_sptr& tableau )
{
...
/*************************************************************************
 * Function Name: bvis_vsol2D_tool::tableau
 * Parameters:
 * Returns: bui_vsol2D_tableau_sptr
 * Effects:
 *************************************************************************/
bgui_vsol2D_tableau_sptr
bvis_vsol2D_tool::tableau()
{
  return tableau_;
}

/*************************************************************************
 * Function Name: bvis_vsol2D_tool::storage
 * Parameters:
 * Returns: vidpro_vsol2D_storage_sptr
 * Effects:
 *************************************************************************/
vidpro_vsol2D_storage_sptr
bvis_vsol2D_tool::storage()
{
  vidpro_vsol2D_storage_sptr vsol_storage;
  vsol_storage.vertical_cast(output_data_[0][0]);
  return vsol_storage;
}
/*************************************************************************
...
vcl_vector< vcl_string > bvis_vsol2D_tool::get_output_type()
{
  ...
  //set default output storage name
void bvis_vsol2D_tool::generate_output_names()
{
  output_names_.clear();
  output_names_.push_back( "vsol2D_tool_output");
}

bpro_storage_sptr bvis_vsol2D_tool::active_storage()
{
  return storage();
}
...
class bvis_vsol_group_command : public vgui_command
{
  public:
...
void 
bvis_vsol2D_tool::get_popup(const vgui_popup_params& params, vgui_menu &menu)
{
...
/*************************************************************************
 * Function Name: bvis_vsol2D_point_tool::bvis_vsol2D_point_tool
 * Parameters:
 * Effects:
 *************************************************************************/

bvis_vsol2D_point_tool::bvis_vsol2D_point_tool()
{
...
/*************************************************************************
 * Function Name: bvis_vsol2D_point_tool::handle
 * Parameters:  const vgui_event & e
 * Returns: bool
 * Effects:
 *************************************************************************/
bool
bvis_vsol2D_point_tool::handle( const vgui_event & e, 
...
/*************************************************************************
 * Function Name: bvis_vsol2D_line_tool::bvis_vsol2D_line_tool
 * Parameters:
 * Effects:
 *************************************************************************/

bvis_vsol2D_line_tool::bvis_vsol2D_line_tool()
{
  gesture0 = vgui_event_condition(vgui_LEFT, vgui_MODIFIER_NULL, true);
...
/*************************************************************************
 * Function Name: bvis_vsol2D_line_tool::handle
 * Parameters:  const vgui_event & e
 * Returns: bool
 * Effects:
 *************************************************************************/
bool
bvis_vsol2D_line_tool::handle( const vgui_event & e, 
                               const bvis_view_tableau_sptr& view )
{
  float ix, iy;
  vgui_projection_inspector().window_to_image_coordinates(e.wx, e.wy, ix, iy);
...
/*************************************************************************
 * Function Name: bvis_vsol2D_line_tool::reset
 * Parameters:
 * Returns: void
 * Effects:
 *************************************************************************/
void
bvis_vsol2D_line_tool::deactivate()
{
  active = false;
}
...
/*************************************************************************
 * Function Name: bvis_vsol2D_polyline_tool::bvis_vsol2D_polyline_tool
 * Parameters:
 * Effects:
 *************************************************************************/

bvis_vsol2D_polyline_tool::bvis_vsol2D_polyline_tool()
{
  active = false;
  gesture0 = vgui_event_condition(vgui_LEFT, vgui_MODIFIER_NULL, true);
...
/*************************************************************************
 * Function Name: bvis_vsol2D_polyline_tool::handle
 * Parameters:  const vgui_event & e
 * Returns: bool
 * Effects:
 *************************************************************************/
bool
bvis_vsol2D_polyline_tool::handle( const vgui_event & e, 
                                   const bvis_view_tableau_sptr& view )
{
  float ix, iy;
  vgui_projection_inspector().window_to_image_coordinates(e.wx, e.wy, ix, iy);
...
/*************************************************************************
 * Function Name: bvis_vsol2D_polyline_tool::reset
 * Parameters:
 * Returns: void
 * Effects:
 *************************************************************************/
void
bvis_vsol2D_polyline_tool::deactivate()
{
  active = false;
  point_list.clear();
}
...
/*************************************************************************
 * Function Name: bvis_vsol2D_polygon_tool::bvis_vsol2D_polygon_tool
 * Parameters:
 * Effects:
 *************************************************************************/

bvis_vsol2D_polygon_tool::bvis_vsol2D_polygon_tool()
{
  active = false;
  gesture0 = vgui_event_condition(vgui_LEFT, vgui_MODIFIER_NULL, true);
  gesture1 = vgui_event_condition(vgui_MIDDLE, vgui_MODIFIER_NULL, true);
...
/*************************************************************************
 * Function Name: bvis_vsol2D_polygon_tool::handle
 * Parameters:  const vgui_event & e
 * Returns: bool
 * Effects:
 *************************************************************************/
bool
bvis_vsol2D_polygon_tool::handle( const vgui_event & e, 
                                  const bvis_view_tableau_sptr& view )
{
  float ix, iy;
  vgui_projection_inspector().window_to_image_coordinates(e.wx, e.wy, ix, iy);
...
/*************************************************************************
 * Function Name: bvis_vsol2D_polygon_tool::reset
 * Parameters: 
 * Returns: void
 * Effects: 
 *************************************************************************/
void
bvis_vsol2D_polygon_tool::deactivate()
{
  active = false;
  point_list.clear();
}
...
//: Constructor
bvis_vsol2D_digital_curve_tool::bvis_vsol2D_digital_curve_tool()
{
  active = false;
  gesture0 = vgui_event_condition(vgui_LEFT, vgui_MODIFIER_NULL, true);
  gesture1 = vgui_event_condition(vgui_MIDDLE, vgui_MODIFIER_NULL, true);
...
//: Handle mouse clicks
bool
bvis_vsol2D_digital_curve_tool::handle( const vgui_event & e, 
                                        const bvis_view_tableau_sptr& view )
{
  float ix, iy;
  vgui_projection_inspector().window_to_image_coordinates(e.wx, e.wy, ix, iy);
...
//: Deactivate the tool
void
bvis_vsol2D_digital_curve_tool::deactivate()
{
  active = false;
  point_list.clear();
}
...
//: Constructor
bvis_vsol2D_split_curve_tool::bvis_vsol2D_split_curve_tool()
...
//: Handle mouse clicks
bool
bvis_vsol2D_split_curve_tool::handle( const vgui_event & e, 
                                      const bvis_view_tableau_sptr& view )
{
  float ix, iy;
  vgui_projection_inspector().window_to_image_coordinates(e.wx, e.wy, ix, iy);
...
//: Deactivate the tool
void
bvis_vsol2D_split_curve_tool::deactivate()
{
}
...
//Constructor
bvis_vsol2D_inspect_tool::bvis_vsol2D_inspect_tool( const vgui_event_condition& lift)
...
//: Destructor
bvis_vsol2D_inspect_tool::~bvis_vsol2D_inspect_tool()
{
}
...
bool
bvis_vsol2D_inspect_tool::set_tableau( const vgui_tableau_sptr& tableau )
{ 
...
//: Handle events
bool
bvis_vsol2D_inspect_tool::handle( const vgui_event & e, const bvis_view_tableau_sptr& selector )
{ 
...
void
bvis_vsol2D_inspect_tool::deactivate()
{
}
...
//Constructor
bvis_vsol2D_selection_tool::bvis_vsol2D_selection_tool( const vgui_event_condition& add, const vgui_event_condition& set)
...
//: Destructor
bvis_vsol2D_selection_tool::~bvis_vsol2D_selection_tool()
{
}
...
//: Set the tableau to work with
bool
bvis_vsol2D_selection_tool::set_tableau( const vgui_tableau_sptr& tableau )
{ 
    if( tableau.ptr() != NULL && tableau->type_name() == "bgui_vsol2D_tableau" ){
        tableau_.vertical_cast(tableau);
        return true;
...
{ 
    ...
    if (tableau_.ptr() && gesture_set_(e) ) {
      ...
      bvis_video_manager::instance()->add_to_display(output_vsol);
...
void
bvis_vsol2D_selection_tool::deactivate()
{
}
...
//Constructor
bvis_vsol2D_adjust_tool::bvis_vsol2D_adjust_tool( const vgui_event_condition& lift,
...
//: Destructor
bvis_vsol2D_adjust_tool::~bvis_vsol2D_adjust_tool()
{
}
...
//: Return the name of this tool
void
bvis_vsol2D_adjust_tool::set_points(const vsol_spatial_object_2d_sptr& obj)
{
  points_.clear();
  cycle_ = false;
...
//: Handle events
bool
bvis_vsol2D_adjust_tool::handle( const vgui_event & e, const bvis_view_tableau_sptr& selector )
{ 
  float ix, iy;
  vgui_projection_inspector().window_to_image_coordinates(e.wx, e.wy, ix, iy);
...
void
bvis_vsol2D_adjust_tool::deactivate()
{
}



bvis_vsol2D_crop_tool::bvis_vsol2D_crop_tool()
{
draw_polygon_=false;
  gesture0 = vgui_event_condition(vgui_LEFT, vgui_MODIFIER_NULL, true);
  gesture1 = vgui_event_condition(vgui_MIDDLE, vgui_MODIFIER_NULL, true);
...
void
bvis_vsol2D_crop_tool::deactivate()
{
}

bool
bvis_vsol2D_crop_tool::handle( const vgui_event & e, 
                               const bvis_view_tableau_sptr& view )
{
  float ix, iy;
  vgui_projection_inspector().window_to_image_coordinates(e.wx, e.wy, ix, iy);
...
void
bvis_vsol2D_crop_tool::set_points(const vsol_spatial_object_2d_sptr& obj)
{
  points_.clear();
  if(vsol_point_2d_sptr pt = obj->cast_to_point())
  {
