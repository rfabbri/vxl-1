//This is bvis/bvis_video_add_menu.h

#ifndef bvis_video_add_menu_h_
#define bvis_video_add_menu_h_

//:
// \file
// \brief The bvis_video_add_menu 
...
class bvis_video_add_menu: public vgui_menu 
{

public:

  bvis_video_add_menu();
  virtual ~bvis_video_add_menu();
