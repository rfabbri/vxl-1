//This is bvis2/menu/bvis2_video_menu.h

#ifndef bvis2_video_menu_header
#define bvis2_video_menu_header

//:
// \file
// \brief The bvis2_video_menu 
...
class bvis2_video_menu: public vgui_menu 
{

public:

  bvis2_video_menu();
  virtual ~bvis2_video_menu();
  ...
  static void set_custom_window();
  static void unset_custom_window();
