...
//Note add rrel dir to bvis cmakelists.txt
...
dbvis_homog_view_tool::dbvis_homog_view_tool( const vgui_event_condition& lift    ,const vgui_event_condition& end_sel ,
...
//: Destructor
dbvis_homog_view_tool::~dbvis_homog_view_tool()
{
}
...
bool
dbvis_homog_view_tool::set_tableau( const vgui_tableau_sptr& tableau )
{
...
//: Handle events
bool 
dbvis_homog_view_tool::handle( const vgui_event & e, const bvis_view_tableau_sptr& selector)
{
        float ix, iy;
...
bool dbvis_homog_view_tool::four_pts()
{
        end_sel_flag=false;
...
bvis_manager::instance()->add_to_display(storage2_);
...
bvis_manager::instance()->display_current_frame();
...
bool dbvis_homog_view_tool::Ransac_all_pts_in_image()
{
 ...
 //   vcl_cout<<"\n"<<"\n";
        ...
        linestorage2_=vidpro_vsol2D_storage_new();
...
#if 0 
                vidpro_vsol2D_storage_sptr outliers_11=vidpro_vsol2D_storage_new();
                vidpro_vsol2D_storage_sptr outliers_12=vidpro_vsol2D_storage_new();
                vidpro_vsol2D_storage_sptr outliers_21=vidpro_vsol2D_storage_new();
                vidpro_vsol2D_storage_sptr outliers_22=vidpro_vsol2D_storage_new();
#endif
        while (num_popfound<num_pop)
        {
                if (use_correlation_)
                {
                        vidpro_image_storage_sptr image; 
                        vidpro_image_storage_sptr image2; 
        ...
        bvis_manager::instance()->add_to_display(storage_);
        bvis_manager::instance()->add_to_display(storage2_);
                bvis_manager::instance()->repository()->store_data(linestorage_);
        bvis_manager::instance()->repository()->store_data(linestorage2_);
        bvis_manager::instance()->add_to_display(linestorage_);
        bvis_manager::instance()->add_to_display(linestorage2_);
                bvis_manager::instance()->repository()->store_data(linestorage3_);
        bvis_manager::instance()->repository()->store_data(linestorage3_);
        bvis_manager::instance()->add_to_display(linestorage4_);
        bvis_manager::instance()->add_to_display(linestorage4_);
                bvis_manager::instance()->repository()->store_data(inliers_11);
        bvis_manager::instance()->repository()->store_data(inliers_12);
        bvis_manager::instance()->add_to_display(inliers_11);
        bvis_manager::instance()->add_to_display(inliers_12);
                bvis_manager::instance()->repository()->store_data(inliers_21);
        bvis_manager::instance()->repository()->store_data(inliers_22);
        bvis_manager::instance()->add_to_display(inliers_21);
        bvis_manager::instance()->add_to_display(inliers_22);
# if 0
                bvis_manager::instance()->repository()->store_data(outliers_11);
        bvis_manager::instance()->repository()->store_data(outliers_12);
        bvis_manager::instance()->add_to_display(outliers_11);
        bvis_manager::instance()->add_to_display(outliers_12);
                bvis_manager::instance()->repository()->store_data(outliers_21);
        bvis_manager::instance()->repository()->store_data(outliers_22);
        bvis_manager::instance()->add_to_display(outliers_21);
        bvis_manager::instance()->add_to_display(outliers_22);
...
//              bvis_manager::instance()->regenerate_all_tableaux();
        bvis_manager::instance()->display_current_frame();
...
bool dbvis_homog_view_tool::Ransac_selected_pts_in_image()
{
    ...
    linestorage4_->set_name("Corr btw trans_pts");
        ...
        bvis_manager::instance()->add_to_display(linestorage2_);
        bvis_manager::instance()->repository()->store_data(linestorage3_);
        bvis_manager::instance()->repository()->store_data(linestorage4_);
        bvis_manager::instance()->add_to_display(linestorage3_);
        bvis_manager::instance()->add_to_display(linestorage4_);
#if 0
        bvis_manager::instance()->repository()->store_data(inliers_11);
        bvis_manager::instance()->repository()->store_data(inliers_12);
                                                                         ...
                                                                         vgui_menu &menu )
{
 ...
 //               bvis_tool_toggle, (void*)(&end_sel_flag) );



   
//      menu.add( "Prune by Gamma", new bvis_prune_command(this, bvis_prune_command::GAMMA));
//      menu.add( "Prune by Directed", new bvis_prune_command(this, bvis_prune_command::DIRECT));
}

void
dbvis_homog_view_tool::deactivate()
{
#if 0
tableaus_vsol_.clear();
 pts_[0].clear();
