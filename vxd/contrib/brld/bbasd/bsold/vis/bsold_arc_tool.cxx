                               ...
                               const bvis1_view_tableau_sptr& /*view*/ )
{
  ...
  else if( this->active_ ) 
  {
    ...
    {
      double r = std::sqrt((this->x1_-this->x0_)*(this->x1_-this->x0_) + 
      ...
      for (unsigned int i=0;i<100;i++)
      {
        ...
        glVertex2d(this->x0_+r*std::cos(angle), this->y0_+r*std::sin(angle));
      }
      glEnd();

      vgui::out << "center (" << this->x0_ << " , " << this->y0_ << ")  r= " << r << std::endl;                                                                                    
      return true;
    }
    ...
    if( this->choose_circle_point_(e) ) 
    {
      ...
      for (unsigned int i=0;i<50;i++)
      {
        ...
        vsol_point_2d_sptr point_sptr = new vsol_point_2d(this->x0_+r*std::cos(angle), 
          this->y0_+r*std::sin(angle));
      ...
      std::cout << "Circle center = ( " << this->x0_ << " , " << this->y0_ << " )" << std::endl;
