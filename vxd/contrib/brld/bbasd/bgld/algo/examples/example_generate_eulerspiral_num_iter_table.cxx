...
{
  std::cout << "This program generates a table of number of iterations " <<
    "used for different computation" << std::endl;
  std::cout << "The result table has the structure" << std::endl;
  std::cout << "     start_angle_1       start_angle_1       num_iter_1 " << std::endl;
  std::cout << "     start_angle_2       start_angle_2       num_iter_2 " << std::endl;
  std::cout << "     start_angle_3       start_angle_3       num_iter_3 " << std::endl;
  std::cout << "         ...                 ...                 ...    " << std::endl;
  std::cout << "     start_angle_n       start_angle_n       num_iter_n " << std::endl;
  ...
  bool success = false;
  std::ofstream ofs("bgld_eulerspiral_num_iter_table_using_lookup_table_minimization.txt");
  int num_failed_cases = 0;
  for (int i = 0; i < npts; i++ ){
    
    start_angle = (i + 1.0/(i+2)) * dt;
    std::cout << "i = " << i << " , start_angle = " << start_angle << std::endl;
