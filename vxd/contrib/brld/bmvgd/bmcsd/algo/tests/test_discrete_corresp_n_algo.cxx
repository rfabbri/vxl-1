...
test_discrete_corresp()
{
  ...
  // ------
  std::vector<vsol_polyline_2d_sptr> a0;
  // ------
  {  // 0
  ...
  // ------
  std::vector<vsol_polyline_2d_sptr> a1;
  // ------
  {  // 0
  std::vector<vsol_point_2d_sptr> pts;
  pts.push_back(new vsol_point_2d(a));
  ...
  // ------
  std::vector<vsol_polyline_2d_sptr> b0;
  // ------
  {  // 0 == a0[1]
  std::vector<vsol_point_2d_sptr> pts;
  pts.push_back(new vsol_point_2d(e));
  ...
  // ------
  std::vector<vsol_polyline_2d_sptr> b1;
  // ------
  {  // 0 == a1[1]
  std::vector<vsol_point_2d_sptr> pts;
  pts.push_back(new vsol_point_2d(c));
...
//  std::cout << "n: " << n << " n_valid: " << n_valid << std::endl;
...
//  TEST("percentage_of_matches_above_truth:  n_valid",n_valid,15);
  ...
  std::cout << "# of objects in image 1 having ground-truth among any candidates:\n\t" 
    << 100.0*(float)n_w_gt/(float)(cp.size()) << "% ("  << n_w_gt << " out of " << cp.size()<< ")." << std::endl;
