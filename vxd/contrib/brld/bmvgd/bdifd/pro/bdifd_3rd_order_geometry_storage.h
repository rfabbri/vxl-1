...
public:
  ...
  virtual std::string type() const { return "3rdOrderGeometry"; }
  ...
  virtual std::string is_a() const { return "bdifd_3rd_order_geometry_storage"; }
  ...
  void set_c(std::vector<bdifd_3rd_order_point_2d> &new_c) {
    c_ = new_c;
  }
...
private:
  ...
  std::vector<bdifd_3rd_order_point_2d> c_;
};
