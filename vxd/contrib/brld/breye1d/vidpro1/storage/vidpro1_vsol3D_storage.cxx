...
vidpro1_vsol3D_storage::b_read(vsl_b_istream &is)
{
  ...
  default:
    std::cerr << "I/O ERROR: vidpro1_vsol3D_storage::b_read(vsl_b_istream&)\n"
...
void
vidpro1_vsol3D_storage::add_objects( const std::vector< vsol_spatial_object_3d_sptr >& objects,  
...
vidpro1_vsol3D_storage::data_named( const std::string& which) const
{
