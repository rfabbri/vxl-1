...
public:
  ...
  //: Constructor
  vidpro1_fmatrix_storage(const std::string& from_name = "");
  ...
  virtual std::string is_a() const { return "vidpro1_fmatrix_storage"; }
...
struct vidpro1_fmatrix_storage_new : public vidpro1_fmatrix_storage_sptr
{
  ...
  vidpro1_fmatrix_storage_new(const std::string& from_name = "") 
