...
std::vector< std::string > vidpro1_frame_diff_process::get_input_type()
{
...
std::vector< std::string > vidpro1_frame_diff_process::get_output_type()
{  
  std::vector<std::string > to_return;
  to_return.push_back( "image" );
  return to_return;
...
vidpro1_frame_diff_process::execute()
{
  if ( input_data_.size() != 2 ){
    std::cout << "In vidpro1_frame_diff_process::execute() - "
