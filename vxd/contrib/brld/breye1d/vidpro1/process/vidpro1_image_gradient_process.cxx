...
std::vector< std::string > vidpro1_image_gradient_process::get_input_type()
{
...
std::vector< std::string > vidpro1_image_gradient_process::get_output_type()
{
  unsigned out_type=0;
...
vidpro1_image_gradient_process::execute()
{
  ...
  {
      std::cout << "In vidpro1_image_gradient_process::execute() - not exactly one"
               << " input image \n";
      return false;
  }
  clear_output();
