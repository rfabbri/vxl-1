...
std::vector< std::string > vidpro1_save_ps_process::get_input_type()
{
...
std::vector< std::string > vidpro1_save_ps_process::get_output_type()
{
  std::vector< std::string > to_return;
...
bool vidpro1_save_ps_process::savePS (std::string filename)
{
