...
void gkll_kl::match_sequence(std::vector<vil1_image> &image_list,gkll_multi_view_data_vertex_sptr matches)
{
...
std::vector<vtol_vertex_2d_sptr>* gkll_kl::extract_points(vil1_image & image)
{
