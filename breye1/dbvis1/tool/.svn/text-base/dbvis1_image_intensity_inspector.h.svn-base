...
class  dbvis1_image_intensity_inspector:public bvis1_tool
{
 public:
  //: Constructor
  dbvis1_image_intensity_inspector();
  //: Destructor
  ...
  //: handle events
  virtual bool handle( const vgui_event & e,const bvis1_view_tableau_sptr& selector );
