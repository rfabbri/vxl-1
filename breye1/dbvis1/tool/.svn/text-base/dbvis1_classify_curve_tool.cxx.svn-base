#include <dbvis1/tool/dbvis1_classify_curve_tool.h>
...
dbvis1_classify_curve_tool::dbvis1_classify_curve_tool()
{
...
bool
dbvis1_classify_curve_tool::set_tableau( const vgui_tableau_sptr& tableau )
{
...
bool
dbvis1_classify_curve_tool::set_storage ( const bpro1_storage_sptr& storage)
{
  if (!storage.ptr())
    return false;
...
dbvis1_classify_curve_tool::tableau()
{
  return tableau_;
}

vidpro1_vsol2D_storage_sptr
dbvis1_classify_curve_tool::storage()
{
...
bool
dbvis1_classify_curve_tool::handle( const vgui_event & e, const bvis1_view_tableau_sptr& view )
{
  float ix, iy;
...
vcl_string dbvis1_classify_curve_tool::name() const
{
