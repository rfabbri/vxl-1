#ifndef bvis1_edge_transform_tools_header
#define bvis1_edge_transform_tools_header
...
class dbvis1_edge_transform_tool : public bvis1_tool
{
public:
  dbvis1_edge_transform_tool();
  virtual ~dbvis1_edge_transform_tool();
