// This is breye1/dbvis1/tool/dbvis1_curvel_3d_tool.cxx
//:
// \file

#include "dbvis1_so3d_info_tool.h"
...
//: Constructor
dbvis1_so3d_info_tool ::dbvis1_so3d_info_tool (const vgui_event_condition& pick)
: gesture_pick_(pick)
{
}

//: Destructor
dbvis1_so3d_info_tool ::~dbvis1_so3d_info_tool ()
{
}
...
//: Handle events
bool 
dbvis1_so3d_info_tool ::handle( const vgui_event & e, 
...
//  double frame = bvis1_manager::instance()->current_frame() + offset;
