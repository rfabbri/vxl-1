//---------------------------------------------------------------------
// This is breye1/vorl1/exec/vorl1_mirec_exec.cxx
//:
// \file
...
int main(int argc, char** argv)
{
  ...
  bpro1_filepath segcorfile, databasefile;
  ...
  int start_frame = vorl1_manager::instance()->start_frame();
  int end_frame = vorl1_manager::instance()->end_frame();
  ...
  for (int j = start_frame-input_object->start_frame_; j<end_frame; j++) {
    ...
    if (poly->size() <= 0) {
      ...
      vorl1_manager::instance()->set_performance(0, 1);
      continue; 
    }
    ...
    vidpro1_image_storage_sptr output_image;
