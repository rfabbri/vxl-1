// This is breye/bvis/tool/bvis_soview2D_tools.h
#ifndef bvis_soview2D_tools_h_
#define bvis_soview2D_tools_h_
//:
// \file
...
// \date 2/6/04
//
// This file contains bvis_translate_tool
//
// \verbatim
//  Modifications
// \endverbatim
...
class bvis_translate_tool : public bvis_tool {
public:
  //: Constructor
  bvis_translate_tool( const vgui_event_condition& lift = vgui_event_condition(vgui_LEFT, vgui_MODIFIER_NULL, true),
...
class bvis_style_tool : public bvis_tool {
public:
  //: Constructor
  bvis_style_tool( const vgui_event_condition& select = vgui_event_condition(vgui_LEFT, vgui_MODIFIER_NULL, true) );
  //: Destructor
