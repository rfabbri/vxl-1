// This is breye/bvis/tool/bvis_correspond_tools.cxx
//:
// \file

#include "bvis_correspond_tools.h"
...
//Constructor
bvis_correspond_point_tool::bvis_correspond_point_tool( const vgui_event_condition& select )
...
//: Destructor
bvis_correspond_point_tool::~bvis_correspond_point_tool()
{
}
...
bool
bvis_correspond_point_tool::set_tableau( const vgui_tableau_sptr& tableau )
{
...
//: Handle events
bool
bvis_correspond_point_tool::handle( const vgui_event & e, 
...
{ 
  ...
  bool is_mouse_over = ( bvis_video_manager::instance()->active_tableau()
...
class bvis_fmatrix_command : public vgui_command
{
  public:
  ...
  void execute()
  {
    ...
    {
      tabs.push_back(*itr);
      bpro_storage_sptr storage = bvis_video_manager::instance()->storage_from_tableau(*itr);
      if( storage != NULL )
  ...
  bvis_correspond_point_tool* tool_;
};


//: Add popup menu items
void 
bvis_correspond_point_tool::get_popup(const vgui_popup_params& params, 
                                            vgui_menu &menu)
{
  menu.add("Fundamental Matrix", new bvis_fmatrix_command(this));
}
