...
//  File: bvis_vsol2D_tools.h
//  Asgn: bvis2
//  Date: Thu Aug 14 15:24:53 EDT 2003
***************************************************************/

#ifndef bvis_vsol2D_tools_header
#define bvis_vsol2D_tools_header
...
class bvis_vsol2D_point_tool : public bvis_vsol2D_tool {

public:

  bvis_vsol2D_point_tool();
  virtual ~bvis_vsol2D_point_tool();
...
class bvis_vsol2D_line_tool : public bvis_vsol2D_tool {

public:

  bvis_vsol2D_line_tool();
  virtual ~bvis_vsol2D_line_tool();
...
protected:
  ...
  vidpro_vsol2D_storage_sptr active_storage_;
...
class bvis_vsol2D_polyline_tool : public bvis_vsol2D_tool {

public:

  bvis_vsol2D_polyline_tool();
  virtual ~bvis_vsol2D_polyline_tool();
...
class bvis_vsol2D_polygon_tool : public bvis_vsol2D_tool {

public:

  bvis_vsol2D_polygon_tool();
  virtual ~bvis_vsol2D_polygon_tool();
...
class bvis_vsol2D_digital_curve_tool : public bvis_vsol2D_tool {

public:

  bvis_vsol2D_digital_curve_tool();
  virtual ~bvis_vsol2D_digital_curve_tool();
...
class bvis_vsol2D_split_curve_tool : public bvis_vsol2D_tool {

public:

  bvis_vsol2D_split_curve_tool();
  virtual ~bvis_vsol2D_split_curve_tool();
...
class  bvis_vsol2D_inspect_tool: public bvis_vsol2D_tool {
public:
    //: Constructor
    bvis_vsol2D_inspect_tool( const vgui_event_condition& lift = vgui_event_condition(vgui_LEFT, vgui_MODIFIER_NULL, true));
    //: Destructor
    ...
    //: handle events
    bool handle( const vgui_event & e, const bvis_view_tableau_sptr& selector );
...
class  bvis_vsol2D_selection_tool: public bvis_vsol2D_tool {
public:
    //: Constructor
    bvis_vsol2D_selection_tool( const vgui_event_condition& add = vgui_event_condition(vgui_LEFT, vgui_MODIFIER_NULL, true),
...
class  bvis_vsol2D_adjust_tool: public bvis_vsol2D_tool {
public:
  //: Constructor
  bvis_vsol2D_adjust_tool( const vgui_event_condition& lift = vgui_event_condition(vgui_LEFT, 
                                                                                    vgui_MODIFIER_NULL, 
                                                                                    true), 
...
class  bvis_vsol2D_crop_tool: public bvis_vsol2D_tool {
public:
  //: Constructor
  bvis_vsol2D_crop_tool();
  //: Destructor
