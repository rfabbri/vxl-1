//This is bvis/menu/bvis_video_view_menu.h

#ifndef bvis_video_view_menu_h_
#define bvis_video_view_menu_h_
...
class bvis_video_view_menu: public vgui_menu 
{

public:

  bvis_video_view_menu();
  virtual ~bvis_video_view_menu();
