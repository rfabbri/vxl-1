//This is bvis/menu/bvis_video_menu.h

#ifndef bvis_video_menu_header
#define bvis_video_menu_header
...
class bvis_video_menu: public vgui_menu 
{

public:

  bvis_video_menu();
  virtual ~bvis_video_menu();
