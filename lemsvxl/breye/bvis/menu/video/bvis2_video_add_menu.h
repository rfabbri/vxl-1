//This is bvis2/bvis2_video_add_menu.h

#ifndef bvis2_video_add_menu_h_
#define bvis2_video_add_menu_h_

//:
// \file
// \brief The bvis2_video_add_menu 
...
class bvis2_video_add_menu: public vgui_menu 
{

public:

  bvis2_video_add_menu();
  virtual ~bvis2_video_add_menu();
