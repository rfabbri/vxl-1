//This is bvis2/menu/bvis2_video_view_menu.h

#ifndef bvis2_video_view_menu_h_
#define bvis2_video_view_menu_h_
...
class bvis2_video_view_menu: public vgui_menu 
{

public:

  bvis2_video_view_menu();
  virtual ~bvis2_video_view_menu();

  void add_to_menu( vgui_menu & menu );

  static void add_video_view();
