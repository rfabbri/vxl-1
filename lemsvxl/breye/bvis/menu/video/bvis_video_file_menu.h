//This is bvis/menu/bvis_video_file_menu.h

#ifndef bvis_video_file_menu_h_
#define bvis_video_file_menu_h_
...
class bvis_video_file_menu: public vgui_menu 
{

public:

  bvis_video_file_menu();
  virtual ~bvis_video_file_menu();
