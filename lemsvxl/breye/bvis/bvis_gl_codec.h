// This is breye/bvis/bvis_gl_codec.h
#ifndef bvis_gl_codec_h
#define bvis_gl_codec_h
//:
// \file
...
// with OpenGL
class bvis_gl_codec :  public vidl1_codec
{
  // PUBLIC INTERFACE----------------------------------------------------------
 public:

  // Constructors
  bvis_gl_codec(int start_frame = -1, int end_frame = -1);
  // Destructor
  ~bvis_gl_codec();
