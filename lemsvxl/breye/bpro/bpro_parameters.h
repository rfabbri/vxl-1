// This is breye/bpro/bpro_parameters.h
#ifndef bpro_parameters_h_
#define bpro_parameters_h_
//:
// \file
// \brief classes to represent parameters to bpro processes
...
//    Amir Tamrakar 09/19/06    Added a parameter type for multiple choice options (bpro_choice_param_type)
//
// \endverbatim
...
template< class T >
class bpro_param_type : public bpro_param
{
 public:
...
class bpro_choice_param_type : public bpro_param_type<unsigned>
{
 public:
  // Constructor
...
class bpro_parameters : public vbl_ref_count
{
 public:
  ...
  bool valid_parameter_type( const vcl_string& name, const T&) const
  {
    ...
    return (dynamic_cast<bpro_param_type<T> *>(itr->second) != NULL);
  }
