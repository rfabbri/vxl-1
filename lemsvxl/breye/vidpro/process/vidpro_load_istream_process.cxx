// This is brl/vidpro/process/vidpro_load_istream_process.cxx

//:
// \file

#include <vidpro/process/vidpro_load_istream_process.h>
...
//: Constructor
vidpro_load_istream_process::vidpro_load_istream_process() : bpro_process()
{
...
//: Destructor
vidpro_load_istream_process::~vidpro_load_istream_process()
{
}
...
//: Clone the process
bpro_process*
vidpro_load_istream_process::clone() const
{
  return new vidpro_load_istream_process(*this);
}


//: Return the name of the process
vcl_string vidpro_load_istream_process::name()
{
...
vcl_vector< vcl_string > vidpro_load_istream_process::get_input_type()
{
...
vcl_vector< vcl_string > vidpro_load_istream_process::get_output_type()
{
  vcl_vector< vcl_string > to_return;
...
bool
vidpro_load_istream_process::execute()
{
...
//: Finish
bool vidpro_load_istream_process::finish() 
{
  return true;
}
...
int
vidpro_load_istream_process::input_frames()
{
  return 0;
}
...
int
vidpro_load_istream_process::output_frames()
{
  return 1;
}
