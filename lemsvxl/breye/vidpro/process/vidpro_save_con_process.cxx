...
vidpro_save_con_process::vidpro_save_con_process() : bpro_process(), first_frame_(true)
{
...
//: Clone the process
bpro_process*
vidpro_save_con_process::clone() const
{
...
bool vidpro_save_con_process::execute()
{
  bpro_filepath con_output, poly_output;
...
bool vidpro_save_con_process::finish() 
{
    return true;
}
