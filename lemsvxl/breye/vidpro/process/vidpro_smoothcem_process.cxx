...
vidpro_smoothcem_process::vidpro_smoothcem_process() : bpro_process()
{
  ...
  {
    vcl_cerr << "ERROR: Adding parameters in vidpro_smoothcem_process::vidpro_smoothcem_process()" << vcl_endl;
  }
}
...
vcl_vector< vcl_string > vidpro_smoothcem_process::get_input_type()
{
...
vcl_vector< vcl_string > vidpro_smoothcem_process::get_output_type()
{
  vcl_vector< vcl_string > to_return;
  to_return.push_back( "vsol2D" );
  return to_return;
