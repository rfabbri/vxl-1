...
std::vector< std::string > vidpro_equalize_images_process::get_input_type()
{
  bool mask = false;
...
std::vector< std::string > vidpro_equalize_images_process::get_output_type()
{  
  std::vector<std::string > to_return;
  to_return.push_back( "image" );
  return to_return;
...
vidpro_equalize_images_process::execute()
{
  if ( input_data_.size() != 1 ){
    std::cout << "In vidpro_equalize_images_process::execute() - "
