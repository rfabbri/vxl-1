// This is brl/vidpro/process/vidpro_image_gradient_process.cxx

//:
// \file

#include "vidpro_image_gradient_process.h"
...
//: Clone the process
bpro_process* 
vidpro_image_gradient_process::clone() const
{
  return new vidpro_image_gradient_process(*this);
}
...
int
vidpro_image_gradient_process::input_frames()
{
  return 1;
}
...
int
vidpro_image_gradient_process::output_frames()
{
  unsigned out_type=0;
  parameters()->get_value( "-output_type" , out_type );
...
bool
vidpro_image_gradient_process::execute()
{
...
//: Finish
bool
vidpro_image_gradient_process::finish()
{
  return true;
}
