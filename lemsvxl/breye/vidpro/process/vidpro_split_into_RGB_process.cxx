// This is basic/dbil/pro/vidpro_split_into_RGB_process.cxx

//:
// \file

#include "vidpro_split_into_RGB_process.h"
...
//: Constructor
vidpro_split_into_RGB_process::vidpro_split_into_RGB_process()
{
}
...
//: Clone the process
bpro_process* 
vidpro_split_into_RGB_process::clone() const
{
  return new vidpro_split_into_RGB_process(*this);
}
...
int
vidpro_split_into_RGB_process::input_frames()
{
  return 1;
}
...
int
vidpro_split_into_RGB_process::output_frames()
{
  return 1;
}
...
bool
vidpro_split_into_RGB_process::finish()
{
  return true;
}
