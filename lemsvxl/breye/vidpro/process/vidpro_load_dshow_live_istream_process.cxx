// This is brl/vidpro/process/vidpro_load_dshow_live_istream_process.cxx
...
//: Destructor
vidpro_load_dshow_live_istream_process::~vidpro_load_dshow_live_istream_process()
{
}
...
//: Clone the process
bpro_process*
vidpro_load_dshow_live_istream_process::clone() const
{
  return new vidpro_load_dshow_live_istream_process(*this);
}
...
//: Finish
bool vidpro_load_dshow_live_istream_process::finish() 
{
  return true;
}
...
int
vidpro_load_dshow_live_istream_process::input_frames()
{
  return 0;
}
...
int
vidpro_load_dshow_live_istream_process::output_frames()
{
  return 1;
}
