...
std::vector< std::string > vidpro_frame_diff_process::get_input_type()
{
...
std::vector< std::string > vidpro_frame_diff_process::get_output_type()
{  
  std::vector<std::string > to_return;
  to_return.push_back( "image" );
  return to_return;
...
vidpro_frame_diff_process::execute()
{
  if ( input_data_.size() != 2 ){
    std::cout << "In vidpro_frame_diff_process::execute() - "
