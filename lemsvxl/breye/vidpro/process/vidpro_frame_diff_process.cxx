// This is brl/vidpro/process/vidpro_frame_diff_process.cxx

//:
// \file

#include "vidpro_frame_diff_process.h"
...
//: Constructor
vidpro_frame_diff_process::vidpro_frame_diff_process()
{
}
...
//: Clone the process
bpro_process* 
vidpro_frame_diff_process::clone() const
{
  return new vidpro_frame_diff_process(*this);
}


//: Return the name of this process
vcl_string
vidpro_frame_diff_process::name()
{
...
int
vidpro_frame_diff_process::input_frames()
{
  return 2;
}
...
int
vidpro_frame_diff_process::output_frames()
{
  return 1;
}
...
vcl_vector< vcl_string > vidpro_frame_diff_process::get_input_type()
{
...
vcl_vector< vcl_string > vidpro_frame_diff_process::get_output_type()
{  
  vcl_vector<vcl_string > to_return;
  to_return.push_back( "image" );
  return to_return;
...
//: Execute the process
bool
vidpro_frame_diff_process::execute()
{
  if ( input_data_.size() != 2 ){
    vcl_cout << "In vidpro_frame_diff_process::execute() - "
...
bool
vidpro_frame_diff_process::finish()
{
  return true;
}
