// This is brl/vidpro/process/vidpro_gaussian_blur_process.cxx

//:
// \file

#include "vidpro_gaussian_blur_process.h"
...
//: Constructor
vidpro_gaussian_blur_process::vidpro_gaussian_blur_process()
{
...
//: Clone the process
bpro_process* 
vidpro_gaussian_blur_process::clone() const
{
  return new vidpro_gaussian_blur_process(*this);
}


//: Return the name of the process
vcl_string
vidpro_gaussian_blur_process::name()
{
...
vcl_vector< vcl_string > vidpro_gaussian_blur_process::get_input_type()
{
...
vcl_vector< vcl_string > vidpro_gaussian_blur_process::get_output_type()
{
  bool modify = false;
...
int
vidpro_gaussian_blur_process::input_frames()
{
  return 1;
}
...
int
vidpro_gaussian_blur_process::output_frames()
{
  return 1;
}
...
bool
vidpro_gaussian_blur_process::execute()
{
  if ( input_data_.size() != 1 )
  {
      vcl_cout << "In vidpro_gaussian_blur_process::execute() - not exactly one"
               << " input image \n";
      return false;
  }
  clear_output();
...
//: Finish
bool
vidpro_gaussian_blur_process::finish()
{
  return true;
}
