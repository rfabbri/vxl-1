...
std::vector< std::string > vidpro_gaussian_blur_process::get_input_type()
{
...
std::vector< std::string > vidpro_gaussian_blur_process::get_output_type()
{
  bool modify = false;
...
vidpro_gaussian_blur_process::execute()
{
  ...
  {
      std::cout << "In vidpro_gaussian_blur_process::execute() - not exactly one"
               << " input image \n";
      return false;
  }
  clear_output();
