// This is brl/vidpro/process/vidpro_harris_corners_process.cxx

//:
// \file

#include "vidpro_harris_corners_process.h"
...
//: Constructor
vidpro_harris_corners_process::vidpro_harris_corners_process() : bpro_process()
{
...
//: Destructor
vidpro_harris_corners_process::~vidpro_harris_corners_process()
{
}
...
//: Clone the process
bpro_process* 
vidpro_harris_corners_process::clone() const
{
  return new vidpro_harris_corners_process(*this);
}
...
//: Finish
bool
vidpro_harris_corners_process::finish()
{
  return true;
}
...
int
vidpro_harris_corners_process::input_frames()
{
  return 1;
}
...
int
vidpro_harris_corners_process::output_frames()
{
  return 1;
}
