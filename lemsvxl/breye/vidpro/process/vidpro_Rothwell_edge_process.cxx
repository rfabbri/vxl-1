// This is brl/vidpro/process/vidpro_Rothwell_edge_process.cxx
...
//: Constructor
vidpro_Rothwell_edge_process::vidpro_Rothwell_edge_process()
{
...
//: Clone the process
bpro_process* 
vidpro_Rothwell_edge_process::clone() const
{
  return new vidpro_Rothwell_edge_process(*this);
}
...
int
vidpro_Rothwell_edge_process::input_frames()
{
  return 1;
}
...
int
vidpro_Rothwell_edge_process::output_frames()
{
  return 1;
}
...
//: Finish
bool
vidpro_Rothwell_edge_process::finish()
{
  return true;
}
