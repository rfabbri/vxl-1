// This is basic/dbil/pro/vidpro_RGB_to_IHS_process.cxx

//:
// \file

#include "vidpro_RGB_to_IHS_process.h"
...
//: Constructor
vidpro_RGB_to_IHS_process::vidpro_RGB_to_IHS_process()
{
...
//: Clone the process
bpro_process* 
vidpro_RGB_to_IHS_process::clone() const
{
  return new vidpro_RGB_to_IHS_process(*this);
}

//: Returns the name of this process
vcl_string 
vidpro_RGB_to_IHS_process::name()
{ 
  return "RGB to IHS"; 
}
...
vidpro_RGB_to_IHS_process::get_input_type()
{
...
vcl_vector< vcl_string > 
vidpro_RGB_to_IHS_process::get_output_type()
{
  vcl_vector< vcl_string > to_return;
...
int
vidpro_RGB_to_IHS_process::input_frames()
{
  return 1;
}
...
int
vidpro_RGB_to_IHS_process::output_frames()
{
  return 1;
}
...
bool
vidpro_RGB_to_IHS_process::execute()
{
  if ( input_data_.size() != 1 ){
    vcl_cerr << "In vidpro_RGB_to_IHS_process::execute() - "
...
bool
vidpro_RGB_to_IHS_process::finish()
{
  return true;
}
