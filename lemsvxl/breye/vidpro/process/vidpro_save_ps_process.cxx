...
vidpro_save_ps_process::vidpro_save_ps_process() : bpro_process()
{
...
//: Clone the process
bpro_process*
vidpro_save_ps_process::clone() const
{
  return new vidpro_save_ps_process(*this);
}
...
bool vidpro_save_ps_process::execute()
{
