...
std::vector< std::string > vidpro_grey_image_process::get_input_type()
{
...
//: Return the name of this process
std::vector< std::string > vidpro_grey_image_process::get_output_type()
{
  std::vector< std::string > to_return;
  to_return.push_back( "image" );
  return to_return;
...
vidpro_grey_image_process::execute()
{
  ...
  {
      std::cout << "In vidpro_grey_image_process::execute() - not exactly one"
               << " input image \n";
      return false;
  }
  clear_output();
