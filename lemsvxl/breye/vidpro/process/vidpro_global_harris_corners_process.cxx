...
std::vector< std::string > vidpro_global_harris_corners_process::get_input_type()
{
...
std::vector< std::string > vidpro_global_harris_corners_process::get_output_type()
{
  std::vector< std::string > to_return;
...
vidpro_global_harris_corners_process::execute()
{
  if ( input_data_.size() != 1 ){
    std::cout << "In vidpro_global_harris_corner_process::execute() - not exactly one"
          << " input image \n";
    return false;
  }
  clear_output();
