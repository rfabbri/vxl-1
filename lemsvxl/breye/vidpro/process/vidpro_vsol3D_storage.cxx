// This is brl/vidpro/storage/vidpro_vsol3D_storage.cxx
...
bool vidpro_vsol3D_storage::registered_ = false;

//: Constructor
vidpro_vsol3D_storage::vidpro_vsol3D_storage()
{
}
...
void 
vidpro_vsol3D_storage::register_binary_io() const
{
  if(!registered_){
...
bpro_storage* 
vidpro_vsol3D_storage::clone() const
{
  return new vidpro_vsol3D_storage(*this);
}

#if 0
//: Return IO version number;
short 
vidpro_vsol3D_storage::version() const
{
  return 2;
}
...
void 
vidpro_vsol3D_storage::b_write(vsl_b_ostream &os) const
{
  vsl_b_write(os, version());
  vidpro_storage::b_write(os);
...
void 
vidpro_vsol3D_storage::b_read(vsl_b_istream &is)
{
  if (!is) return;
...
//: Remove all vsol3D
void
vidpro_vsol3D_storage::clear_all()
{
  vsol_map_.clear();
}
