// This is brl/vidpro/vidpro_process_manager.h
#ifndef vidpro_process_manager_h_
#define vidpro_process_manager_h_
...
//    3/37/07 - Isabel Restrepo - Narrowed to only video-related methods
//                                Subclassed from bpro_process_manager
// \endverbatim
...
class vidpro_process_manager : public bpro_process_manager<vidpro_process_manager> 
{
public:

    //:Destructor 
    virtual ~vidpro_process_manager(); 
    ...
    friend class bpro_process_manager<vidpro_process_manager>;
...
#endif // vidpro_process_manager_h_
