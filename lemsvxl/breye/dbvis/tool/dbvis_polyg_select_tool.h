#ifndef dbvis_polyg_select_tool_header
#define dbvis_polyg_select_tool_header
...
class dbvis_polyg_select_tool : public bvis_tool
{
public:
  dbvis_polyg_select_tool();
  virtual ~dbvis_polyg_select_tool();
