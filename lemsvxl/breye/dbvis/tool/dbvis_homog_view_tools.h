#ifndef dbvis_homog_view_tools_header
#define dbvis_homog_view_tools_header
...
class  dbvis_homog_view_tool: public bvis_vsol2D_tool {
public:
    //: Constructor
    dbvis_homog_view_tool( const vgui_event_condition& lift     = vgui_event_condition(vgui_LEFT, vgui_MODIFIER_NULL, true)     ,
...
private:
    ...
    vidpro_vsol2D_storage_sptr storage_,storage2_;
    vidpro_vsol2D_storage_sptr linestorage_,linestorage2_,linestorage3_,linestorage4_;
    vcl_vector < bpro_storage_sptr > images_;
