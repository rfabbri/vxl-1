#include <dbvis/tool/dbvis_edge_transform_tools.h>
...
dbvis_edge_transform_tool::dbvis_edge_transform_tool()
{
...
bool
dbvis_edge_transform_tool::set_tableau( const vgui_tableau_sptr& tableau )
{
...
bool
dbvis_edge_transform_tool::set_storage ( const bpro_storage_sptr& storage)
{
  if (!storage.ptr())
    return false;
...
dbvis_edge_transform_tool::tableau()
{
  return tableau_;
}

vidpro_vsol2D_storage_sptr
dbvis_edge_transform_tool::storage()
{
...
bool
dbvis_edge_transform_tool::handle( const vgui_event & e, 
