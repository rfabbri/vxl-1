#include <dbvis/tool/dbvis_image_intensity_inspector.h>
...
dbvis_image_intensity_inspector::dbvis_image_intensity_inspector()
{
  rgb_=true;
  ihs_=false;
}

bool dbvis_image_intensity_inspector::handle(const vgui_event & e,const bvis_view_tableau_sptr& selector )
{
...
bool
dbvis_image_intensity_inspector::set_tableau ( const vgui_tableau_sptr& tableau )
{
...
bool
dbvis_image_intensity_inspector::set_storage ( const bpro_storage_sptr& storage )
{
  if (!storage.ptr())
    return false;
...
void
dbvis_image_intensity_inspector::activate()
{

}

void
dbvis_image_intensity_inspector::deactivate()
{

}
void 
dbvis_image_intensity_inspector::get_popup( const vgui_popup_params& params, 
                                            vgui_menu &menu )
{
  vcl_string on = "[x] ", off = "[ ] ";
  menu.add( ((rgb_)?on:off)+"RGB ", 
            bvis_tool_toggle, (void*)(&rgb_) );
  menu.add( ((ihs_)?on:off)+"IHS", 
            bvis_tool_toggle, (void*)(&ihs_) );
