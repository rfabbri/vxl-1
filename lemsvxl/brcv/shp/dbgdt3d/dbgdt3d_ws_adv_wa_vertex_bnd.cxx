...
{  
  ...
  if (W->detect_project_to_L_dege (alphaCL) == false) {
    #if GDT_DEBUG_MSG
    if (n_verbose_>3)
      vul_printf (std::cout, "  Qv: No RF from W %d (%.3f, %.3f) at V %d to LE %d possible.\n", 
  ...
  if (rfW) {
    ...
    n_V_bnd_RF_++;
    if (n_verbose_>3)
      vul_printf (std::cout, "  Qv: Create L_contact S %d at v %d from W %d (%.3f, %.3f).\n", 
    ...
    #if GDT_DEBUG_MSG
    if (n_verbose_>3)
      vul_printf (std::cout, "  Qv: No shock created from W %d (%.3f, %.3f) at SV %d.\n", 
    ...
    #if GDT_DEBUG_MSG
    if (n_verbose_>3)
      vul_printf (std::cout, "  Qv: Create degeW %d (%.3f, %.3f).\n", 
...
void gdt_ws_manager::Create_rarefaction_of_R_bnd_vertex (dbmsh3d_gdt_vertex_3d* ev, gdt_welm* W) 
{
  ...
  if (W->detect_project_to_R_dege (alphaCR) == false) {
    #if GDT_DEBUG_MSG
    if (n_verbose_>3)
      vul_printf (std::cout, "  Qv: No RF from W %d (%.3f, %.3f) at V %d to RE %d possible.\n", 
  ...
  if (rfW) {
    ...
    n_V_bnd_RF_++;
    if (n_verbose_>3)
      vul_printf (std::cout, "  Qv: Create R_contact S %d at v %d from W %d (%.3f, %.3f).\n", 
    ...
    #if GDT_DEBUG_MSG
    if (n_verbose_>3)
      vul_printf (std::cout, "  Qv: No shock created from W %d (%.3f, %.3f) at EV %d.\n", 
