...
#if GDT_DEBUG_MSG
  if (n_verbose_>2)
    vul_printf (std::cerr, "    Remove propagation of edge %d.\n", input_edge->id());
#endif
...
#if GDT_DEBUG_MSG
  if (n_verbose_>2)
    vul_printf (std::cerr, "    Remove subseq. propagation of edge %d.\n", input_edge->id());
#endif
...
#if GDT_DEBUG_MSG
  if (n_verbose_>2)
    vul_printf (std::cerr, "    Remove subseq. intervals of edge %d.\n", input_edge->id());
#endif
