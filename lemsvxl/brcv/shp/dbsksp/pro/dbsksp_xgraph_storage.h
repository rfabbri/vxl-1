...
public:
  ...
  const std::vector<dbsksp_xshock_fragment_sptr >& xfrag_list() const 
  { return this->list_xfrag_; }

  std::vector<dbsksp_xshock_fragment_sptr >& xfrag_list()
  { return this->list_xfrag_; }
  ...
  const std::vector<dbsksp_xshock_node_descriptor >* xsamples() const
  { return &(this->xsamples_); }
...
protected:
  ...
  //: List of fragments
  std::vector<dbsksp_xshock_fragment_sptr > list_xfrag_;

  //: List of xshock samples
  std::vector<dbsksp_xshock_node_descriptor > xsamples_;
