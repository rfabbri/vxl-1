...
public:
  ...
  void set_edge_correspondence(const std::map<dbsksp_xshock_edge_sptr, dbsksp_xshock_edge_sptr >& edge_map_xgraph1_to_model,
    const std::map<dbsksp_xshock_edge_sptr, dbsksp_xshock_edge_sptr >& edge_map_model_to_xgraph1,
    const std::map<dbsksp_xshock_edge_sptr, dbsksp_xshock_edge_sptr >& edge_map_xgraph2_to_model,
    const std::map<dbsksp_xshock_edge_sptr, dbsksp_xshock_edge_sptr >& edge_map_model_to_xgraph2)
  {
...
protected:
  ...
  std::map<dbsksp_xshock_edge_sptr, dbsksp_xshock_edge_sptr > edge_map_parent_to_model_[2];
  std::map<dbsksp_xshock_edge_sptr, dbsksp_xshock_edge_sptr > edge_map_model_to_parent_[2];
