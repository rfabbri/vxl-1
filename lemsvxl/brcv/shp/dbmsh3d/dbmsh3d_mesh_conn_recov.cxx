//---------------------------------------------------------------------
// This is brcv/shp/dbmsh3d/dbmsh3d_mesh_conn_recovery.cxx
//:
// \file
...
void dbmsh3d_mesh::sort_halfedges_for_all_faces (const int verbose)
{
  if (facemap_.size() == 0)
    return;
...
//
void dbmsh3d_mesh::build_IFS_mesh () 
{
  assert (is_MHE());
...
void dbmsh3d_mesh::clean_IFS_mesh ()
{
  assert (is_MHE());
...
bool edges_id_less (const dbmsh3d_edge* E1, const dbmsh3d_edge* E2)
{
  return E1->id() < E2->id();
}
...
/*bool dbmsh3d_mesh::valid_conn ()
{
  bool result = dbmsh3d_ifs_mesh::valid_conn ();
  if (result == false)
    return false;
