...
void test_mesh_boundary()
{
  ...
  std::string cube_wo_base_ply = "C:/projects/lemsvxl/src/brcv/shp/dbmsh3d/tests/test_data/cube_without_bases.ply";
  ...
  {
    std::cout << "Boundary " << i << " vertices = ";
    std::vector<dbmsh3d_vertex* > boundary = boundary_list[i];
