...
//: This is lemsvxlsrc/brcv/shp/dbshk3d/cmdproc/dbshk3d_process_vis.h
//  Creation: Dec 24, 2005   Ming-Ching Chang

#ifndef dbshk3d_process_vis_h_
#define dbshk3d_process_vis_h_
...
public:
  SbColor A1A3_color_;
  SbColor A1A3_color_2_;
  SbColor A14_color_;
  SbColor A14_color_2_;
  SbColor Dege_A1A3_color_;
  SbColor Dege_A1A3_color_2_;
  SbColor Dege_A14_color_;
  SbColor Dege_A14_color_2_;
  ...
  SbColor A13_axial2_color_;
  SbColor A13_axial3_color_;
  SbColor A13_axial4_color_;
  SbColor Dege_axial_color_;
  SbColor Dege_axial_color_2_;
  SbColor A3_loop_color_;
  SbColor A3_loop_color_2_;
  SbColor A13_loop_color_;
  SbColor A13_loop_color_2_;

  SbColor Vc_color_;  //Virtual curve color
  SbColor Vc_color_2_;
  ...
  dbsk3d_ms_vis_param () {
    ...
    A1A3_color_2_ = SbColor (0.25f, 0.5f, 0.0f);
    A14_color_ = SbColor (1.0f, 0.0f, 1.0f);
    A14_color_2_ = SbColor (0.5f, 0.0f, 0.5f);
    Dege_A1A3_color_ = SbColor (0.4f, 0.8f, 0.8f);
    Dege_A1A3_color_2_ = SbColor (0.2f, 0.4f, 0.4f);
    Dege_A14_color_ = SbColor (0.8f, 0.4f, 0.8f);
    Dege_A14_color_2_ = SbColor (0.4f, 0.2f, 0.4f);
    ...
    A13_axial2_color_ = SbColor (1.0f, 0.5f, 0.0f);
    A13_axial3_color_ = SbColor (1.0f, 0.0f, 0.0f);
    A13_axial4_color_ = SbColor (1.0f, 0.5f, 0.0f);

    Dege_axial_color_ = SbColor (1.0f, 0.5f, 0.0f); 
    Dege_axial_color_2_ = SbColor (0.5f, 0.25f, 0.0f); 
    A3_loop_color_ = SbColor (0.0f, 0.5f, 1.0f);  //SbColor (0.0f, 0.0f, 1.0f); 
    A3_loop_color_2_ = SbColor (0.0f, 0.25f, 0.5f); //SbColor (0.0f, 0.0f, 0.5f);
    A13_loop_color_ = SbColor (1.0f, 0.5f, 0.0f);
    A13_loop_color_2_ = SbColor (0.5f, 0.25f, 0.0f);

    Vc_color_ = SbColor (0.5f, 0.0f, 0.5f);
    Vc_color_2_ = SbColor (0.25f, 0.0f, 0.25f);
...
public:
  ...
  SoSeparator* vis_ms_hypg (const int option = 0, 
                            const int color_seed = DBMSH3D_SHEET_COLOR_SEED, 
                            const bool idv = false);
