...
int test_file_load_cem_main( int argc, char* argv[] )
{
  if ( argc >= 2 ) {
    file_base = argv[1];
#ifdef VCL_WIN32
  ...
  testlib_test_start("load .cem test");
  testlib_test_begin( "dbsk2d_ishock_boundary .cem load" );
  testlib_test_perform(load_cem_and_compare());
