...
{
  std::cout << "This is test_boundary_preprocess_1()" << std::endl;
  ...
  std::vector< vsol_point_2d_sptr > pts_0;
  ...
  polyline_0->print_summary(std::cout);
  ...
  std::cout << "\n Before pre-processing: " << std::endl;
...
{
  std::cout << "This is test_boundary_preprocess_2()" << std::endl;
  std::cout << "Testing forming contours from edges" << std::endl;
  ...
  */
  ...
  std::vector< vsol_point_2d_sptr > pts[4];
...
//  bool preprocess_algo2(std::list<dbsk2d_bnd_edge_sptr >& edges);
