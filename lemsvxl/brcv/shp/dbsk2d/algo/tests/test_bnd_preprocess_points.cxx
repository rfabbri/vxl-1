...
{
  std::cout << "In test_remove_unreal_stand_alone_points()" << std::endl;
  ...
  std::vector<dbsk2d_bnd_edge_sptr >real_points;
  ...
  std::vector<dbsk2d_bnd_vertex_sptr > disconnected_vertices;
    ...
    eit != bnd_pts.end(); ++eit)
  {
    remove_success = remove_success &&
      (std::find(disconnected_vertices.begin(), disconnected_vertices.end(), 
...
{
  std::cout << "In test_merge_close_points()" << std::endl;
  ...
  std::vector<vgl_point_2d<double > > remaining_pts;
