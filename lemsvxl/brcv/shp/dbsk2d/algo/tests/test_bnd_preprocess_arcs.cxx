...
{
  std::cout << "In test_intersect_bnd_arcs_1_pair()" << std::endl;
...
{
  std::cout << "In test_intersect_bnd_arcs_3_pairs()" << std::endl;
...
{
  std::cout << "In test_intersect_bnd_arcs_1_pair_with_shared_endpoint()" << std::endl;
...
void test_merge_vertices_into_arcs()
{
  ...
  // arc 2
  vgl_point_2d<double > p21(1, 2-std::sqrt(3.0)+1e-6);
