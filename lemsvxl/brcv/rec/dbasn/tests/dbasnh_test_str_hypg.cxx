//---------------------------------------------------------------------
// This is brcv/rec/dbasn/tests/dbasnh_test_str_hypg.cxx
//:
// \file
...
//: generate hypg with discriminative node info.
void generate_hypg_discri_c2 (dbasnh_hypg* G, dbasnh_hypg* g, const float noise)
{
  vnl_random mzr;
  G->alloc_corners_angle ();
  g->alloc_corners_angle ();
...
MAIN( dbasnh_test_str_hypg )
{
  ...
  for (int t=0; t<N_TEST_GA_STR_HYPG; t++) {
    ...
    case 14: //remove two sheets (8 corners)
      generate_hypg_random_n (G, g, 0.5, 0);
      generate_hypg_random_l (G, g, 0.5, 0);
      generate_hypg_discri_c2 (G, g, 0);
    break;
    case 15: //remove two sheets (8 corners) with noise
      generate_hypg_random_n (G, g, 0.5, SMALL_NOISE);
      generate_hypg_random_l (G, g, 0.5, SMALL_NOISE);
      generate_hypg_discri_c2 (G, g, SMALL_NOISE);
    break;
