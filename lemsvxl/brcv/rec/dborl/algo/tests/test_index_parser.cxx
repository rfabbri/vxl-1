...
static void test_index_parser(int argc, char* argv[])
{
  ...
  std::vector<dborl_index_node_base_sptr> cs2;
  ...
  std::vector<dborl_index_node_base_sptr> ch1c;
  ...
  std::vector<dborl_index_node_base_sptr> ch2c;
  ...
  std::vector<dborl_index_node_base_sptr> ch3c;
  ...
  //: test writing index
  std::ofstream os;
  os.open("test.xml", std::ios::out);
  ind2->write_xml(os);
  std::cout << "test.xml written.\n";
  os.close();
  ...
  std::vector<dborl_index_node_base_sptr> cs3;
