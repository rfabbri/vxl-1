...
std::vector< std::string > brld_edge_point_tangent_bg_model_process_2::get_input_type()
{
...
std::vector< std::string > brld_edge_point_tangent_bg_model_process_2::get_output_type()
{  
    std::vector<std::string > to_return;
