...
public:
  ...
  dborl_parameter<std::string> output_image_extension_;
  ...
  dborl_parameter<std::string> edge_detect_method_;

  //: Edge Linking Method to use
  dborl_parameter<std::string> edge_linking_method_;
  ...
  std::string tag_generic_edge_detection_;
  ...
  std::string tag_convert_edgemap_to_image_;

  //: Tag for generic edge_linking
  std::string tag_gen_linking_;
