...
int main(int argc, char *argv[]) {
  ...
  // Initialize defaults
  int return_status = 0;
  dborl_extract_shock_params_sptr params = new dborl_extract_shock_params("dborl_extract_shock");
  dborl_extract_shock e(params);  // just pass with the defaults to the constructor
  
  dborl_cluster<int, dborl_extract_shock, char> cluster(&e);
