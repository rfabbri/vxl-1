...
//        Uses the simple ex_class as the result type R,
//        ex_class only contains primitive type members,
//        see MPI_Datatype create_datatype_for_R() on how to create a new datatype using MPI functions
//        in order to be able to pass around instances of ex_class as messages
//
...
#if !defined(_dborl_example2_h)
#define _dborl_example2_h
...
class example_processor2 : public dborl_processor_base<int, ex_class>
{
public:
