...
int main(int argc, char *argv[]) {
  ...
  dborl_detect_patch_processor e;
  dborl_cluster<dborl_detect_patch_processor_input, dborl_detect_patch_processor, dborl_detect_patch_processor_output> cluster(&e);
  ...
  try
  {
    ...
    vcl_vector<dborl_detect_patch_processor_input> things; 
