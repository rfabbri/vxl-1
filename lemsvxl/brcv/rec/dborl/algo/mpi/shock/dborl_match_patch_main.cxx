...
//
// inputs to be passed from input.xml  see dborl_match_patch_processor::parse(const char* param_file)
...
int main(int argc, char *argv[]) {
  ...
  dborl_match_patch_processor e;
  dborl_cluster<dborl_match_patch_processor_input, dborl_match_patch_processor, char> cluster(&e);
  ...
  try
  {
    ...
    vcl_vector<dborl_match_patch_processor_input> things; 
