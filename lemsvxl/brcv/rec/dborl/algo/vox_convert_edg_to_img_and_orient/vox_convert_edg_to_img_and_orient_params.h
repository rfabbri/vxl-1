...
public:
    ...
    //: Constructor
    vox_convert_edg_to_img_and_orient_params(std::string algo_name);
    ...
    dborl_parameter<std::string> input_edgemap_dir_;
    dborl_parameter<std::string> input_linked_edgemap_dir_;
    dborl_parameter<std::string> input_edgemap_extension_;
    dborl_parameter<std::string> input_linked_edgemap_extension_;
    ...
    dborl_parameter<std::string> output_edge_image_orient_dir_;
    dborl_parameter<std::string> output_edge_image_extension_;
    dborl_parameter<std::string> output_edge_orient_extension_;
