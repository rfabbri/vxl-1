...
#ifndef vox_detect_shock_patches_params_h_
#define vox_detect_shock_patches_params_h_
...
class vox_detect_shock_patches_params : public dborl_algo_params
{
public:
  //: Constructor
...
#endif  //_vox_detect_shock_patches_params_h
