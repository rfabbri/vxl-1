...
public:
    ...
    //: Constructor
    vox_octave_pb_edge_detector_params(std::string algo_name);
    ...
    dborl_parameter<std::string> edgemap_extension_;
    ...
    dborl_parameter<std::string> output_edgemap_dir_;

    dborl_parameter<std::string> input_pyramid_dir_;
