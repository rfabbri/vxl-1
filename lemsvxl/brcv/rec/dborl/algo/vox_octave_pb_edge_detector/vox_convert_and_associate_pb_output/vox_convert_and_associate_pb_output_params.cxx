...
//: Constructor
vox_convert_and_associate_pb_output_params::vox_convert_and_associate_pb_output_params(vcl_string algo_name) : dborl_algo_params(algo_name)
{
    ...
    this->output_edgemap_dir_.set_values(this->param_list_, "io",
            ...
            "/vision/scratch/firat/ethz/applelogos_box_uploaded_edgemap",
            0, // associated to 0th input object
            dborl_parameter_system_info::OUTPUT_FILE,
            "edge_map_directory",
            dborl_parameter_type_info::FILEASSOC);

    this->input_edgemap_folder_list_file_.set_values(this->param_list_, "io",
            "input_edgemap_folder_list_file",
            "Path to the input file containing the list of pb output folders",
            "/vision/scratch/firat/ethz/pb_out_list.txt", "/vision/scratch/firat/ethz/pb_out_list.txt");
    ...
    this->output_edgemap_extension_.set_values(this->param_list_, "io", "output_edgemap_extension",
            "-io: output edge map extesion (.edg)", ".edg", ".edg");
}
