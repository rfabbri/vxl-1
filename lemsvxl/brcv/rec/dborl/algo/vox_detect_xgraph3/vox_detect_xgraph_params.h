...
public:
  ...
  std::string get_prev_image_file() const;
  ...
  std::string get_appearance_prototype_name() const; //> 
  std::string get_bb_file() const;
  std::string get_initial_edge_file() const;
  // MEMBER VARIABLES ----------------------------------------------------------
  ...
  dborl_parameter<std::string > appearance_prototype_filename_;

  dborl_parameter<std::string > input_bb_folder_;

  dborl_parameter<std::string > initial_edge_folder_;
