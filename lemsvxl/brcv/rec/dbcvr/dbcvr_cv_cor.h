//---------------------------------------------------------------------
// This is brcv/rec/dbcvr/dbcvr_cv_cor.h
//:
// \file
// \brief a small class to hold the curve correspondence as vectors of points
...
#ifndef _dbcvr_cv_cor_h
#define _dbcvr_cv_cor_h
...
class dbcvr_cv_cor : public vbl_ref_count
{
public:
  //: constructors
  dbcvr_cv_cor();
  dbcvr_cv_cor(const bsol_intrinsic_curve_2d_sptr c1, 
               const bsol_intrinsic_curve_2d_sptr c2, 
               vcl_vector<vcl_pair<int,int> >& map,
               int n1);

  virtual ~dbcvr_cv_cor()  { poly1_ = 0; poly2_ = 0; };
  ...
  virtual vcl_string is_a() const {return "dbcvr_cv_cor";}
