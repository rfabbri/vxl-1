...
#ifndef dbcvr_curvematch_process_header
#define dbcvr_curvematch_process_header
...
class dbcvr_curvematch_process : public bpro1_process 
{
public:
  dbcvr_curvematch_process();
  virtual ~dbcvr_curvematch_process() {}

  //: Clone the process
  virtual bpro1_process* clone() const;

  vcl_string name() {
    return "Curve Matching";
  }
