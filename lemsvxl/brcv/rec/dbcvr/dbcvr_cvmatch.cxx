...
dbcvr_cvmatch::dbcvr_cvmatch (bsol_intrinsic_curve_2d_sptr c1, bsol_intrinsic_curve_2d_sptr c2)
{
  _curve1 = c1;
  _curve2 = c2;
  _R = 10;
...
void dbcvr_cvmatch::setTemplateSize (int temp_size) {
...
void dbcvr_cvmatch::initializeDPCosts()
{
  //Ming: init
  _DPCost.clear();
  _DPMap.clear();
...
double dbcvr_cvmatch::computeIntervalCost(int i, int ip, int j, int jp)
{
...
void dbcvr_cvmatch::computeDPCosts ()
{ 
...
void dbcvr_cvmatch::findDPCorrespondence (void)
{
  int i, j, ip, jp;
...
void dbcvr_cvmatch::GetAverageCurveFromAMatch (bsol_intrinsic_curve_2d_sptr AverageCurve)
{
  AverageCurve->clear();
  double x, y;
...
void dbcvr_cvmatch::GetSumCurveFromAMatch (bsol_intrinsic_curve_2d_sptr SumCurve)
{
  SumCurve->clear();
  double x, y;
...
void dbcvr_cvmatch::GetMorphingCurvesFromAMatch (bsol_intrinsic_curve_2d_sptr MorphingCurves, int NumMorphs)
{
  double w;
...
//       DEBUG PRINT
//##################################################
void dbcvr_cvmatch::ListDPTable (void)
{
  int n = _curve1->size();
  int m = _curve2->size();
...
void dbcvr_cvmatch::ListAlignCurve (void)
{
  vcl_cout<<"=======================================\n";
...
void dbcvr_cvmatch::SaveDPTable (void)
{
...
void dbcvr_cvmatch::SaveAlignCurve (void)
{
  int n = _curve1->size();
  int m = _curve2->size();
...
dbcvr_cv_cor_sptr dbcvr_cvmatch::get_cv_cor() {
  dbcvr_cv_cor_sptr cv_cor = new dbcvr_cv_cor(_curve1, _curve2, _finalMap, _curve1->size()); 
