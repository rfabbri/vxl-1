...
static void test_shock_patch_match(int argc, char* argv[])
{
  ...
  //: load the st1
  std::string name1 = "donkey1";
  std::string path_initial = "Y:\\";
  std::string sep = "\\";
  //std::string st_file1 = "donkey1-model-nocirc-s-1-e-10-i-1-patch_strg.bin";
  //std::string st_file1 = "Y:\\99-db\\orl-exps\\patches\\prototype_patches\\patch_set\\donkey1\\donkey1_p_e_data_1_10_1_2_on_off_on_0.5_off_0.01_0.8_on_on_off_png\\donkey1_p_e_data_1_10_1_2_on_off_on_0.5_off_0.01_0.8_on_on_off_png-patch_strg.bin";
  std::string st_file1 = path_initial + "99-db" + sep + "orl-exps" + sep + "patches" + sep + "prototype_patches" + sep + "patch_set" + sep + name1 + sep + name1 + "_p_e_data_1_10_1_2_on_off_on_0.5_off_0.01_0.8_on_on_off_png" + sep + name1 + "_p_e_data_1_10_1_2_on_off_on_0.5_off_0.01_0.8_on_on_off_png-patch_strg.bin";
  //std::string sg_file1 = "Y:\\99-db\\orl-exps\\dataset\\donkey1\\donkey1.esf";
  std::string sg_file1 = path_initial + "99-db" + sep + "orl-exps" + sep + "shocks" + sep + "protos" + sep + "shock_set" + sep + name1 + sep + name1 + ".esf";
  //std::string img_file1 = "Y:\\99-db\\orl-exps\\dataset\\donkey1\\donkey1.pgm";
  std::string img_file1 = path_initial + "99-db" + sep + "orl-exps" + sep + "dataset" + sep + name1 + sep + name1 + ".pgm";
  ...
  //std::string st_file2 = "horse1-090-180-patch_strg.bin";
  //std::string st_file2 = "horse1-090-180-nocirc-color-s-5-e-5-i-1-pd-2-st-0.5-ot-0.8-patch_strg.bin";
  //std::string st_file2 = "dog2-nocirc-color-s-1-e-5-i-1-pd-2-st-0.5-ot-0.8-patch_strg.bin";
  //std::string st_file2 = "Y:\\99-db\\orl-exps\\patches\\prototype_patches\\patch_set\\cat1\\cat1_p_e_data_1_10_1_2_on_off_on_0.5_off_0.01_0.8_on_on_off_png\\cat1_p_e_data_1_10_1_2_on_off_on_0.5_off_0.01_0.8_on_on_off_png-patch_strg.bin";
  std::string name2 = "dog2";
  std::string set_name = "del-5-0.5-1";
  std::string st_file2 = path_initial + "99-db" + sep + "orl-exps" + sep + "patches" + sep + set_name + sep + "patch_set" + sep + name2 + sep + name2 + "_p_e_data_1_5_1_2_off_off_on_0.5_off_0.01_0.8_on_on_off_png" + sep + name2 + "_p_e_data_1_5_1_2_off_off_on_0.5_off_0.01_0.8_on_on_off_png-patch_strg.bin";
  //std::string sg_file2 = "Y:\\99-db\\orl-exps\\dataset\\cat1\\cat1.esf";
  std::string sg_file2 = path_initial + "99-db" + sep + "orl-exps" + sep + "shocks" + sep + set_name + sep + "shock_set" + sep + name2 + sep + name2 + ".esf";
  //std::string img_file2 = "Y:\\99-db\\orl-exps\\dataset\\cat1\\cat1.pgm";
  std::string img_file2 = path_initial + "99-db" + sep + "orl-exps" + sep + "dataset" + sep + name2 + sep + name2 + ".pgm";
  ...
  //std::string out_name = "donkey1-horse1-match.bin";
  //std::string out_name = "donkey1-model-nocirc-s-1-e-10-i-1-horse1-090-180-nocirc-color-s-5-e-5-i-1-pd-2-st-0.5-ot-0.8-nocirc-s-1.0-i-1.0-R-6.0.bin";
  //std::string out_name = "donkey1-model-nocirc-s-1-e-10-i-1-dog2-nocirc-color-s-1-e-5-i-1-pd-2-st-0.5-ot-0.8-nocirc-s-1.0-i-1.0-R-6.0.bin";
  //std::string out_name = params_.match_folder_ + inp.name1 + "-" + inp.name2 + params_.shock_match_params_.output_file_postfix_ + ".bin";
  //std::string out_name = "donkey1-model-nocirc-s-1-e-10-i-1-dog2-nocirc-color-s-1-e-5-i-1-pd-2-st-0.5-ot-0.8-nocirc-s-1.0-i-1.0-R-6.0.bin";
  //std::string out_name = "Y:\\99-db\\orl-exps\\matches\\protos-protos\\match_set\\donkey1\\donkey1-cat1_e_d_data_1_1_off_off_6_off_off_off.bin";
  //std::string out_name = "Y:\\99-db\\orl-exps\\matches\\protos-del-1-1-1\\match_set\\skyhawk\\skyhawk-cat2_e_d_data_1_1_off_off_6_off_off_off.bin";
  //std::string out_name = "Y:\\99-db\\orl-exps\\matches\\protos-del-1-1-1\\match_set\\donkey1\\donkey1-cat2_e_d_data_1_1_off_off_6_off_off_off.bin";
  std::string out_name = path_initial + "99-db" + sep + "orl-exps" + sep + "matches" + sep + "protos-" + set_name + sep + "match_set" + sep + name1 + sep + name1 + "-" + name2 + "_e_d_data_1_1_off_off_6_off_off_off.bin";
  ...
  if (detection_box) {
    std::cout << "detected box with area: " << detection_box->area() << " box: " << *detection_box << std::endl;
  } else {
