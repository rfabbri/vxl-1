...
typedef std::map<int, std::vector<std::pair<int, std::vector<dbcvr_cv_cor_sptr> > >* > patch_curve_cor_map_type;
typedef std::map<int, std::vector<std::pair<int, std::vector<dbcvr_cv_cor_sptr> > >* >::iterator patch_curve_cor_map_iterator;
...
*/
 ...
 // std::pair<int, std::vector<float> >& get_best_match(int patch_id) { return (*patch_cor_map_[patch_id])[0]; }
  ...
  virtual std::string is_a() const {return "dbskr_shock_patch_curve_match";}
...
public:
  ...
  std::vector<dbcvr_cv_cor_sptr> curve_cor_;
  std::vector<std::pair<int, std::vector<dbcvr_cv_cor_sptr> > >* left_curve_v_;
