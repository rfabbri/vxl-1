// This is brcv/rec/dbskr/vis/dbskr_shock_patch_match_displayer.h
#ifndef dbskr_shock_patch_match_displayer_h_
#define dbskr_shock_patch_match_displayer_h_

//:
// \file
// \brief This file defines the displayer class that is responsible
//        for generating a tableau out of dbskr_shock_patch_match_storage_sptr.
...
class dbskr_shock_patch_match_displayer : public bvis1_displayer 
{
public:
  dbskr_shock_patch_match_displayer(){}

  //: Return type string "shock_patch_match"
...
#endif // dbskr_shock_patch_match_displayer_h_
