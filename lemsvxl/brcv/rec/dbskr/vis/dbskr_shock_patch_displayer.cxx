// This is brcv/rec/dbskr/vis/dbskr_shock_patch_displayer.cxx

//:
// \file

#include "dbskr_shock_patch_displayer.h"
...
vgui_tableau_sptr
dbskr_shock_patch_displayer::make_tableau( bpro1_storage_sptr storage) const
{
  ...
  dbskr_shock_patch_storage_sptr shock_storage;
  shock_storage.vertical_cast(storage);

  // Create a new shock tableau
  dbskr_shock_patch_tableau_sptr shock_tab = dbskr_shock_patch_tableau_new();
  //set the boundary, instrinsic shock graph and the coarse shock graph
  shock_tab->set_patches(shock_storage->get_patches());
