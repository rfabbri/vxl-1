...
//: Default constructor
dbskr_shock_tree::
dbskr_shock_tree(float scurve_sample_ds, float interpolate_ds, float matching_R):
...
void dbskr_shock_tree::clear(void) 
{
  dart_paths_.clear();
...
{
  sg_ = sg;
  dbskr_shock_tree otree(scurve_sample_ds_);
...
bool dbskr_shock_tree::acquire(dbsk2d_shock_graph_sptr sg, bool elastic_splice_cost, 
...
vsol_polygon_2d_sptr dbskr_shock_tree::
