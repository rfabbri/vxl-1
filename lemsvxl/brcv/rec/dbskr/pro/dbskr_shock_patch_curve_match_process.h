// This is dbskr/pro/dbskr_shock_patch_curve_match_process.h
#ifndef dbskr_shock_patch_curve_match_process_h_
#define dbskr_shock_patch_curve_match_process_h_
...
class dbskr_shock_patch_curve_match_process : public bpro1_process
{
public:
  dbskr_shock_patch_curve_match_process();
  virtual ~dbskr_shock_patch_curve_match_process() {}
  
  virtual vcl_string name() {
    return "Match Shock Patches using Elastic Curve Matching";
  }
...
#endif // dbskr_shock_patch_curve_match_process_h_
