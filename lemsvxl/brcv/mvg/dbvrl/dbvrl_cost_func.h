// This is algo/dbvrl/dbvrl_cost_func.h
#ifndef dbvrl_cost_func_h_
#define dbvrl_cost_func_h_
//:
// \file
...
// by minimizing square difference in intensities
class dbvrl_cost_func : public vnl_cost_function
{
public:
  //: Constructor
  dbvrl_cost_func( const vil_image_view<float>& image1,
