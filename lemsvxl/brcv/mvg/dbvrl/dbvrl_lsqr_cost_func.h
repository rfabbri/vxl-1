// This is algo/dbvrl/dbvrl_lsqr_cost_func.h
#ifndef dbvrl_lsqr_cost_func_h_
#define dbvrl_lsqr_cost_func_h_
//:
// \file
...
// by minimizing square difference in intensities
class dbvrl_lsqr_cost_func : public vnl_least_squares_function
{
public:
  //: Constructor (no masks)
  dbvrl_lsqr_cost_func( const vimt_image_2d_of<float>& image1,
