...
public:
   ...
   std::vector<edge_arc * > in_edges;
   std::vector<edge_arc * > out_edges;

   //std::vector<std::pair<double,std::vector<std::pair<dbetrk_edge_sptr,dbetrk_edge_sptr> > > >  particles;


   std::vector<std::vector<dbetrk_edge_sptr>  > particles;
  std::vector<double>  prob_particles;
