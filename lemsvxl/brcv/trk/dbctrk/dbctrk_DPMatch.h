...
class dbctrk_DPMatch
{
 public:
  ...
  dbctrk_DPMatch(std::vector<std::pair<double,double> > v1,
  ...
  std::vector <std::pair <int,int> > finalMap(){return finalMap_;};
  std::vector< double > finalMapCost(){return finalMapCost_;};
  int n(){return n_;};
  int m(){return m_;};

  void lambda(std::vector<double> l){lambda_=l;};
  ...
  void match();
  void endPointMatch();
  void detect_tail(std::vector<int> &tail1,std::vector<int> &tail2);
  ...
  std::map<int,int> refine_mapping();
  ...
  std::vector<std::vector<double> > I1pos;
  std::vector<std::vector<double> > I2pos;
  std::vector<std::vector<double> > I1neg;
  std::vector<std::vector<double> > I2neg;
 ...
 protected:
  ...
  std::vector< std::pair <int,int> > finalMap_;
  double finalCost_;
  std::vector< double > finalMapCost_;
  int n_;
  int m_;
  bool flip_;
  vnl_double_2 ep_;
