#ifndef dbctrk_intensity_tool_
#define dbctrk_intensity_tool_
#include "engine.h"
#include "matrix.h"
...
class dbctrk_intensity_tool : public bvis1_tool
{
public:
  dbctrk_intensity_tool();
  virtual ~dbctrk_intensity_tool();
