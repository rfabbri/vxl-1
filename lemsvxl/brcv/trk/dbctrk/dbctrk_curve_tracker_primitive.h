#ifndef dbctrk_curve_tracker_primitive_h_
#define dbctrk_curve_tracker_primitive_h_
...
//-----------------------------------------------------------------------------
class dbctrk_curve_tracker_primitive
{
 public:
  // Parameters
  ...
  dbctrk_curve_tracker_primitive(){}
  dbctrk_curve_tracker_primitive(int id, vdgl_edgel_chain_sptr curve){ init(id, curve); }
  ~dbctrk_curve_tracker_primitive(){}
...
#endif // dbctrk_curve_tracker_primitive_h_
