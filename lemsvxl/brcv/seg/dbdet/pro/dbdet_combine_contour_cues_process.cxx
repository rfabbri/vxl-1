...
std::vector< std::string > dbdet_combine_contour_cues_process::get_input_type()
{
...
std::vector< std::string > dbdet_combine_contour_cues_process::get_output_type()
{
  bool boutput_res;
...
dbdet_combine_contour_cues_process::execute()
{
  ...
  if (input_data_.size() != 1 ){
    std::cout << "In dbdet_combine_contour_cues_process::execute() - only one color image needed!\n";
    return false;
  }
  clear_output();
