// This is brcv/seg/dbdet/pro/dbdet_combine_contour_cues_process.cxx

//:
// \file

#include "dbdet_combine_contour_cues_process.h"
...
//: Constructor
dbdet_combine_contour_cues_process::dbdet_combine_contour_cues_process()
{
...
//: Clone the process
bpro1_process*
dbdet_combine_contour_cues_process::clone() const
{
  return new dbdet_combine_contour_cues_process(*this);
}


//: Return the name of this process
vcl_string
dbdet_combine_contour_cues_process::name()
{
  return "Combine Multiple Contour Cues";
}


//: Return the number of input frame for this process
int
dbdet_combine_contour_cues_process::input_frames()
{
  return 1;
}
...
int
dbdet_combine_contour_cues_process::output_frames()
{
  return 1;
}
...
vcl_vector< vcl_string > dbdet_combine_contour_cues_process::get_input_type()
{
...
vcl_vector< vcl_string > dbdet_combine_contour_cues_process::get_output_type()
{
  bool boutput_res;
...
//: Execute the process
bool
dbdet_combine_contour_cues_process::execute()
{
  ...
  if (input_data_.size() != 1 ){
    vcl_cout << "In dbdet_combine_contour_cues_process::execute() - only one color image needed!\n";
    return false;
  }
  clear_output();
...
bool
dbdet_combine_contour_cues_process::finish()
{
  return true;
}
