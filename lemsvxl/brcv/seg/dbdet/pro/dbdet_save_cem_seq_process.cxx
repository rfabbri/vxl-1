...
std::string dbdet_save_cem_seq_process::name() 
{
  return "Save .CEM seq Files";
}

std::vector< std::string > dbdet_save_cem_seq_process::get_input_type() 
{
...
std::vector< std::string > dbdet_save_cem_seq_process::get_output_type() 
{
  std::vector< std::string > to_return;
  return to_return;
}
...
{ 
  ...
  std::string output_file = cem_filename.path;  
  ...
  {  
	  ...
	  //std::string output_file_1 = output_file + "_" + convert.str() + ".cem";
	  std::string output_file_1 = output_file + "_" + num2str_frame(sindex+i) + ".cem";
