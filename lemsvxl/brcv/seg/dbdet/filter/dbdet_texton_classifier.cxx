...
vnl_matrix<unsigned> dbdet_texton_classifier::classify(std::vector<vil_image_view<double> > decomposed)
{
  ...
  std::vector<double> x2(xs, 0.);
  std::vector<double> y2(ys, 0.);
