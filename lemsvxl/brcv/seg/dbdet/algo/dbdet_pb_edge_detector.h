...
public:
    dbdet_pb_edge_detector(const std::string& temp_dir);
    ...
    dbdet_edgemap_sptr detect_bgtg(vil_image_view<vxl_byte>& image, const std::string& pres, double radius[], int norient);
