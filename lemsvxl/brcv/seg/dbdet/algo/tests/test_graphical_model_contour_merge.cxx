...
{
  double x_diff = std::abs(e1->pt.x() - e2->pt.x());
  double y_diff = std::abs(e1->pt.y() - e2->pt.y());
      ...
      )
{
  ...
  std::string frags_ref_path = base_path + "2018_merged.cem";
  std::string frags_ori_path = base_path + "2018_geom.cem";
