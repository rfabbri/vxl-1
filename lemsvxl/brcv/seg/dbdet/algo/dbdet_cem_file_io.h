...
dbdet_edgemap_sptr dbdet_load_cem_v1(std::ifstream &infp, dbdet_curve_fragment_graph& CFG, int width = 3000, int height = 3000, bool convert_degrees_to_radians = true);
