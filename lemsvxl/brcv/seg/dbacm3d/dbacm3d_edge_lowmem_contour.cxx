...
#include "dbacm3d_edge_lowmem_contour.h"
...
#include <dbacm3d/dbacm3d_edge_lowmem_levelset_func.h>
#include <dbacm3d/dbacm3d_image_filters.h>


//: Constructor
dbacm3d_edge_lowmem_contour::
dbacm3d_edge_lowmem_contour(const vil3d_image_view<float> & edges, const vil3d_image_view<bool> & no_go_image)
:twoD_hack_(0)
{
  this->levelset_func_ = new dbacm3d_edge_lowmem_levelset_func(edges,no_go_image);
}


// -------------------------------------------------------------------
//: Set parameters of levelset function
void dbacm3d_edge_lowmem_contour::
...
{ 
  ...
  ((dbacm3d_edge_lowmem_levelset_func*)this->levelset_func().ptr())->set_twoD_hack(twoD_hack_);
  ((dbacm3d_edge_lowmem_levelset_func*)this->levelset_func().ptr())->set_edgeT(edgeT_);
