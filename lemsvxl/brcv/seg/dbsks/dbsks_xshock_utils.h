...
bool dbsks_fill_in_silhouette(const dbsksp_xshock_graph_sptr& xgraph, const vil_image_view<vxl_byte >& image, std::vector<vgl_point_2d<int > >& points, vil_image_view<vxl_byte >& screenshot_image);
