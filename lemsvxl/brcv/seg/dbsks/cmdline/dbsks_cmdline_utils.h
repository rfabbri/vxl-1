...
bool dbsks_batch_ps_to_jpeg(const std::string& input_folder, const std::string& output_folder, 
                        const std::string& ps_file_extension = ".ps");
...
bool dbsks_compute_pos_xgraph_ccm_cost(const std::string& xgraph_list_file,
                                   const std::string& xshock_folder,
                                   const std::string& image_folder,
                                   const std::string& image_extension,
                                   const std::string& edgemap_folder,
                                   const std::string& edgemap_extension,
                                   const std::string& edgeorient_folder,
                                   const std::string& edgeorient_extension,
                                   const std::string& cemv_folder,
                                   const std::string& cemv_extension,
                                   int root_vid, 
                                   int major_child_eid,
                                   const std::string& output_file);
