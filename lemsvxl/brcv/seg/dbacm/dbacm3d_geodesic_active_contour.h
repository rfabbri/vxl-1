// This is brcv/seg/dbacm3d/dbacm3d_geodesic_active_contour.h
#ifndef dbacm3d_geodesic_active_contour_h_
#define dbacm3d_geodesic_active_contour_h_
//:
// \file
...
#include <dbacm/dbacm3d_levelset_driver.h>


//: A class implementing geodesic active contour model
// Reference: Caselles, V., et al. "Geodesic Active Contours." IJCV97.
class dbacm3d_geodesic_active_contour : public dbacm3d_levelset_driver
{
 public:
  //: Constructor
  ...
  //: Destructor
  virtual ~dbacm3d_geodesic_active_contour() {}
...
#endif // dbacm3d_geodesic_active_contour_h_
