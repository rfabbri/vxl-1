// This is brcv/seg/dbacm/vis/dbacm_geodesic_active_contour_tool.cxx
//:
// \file

#include "dbacm_geodesic_active_contour_tool.h"
...
void dbacm_geodesic_active_contour_tool::
activate() 
{
//  this->contour_.clear();
...
//
  vcl_cout << "\nGeodesic Active Contour Segmentation tool is activated!!!\n";
}

// ------------------------------------------------------------------
//: Set the tableau to work with
bool dbacm_geodesic_active_contour_tool::
