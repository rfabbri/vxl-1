# lemsvxl/config/cmake/LEMSStandardOptions.cmake
#
# This CMake module is included by lemsvxl/CMakeLists.txt.  It adds
# several lemsvxl-standard testing and build options to the project:
#
#  LEMS_BUILD_SHARED_LIBS
#  BUILD_TESTING
#  BUILD_EXAMPLES
#  WARN_DEPRECATED
...
#
# This module may be automatically included by UseLEMS.cmake.
# See lemsvxl/config/cmake/UseLEMS.cmake for details.
#

# Everything here should be valid for both the lemsvxl source and for
# client projects.
...
if(WARN_DEPRECATED)
  add_definitions( -DLEMS_WARN_DEPRECATED )
  if(WARN_DEPRECATED_ONCE)
    add_definitions( -DLEMS_WARN_DEPRECATED_ONCE )
  endif()
  if(WARN_DEPRECATED_ABORT)
    add_definitions( -DLEMS_WARN_DEPRECATED_ABORT )
  endif()
endif()
...
if(WIN32)
       if(NOT MINGW)
         if(NOT LEMS_ENABLE_VISUAL_STUDIO_DEPRECATED_C_WARNINGS)
           add_definitions(
         ...
         if(MSVC_VERSION GREATER 1310)
           set(LEMS_REQUIRED_CXX_FLAGS "${LEMS_REQUIRED_CXX_FLAGS} /bigobj")
         endif()
       endif()
endif()
