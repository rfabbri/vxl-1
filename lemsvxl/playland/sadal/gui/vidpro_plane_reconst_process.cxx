...
vidpro_plane_reconst_process::vidpro_plane_reconst_process()
{
  ...
  {
    std::cerr << "ERROR: Adding parameters in vidpro_plane_reconst_process::vidpro_plane_reconst_process()" << std::endl;
  }
}
...
vidpro_plane_reconst_process::execute()
{
  ...
  if ( input_data_.size() != 1 ){
    std::cout << "In vidpro_plane_reconst_process::execute() - not exactly two"
