...
std::vector< std::string > vidpro_kltrack_process::get_input_type()
{
...
std::vector< std::string > vidpro_kltrack_process::get_output_type()
{  
  std::vector<std::string > to_return;
...
vidpro_kltrack_process::execute()
{
 int num_of_frames;
  ...
  if ( input_data_.size() !=  num_of_frames ){
    std::cout << "In vidpro_kltrack_process::execute() - "
  ...
  std::vector<vidpro_image_storage_sptr> frame_image(num_of_frames);
  std::vector<vil_image_resource_sptr> images(num_of_frames);
  std::vector<vidpro_image_storage_sptr>::const_iterator frame_iter= frame_image.begin();
