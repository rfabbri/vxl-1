...
#include "vidpro_homog_view_process.h"
...
//: Constructor
vidpro_homog_view_process::vidpro_homog_view_process()
{
...
vidpro_process *
vidpro_homog_view_process::clone() const
{
    return new vidpro_homog_view_process(*this);

};
//: Return the number of input frame for this process
int
vidpro_homog_view_process::input_frames()
{
...
int
vidpro_homog_view_process::output_frames()
{
...
//: Execute the process
bool
vidpro_homog_view_process::execute()
{
...
//: Finish
bool
vidpro_homog_view_process::finish()
{
