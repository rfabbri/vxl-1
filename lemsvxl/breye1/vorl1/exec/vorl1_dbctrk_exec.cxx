...
int main(int argc, char** argv)
{
  ...
  std::string output_ps = vorl1_manager::instance()->get_output_ps_dir(); 
//  std::string output_video_dir = vorl1_manager::instance()->get_output_video_dir(); 
  std::string video_assoc_dir = vorl1_manager::instance()->get_video_assoc_dir()+"//contour"; 
