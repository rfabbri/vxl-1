...
bfrag_Menu::add_to_menu( vgui_menu & menu )
{
    vgui_menu fileItems;
        ...
        fileItems.add( "Add A &Puzzle...", addPuzzle, (vgui_key)'P', vgui_CTRL );       
        fileItems.separator();
    ...
    vgui_menu pieces;
        ...
        pieces.add( "&Top Images", topImageSettings );
...
void bfrag_Menu::load(){
    ...
    vcl_string ext = "*.pz2";
    vcl_string fileToOpen;
    params.file("Puzzle File To Load (*.pz2)", ext, fileToOpen);
