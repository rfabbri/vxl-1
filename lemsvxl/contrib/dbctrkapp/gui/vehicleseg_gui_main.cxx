...
#include <vidpro1_blob_finder_process.h>
...
int main(int argc, char** argv)
{
    ...
    REG_PROCESS( vidpro1_robust_intensity_register_process );
    REG_PROCESS( vidpro1_robust_bg_model_process );
    REG_PROCESS( vidpro1_blob_finder_process );
    ...
    //REG_PROCESS( dbctrk_pairing_curves_process );
