...
#include <dbvis1_image_intensity_inspector.h>
...
vehicleseg_gui_menu::setup_menu()
{
    ...
    MENU_ADD_PROCESS_NAME( "BG model", motion_detection_group_menu );
    MENU_ADD_PROCESS_NAME( "Robust BG model", motion_detection_group_menu );
