...
#include <dboxm/boxm_utils.h>
#include <dboxm/boxm_block.h>
#include <dboxm/boxm_cell_vis_graph_iterator.h>
#include <dboxm/boxm_block_vis_graph_iterator.h>
#include <vil/vil_math.h>
#include <vul/vul_timer.h>
#include <dboxm/boxm_render_image.h>
#include <iostream>
#include <dboxm/boxm_raytrace_operations.h>
#include <dboxm/boxm_rational_camera_utils.h>
          ...
          if (cube_mean(xverts, yverts, vertdists, vis_face_ids,img,cell_mean_obs)) {
            ...
            if (!((cell_PI >= 0) && (cell_PI < 1e8)) ) {
              std::cout << std::endl << "cell_PI = " << cell_PI << std::endl
                       << "  cell_obs = " << cell_mean_obs << std::endl
