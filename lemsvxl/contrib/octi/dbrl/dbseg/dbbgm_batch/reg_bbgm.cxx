...
#include <dbbgm/pro/bbgm_processes.h>
#include <dbbgm/pro/bbgm_register.h>
...
{
	manager_type.ob_type=&PyType_Type;
	manager_type.tp_name="dbbgm_batch.manager_type"	;
}  */
PyMODINIT_FUNC
initdbbgm_batch(void)
{
  PyMethodDef reg_pro;
  ...
  dbbgm_batch_methods[0]=reg_pro;
  dbbgm_batch_methods[1]=reg_data;

  for (int i=0; i<METHOD_NUM; ++i) {
    dbbgm_batch_methods[i+2]=batch_methods[i];
  }
//  register_python_types();

  Py_InitModule("dbbgm_batch", dbbgm_batch_methods);
}
