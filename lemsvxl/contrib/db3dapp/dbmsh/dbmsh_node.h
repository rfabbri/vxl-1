...
public:
  ...
  std::set<dbmsh_face*> getFaces() { return _faces; }
  std::set<dbmsh_link*> getLinks() { return _links; }
  ...
  std::vector<dbmsh_face*> commonFaces( dbmsh_node* node );
