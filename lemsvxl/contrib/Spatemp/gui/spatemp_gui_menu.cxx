...
/*************************************************************************
 * Function Name: spatemp_gui_menu::spatemp_gui_menu
 * Parameters: 
 * Effects: 
 *************************************************************************/

spatemp_gui_menu::spatemp_gui_menu() 
{
}


/*************************************************************************
 * Function Name: spatemp_gui_menu::setup_menu
 * Parameters: 
 * Returns: vgui_menu
 * Effects: 
 *************************************************************************/
vgui_menu
spatemp_gui_menu::setup_menu()
{
  vgui_menu MainMenu;
  ...
  FILE_MENU_ADD_PROCESS_NAME( ".EDG Video", "Load .EDG Video", load_menu );


  MENU_ADD_PROCESS_NAME2( ".EDG", "Save .EDG File", save_menu);
  MENU_ADD_PROCESS_NAME2( ".EDG Video", "Save .EDG Video", save_menu);
  ...
  vgui_menu  motion_detection_group_menu; // Motion Detection
    ...
    MENU_ADD_PROCESS_NAME( "Curve Tracking",   motion_detection_group_menu );
    MENU_ADD_PROCESS_NAME( "KL Tracking", motion_detection_group_menu );
  ...
  vgui_menu  other_group_menu; // Other
    ...
    MENU_ADD_PROCESS_NAME( "Display Edge Maps", other_group_menu );
    MENU_ADD_PROCESS_NAME( "Form Temporal Bundles", other_group_menu );
    MENU_ADD_PROCESS_NAME( "Forward Beta Map", other_group_menu );
    MENU_ADD_PROCESS_NAME( "Backward Beta Map", other_group_menu );
    ...
    MENU_ADD_PROCESS_NAME( "Curve Detection", edge_detection_group_menu );
  ...
  /////////////// Tools Menu ///////////////
  vgui_menu tools;
  vgui_menu vsol2D_tools_menu, vsol2D_draw_tools_menu, edge_tools_menu;
