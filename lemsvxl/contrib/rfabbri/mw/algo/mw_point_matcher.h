...
public:
  ...
  bool trinocular_DG_match_cost_band( 
    const bdifd_2nd_order_point_2d &pt_img1, 
    const bdifd_2nd_order_point_2d &pt_img2, 
    const bdifd_2nd_order_point_2d &pt_img3, 
    unsigned iv0, 
    unsigned iv1, 
    unsigned iv2, 
    bdifd_rig &rig12,
  ...
  static bool trinocular_tangent_match_cost_band_1way
    (
      ...
      double t_err,
      const bdifd_camera &cam2,
      const bdifd_rig &rig01,
      reason *reason
    )
  {
    ...
    bool valid = 
      bdifd_transfer::transfer_tangent_band( p0,p1,t_err, &theta_min_reproj,&theta_max_reproj, cam2, rig01);
    ...
    bool has_intersection = 
      bdifd_transfer::has_tangent_band_intersection(p2.t[0],p2.t[1],t_err, theta_min_reproj,theta_max_reproj);
    if (!has_intersection) {
