...
protected:
  ...
  std::vector<mw_camera> cam_; //: cameras for each view
  std::vector<vil_image_view<float> > img_; //: cameras for each view
  ...
  std::vector<dbdet_edgel_chain *> selected_crv_; //:< selected curve in each view (for reconstruction, etc)
