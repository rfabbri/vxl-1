...
{
  return "Trinocular Curve Tracing";
}
...
//: Compute epipolar line in left image from an epipolar line in the left
// image, given fundamental matrix from left to right image. Zisserman 2nd
// edition p. 247
//
vgl_homg_line_2d<double> mw_curve_tracing_tool_3::
l_epipolar_line(
...
{
  vgl_homg_point_2d<double> e, e_prime, e_prime_prime;
  fm_->get_epipoles(e,e_prime);
  fm_02_->get_epipoles(e,e_prime_prime);

  break_curves_into_episegs(vsols_[0], e, frame_v_[0], 0 /*view*/);
  break_curves_into_episegs(vsols_[1], e_prime, frame_v_[1], 1 /*view*/);
  break_curves_into_episegs(vsols_[2], e_prime_prime, frame_v_[2], 2 /*view*/);
