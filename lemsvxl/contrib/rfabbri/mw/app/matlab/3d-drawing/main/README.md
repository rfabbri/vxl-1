...
#### 3. Enhanced reconstruction: generate attributes
 a. go lemsvpe/vxd-bin/bin and make a copy of mcs_e for your dataset.
 ...
 This will also generate the attributes and .dat files needed for 3D curve drawing code.
