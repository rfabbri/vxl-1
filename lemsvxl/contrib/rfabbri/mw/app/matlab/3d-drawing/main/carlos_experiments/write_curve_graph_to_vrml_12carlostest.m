...
%Open the file
fid = fopen('/media/biao/ubuntuSSD/datasets/pavilion-midday-half/ply/curve_graph_pavilion_mixed_12.ply','w');
...
%Open the file
fid = fopen('/media/biao/ubuntuSSD/datasets/pavilion-midday-half/ply/curve_junctions_pavilion_mixed_12.ply','w');
