...
%     v = all_views(1,vind);
% 
%     mypath=['./paper-runs/amsterdam_house/quarter-full/',num2str(v)];
%     recs = cell(0,0);
%     tangs = cell(0,0);
% 
...
% %for v=1:1
%     all_views(1,v)
%     cons = read_cons(['./curves/',num2str(all_views(1,v),'%08d'),'.cemv'],[num2str(all_views(1,v),'%08d'),'.jpg'],0,-1);
...
%     
%     cons = read_cons(['./curves/',num2str(all_views(1,vv),'%08d'),'.cemv'],[num2str(all_views(1,vv),'%08d'),'.jpg'],0,-1);
%     num_im_contours = size(cons,2);
%     
%     %Load the image curve-edge links for this view
%     fid = fopen(['./curve-edge/',num2str(all_views(1,vv),'%08d'),'.txt']);
%     
...
load intermediate-complete-quarter.mat;
...
%         end
        ...
        save('curve_graph_amsterdam_quarter.mat','complete_curve_graph','all_junctions');
    end
end
