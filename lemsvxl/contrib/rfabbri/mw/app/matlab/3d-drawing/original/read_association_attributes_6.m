function [links_3d, offsets_3d, edge_support_3d] = read_association_attributes_6(view,num_image_curves,num_3d_curves,num_views)

    fid=fopen(['./association_attributes/6/attributes_' num2str(view) '.txt']);
