...
% for v=1:numIM
% 
%     mypath=['./paper-runs/pavilion-midday-half/',num2str(v-1),'/6/'];
%     recs = cell(0,0);
%     tangs = cell(0,0);
% 
...
load intermediate-pavilion-midday-half_6.mat;
...
save('curve_drawing_pavilion_midday_half_6_10x_prune_medium_conv.mat','complete_curve_graph','all_junctions','complete_lock_map');
