...
for v=1:numIM
    ...
    mypath=['./paper-runs/pavilion-mixed-half/',num2str(v-1),'/10/'];
    recs = cell(0,0);
    tangs = cell(0,0);
...
save intermediate-pavilion-mixed-half_10.mat;
...
save('curve_drawing_pavilion_mixed_half_10.mat','complete_curve_graph','all_junctions');
