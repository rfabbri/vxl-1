...
mypath='./amsterdam-house-quarter-size-test-subset-single-anchor-mcs-work/association_runs/13';
%mypath='./amsterdam-house-quarter-size-test-subset-single-anchor-mcs-work/10';
%mypath='./out';
recs = cell(0,0);
tangs = cell(0,0);
