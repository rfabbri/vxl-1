...
for v=1:numIM
    ...
    mypath=['./paper-runs/vase-eval/',num2str(v-1),'/6/'];
    recs = cell(0,0);
    tangs = cell(0,0);
...
%for v=1:1
    ...
    num_im_contours = size(cons,2);
    [all_links_3d{all_views(1,v)+1,1}, all_offsets_3d{all_views(1,v)+1,1}, all_edge_support_3d{all_views(1,v)+1,1}] = read_association_attributes_6(all_views(1,v),num_im_contours,all_nR(all_views(1,v)+1,1),numIM);
    all_num_im_contours(all_views(1,v)+1,1) = num_im_contours;
...
write_curve_graph_to_vrml_6;
save('curve_drawing_vase_6.mat','complete_curve_graph','all_junctions');
