...
mydir{8} = '/home/rfabbri/tmp/dino/new-20091102/new-length20-ratio-no_lonely-5conf'
mydir{9} = '/home/rfabbri/tmp/dino/new-20091102/new-length20-no_ratio-no_lonely-5conf'


num_dirs=length(mydir);

for i=1:num_dirs
  plot_save_pr_fn(mydir{i});
end
