...
% - nx1: x coordinates of the points in image 1
% - ny1: y coordinates of the points in image 1

% - nx2: x coordinates of the corresponding points in image 2
% - ny2: y coordinates of the corresponding points in image 2
% - no_matches: number of matches == length(nx1);
% - m3: homogeneous scaling. Usually set to 1.
