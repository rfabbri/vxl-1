...
%matriz aleatória, distribuicão normal com média 0 e sigma 200
Norm=200*randn(30,2);  

%matriz de coordenadas de 10 pontos (em cada câmera) gerados a partir do pt 488 com ruído da gaussiana com média 0 e sigma 200
for j=1:10
        MRAND(3*j-2:3*j,:)=M488(1:3,:)+Norm(3*j-2:3*j,:)
end

writematrix(MRAND, 'MRAND488.txt', 'Delimiter', 'tab');