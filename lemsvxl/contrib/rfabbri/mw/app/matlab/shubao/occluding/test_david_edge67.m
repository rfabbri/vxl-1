...
resultpath = '../result/david_edge67/';
...
for i = 1:data.imnum
    ...
    if DEBUG
        imwrite(full(data.edgemap{i}), ['../debug/david_edge67/' 'edgemap_' int2strfixed(i,4) '.png']);
    end
...
if DEBUG
    save('../debug/david_edge67/programdata.mat');
end

[pts3drawcell, confrawcell] = struct_from_sil(data,1,10,'david_edge67');
