...
%% parameters controlling the output
    resultpath = '../result/david_edge42/';
...
fprintf(1, 'Loading data and computing the edges with gradient and orientation ...\n');
    ...
    for i = 1:data.imnum
        ...
        if DEBUG
            imwrite(full(data.edgemap{i}), ['../debug/david_edge42/' 'edgemap_' int2strfixed(i,4) '.png']);
        end
    ...
    if DEBUG
        save('../debug/david_edge42/programdata.mat');
    end

%% main work
    [pts3drawcell, normalrawcell confrawcell] = struct_from_sil(data,1,10,'david_edge42');
