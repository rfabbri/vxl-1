...
main(int argc, char **argv)
{
  ...
  vul_arg<std::string> a_prefix("-prefix", "path to directory of files (suffixed with slash)",prefix_default);
  ...
  std::cout << "fname1: " <<  a_fname1() 
    << "\tfname2: " << a_fname2() 
    << "\tfname3: " << a_fname3() << std::endl 
    << "prefix: " << a_prefix()  << std::endl
    << "corresp_out: " << a_corresp_out()
    << "\tcorresp_gt: " << a_corresp_gt()
    << "\tprecomputed_epip: " << a_precomputed_epip() << std::endl
    << "\tedgels1: " << a_edgels1() 
    << "\tedgels2: " << a_edgels2() 
    << "\tedgels3: " << a_edgels3()  << std::endl
    << std::endl;
  ...
  app.run_stereo();
  std::string p1 = a_out_path() + a_corresp_out();
  std::string p2 = a_out_path() + std::string("out/") + a_precomputed_epip();
