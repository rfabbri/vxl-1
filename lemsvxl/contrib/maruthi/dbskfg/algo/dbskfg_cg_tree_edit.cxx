    ...
    if (iter == pathtable_.end()) 
    {
        ...
        else 
        {
            ...
            else
            {
                ...
                {
                    std::vector<vnl_vector_fixed<vl_sift_pix,128 > > tree1_sift;
                    std::vector<vnl_vector_fixed<vl_sift_pix,128 > > tree2_sift;
                    ...
                    //     model_file<<tree1_sift.size()<<std::endl;
                    ...
                    //     query_file<<tree2_sift.size()<<std::endl;
