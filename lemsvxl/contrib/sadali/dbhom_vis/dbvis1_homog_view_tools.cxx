...
dbvis1_homog_view_tool::handle( const vgui_event & e, const bvis1_view_tableau_sptr& selector)
{
        ...
        if (active_&&!end_sel_flag)
        {
                ...
                if (gesture_end_sel_(e))
                {
                        ...
                        drawnpt_vgl.push_back(vgl_point_2d<double>(last_x, last_y));
                        ...
                        vgl_polygon<double> drawn_vgl(drawnpt_vgl);
...
void dbvis1_homog_view_tool::putative_correspondences(std::vector<vsol_point_2d_sptr >  &featurepts1,std::vector<vsol_point_2d_sptr >      &featurepts2,
