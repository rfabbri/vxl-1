...
vidpro1_combine_storage_process::vidpro1_combine_storage_process()
{
  ...
  {
    std::cerr << "ERROR: Adding parameters in vidpro1_combine_storage_process::vidpro1_combine_storage_process()" << std::endl;
  }
}
...
vidpro1_combine_storage_process::execute()
{
  ...
  if ( input_data_.size() != 1 ){
    std::cout << "In vidpro1_combine_storage_process::execute() - not exactly two"
