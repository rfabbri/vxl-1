...
vidpro1_factorize_process::vidpro1_factorize_process()
{
  ...
  {
    vcl_cerr << "ERROR: Adding parameters in vidpro1_factorize_process::vidpro1_factorize_process()" << vcl_endl;
  }
}
...
int num_of_frames;
  ...
  if ( input_data_.size() != num_of_frames ){
    vcl_cout << "In vidpro1_factorize_process::execute() - not exactly one"
