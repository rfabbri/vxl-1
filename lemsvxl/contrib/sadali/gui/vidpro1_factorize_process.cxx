// This is contrib/sadali/vidpro1_factorize_process.cxx

//:
// \file

#include "vidpro1_factorize_process.h"
...
#include <bfac/bfac_factorization.h>
...
//: Constructor
vidpro1_factorize_process::vidpro1_factorize_process()
{
  ...
  {
    std::cerr << "ERROR: Adding parameters in vidpro1_factorize_process::vidpro1_factorize_process()" << std::endl;
  }
}
...
bpro1_process* vidpro1_factorize_process::clone() const
{
    return new vidpro1_factorize_process(*this);
}


//: Return the name of this process
std::string
vidpro1_factorize_process::name()
{
...
int
vidpro1_factorize_process::input_frames()
{
...
int
vidpro1_factorize_process::output_frames()
{
int framenum;
parameters()->get_value("-num_input_frames",framenum);
 if (framenum<2)
...
vidpro1_factorize_process::get_input_type()
{
...
std::vector< std::string > 
vidpro1_factorize_process::get_output_type()
{  
...
//: Execute the process
bool
vidpro1_factorize_process::execute()
{
int num_of_frames;
  ...
  if ( input_data_.size() != num_of_frames ){
    std::cout << "In vidpro1_factorize_process::execute() - not exactly one"
  ...
  std::vector<vidpro1_vsol2D_storage_sptr> feat_pts(num_of_frames); 
 ...
 bfac_reconstructor *Reconstructor = new bfac_reconstructor(obs_matrix, vrml_fname+".vrml"  );
  ...
  vidpro1_vsol3D_storage_sptr output_vsol3d = vidpro1_vsol3D_storage_new();
...
//: Finish
bool
vidpro1_factorize_process::finish()
{
