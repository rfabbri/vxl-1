...
vidpro1_homog_view_process::vidpro1_homog_view_process()
{
  ...
  {
    std::cerr << "ERROR: Adding parameters in vidpro1_homog_view_process::vidpro1_homog_view_process()" << std::endl;
  }
}
...
vidpro1_homog_view_process::execute()
{
  ...
  if ( input_data_.size() != 1 ){
    std::cout << "In vidpro1_homog_view_process::execute() - not exactly two"
