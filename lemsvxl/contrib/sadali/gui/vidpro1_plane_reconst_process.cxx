...
vidpro1_plane_reconst_process::vidpro1_plane_reconst_process()
{
  ...
  {
    vcl_cerr << "ERROR: Adding parameters in vidpro1_plane_reconst_process::vidpro1_plane_reconst_process()" << vcl_endl;
  }
}
...
vidpro1_plane_reconst_process::execute()
{
  ...
  if ( input_data_.size() != 1 ){
    vcl_cout << "In vidpro1_plane_reconst_process::execute() - not exactly two"
