#ifndef dbvis1_polyg_select_img_tool_header
#define dbvis1_polyg_select_img_tool_header
...
class dbvis1_polyg_select_img_tool : public bvis1_tool
{
public:
  dbvis1_polyg_select_img_tool();
  virtual ~dbvis1_polyg_select_img_tool();
...
protected:
  ...
  std::vector< vsol_point_2d_sptr > bound_box_vert;
  std::vector< vgl_point_2d<double> > drawnvert;
  std::vector< vsol_point_2d_sptr > drawnvert_so;
