#ifndef aerial_vehicle_detection_dll
#define aerial_vehicle_detection_dll

#ifdef WIN32
#ifdef aerial_vehicle_detection_api_EXPORTS
...
extern "C" VEHICLE_API void detectvehicle(char *input_vid,unsigned int maxComp,float initialstd,
                                           float intialweight,float sigmathresh,float minweightthresh,
                                           int min_no_of_pixels,int max_no_of_pixels,float erosionrad,
                                           float postdilationerosionrad,float dilationrad, char *polyfile);
