                           ...
                           double radius = 8.0)
{
  ...
  typedef std::vector<dbdet_keypoint_sptr>::const_iterator kitr;
...
int main(int argc, char** argv)
{
  ...
  vul_arg<std::string>  a_on_surf("-on_surf", "path to \"on surface\" flag output", "");
  ...
  if(a_surf.set()){
    ...
    typedef std::vector<modrec_desc_feature_3d<64> > feat_vector;
  ...
  graph["on_surf_snk"] = new dbpro_b_ostream_sink<std::vector<bool> >(a_on_surf());
