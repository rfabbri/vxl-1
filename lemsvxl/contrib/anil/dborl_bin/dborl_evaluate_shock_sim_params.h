...
#ifndef dborl_evaluate_shock_sim_params_h_
#define dborl_evaluate_shock_sim_params_h_
...
public:
  ...
  { 
    ...
    output_dir_.set_values(param_list_,  "io",  "output_folder",  "output folder to store results", "evaluate_shock_sim", 
      "evaluate_shock_sim", 
      0,   // associate to 0th input object
      dborl_parameter_system_info::OUTPUT_FILE, "eval_sim", dborl_parameter_type_info::FILEASSOC);
...
#endif  //dborl_evaluate_shock_sim_params_h_
