...
#include <vsl/vsl_binary_io.h>
  ...
  // init constructor
bvam_ekf_camera_optimizer_state::bvam_ekf_camera_optimizer_state(
  double t_scale, 
...
vgl_rotation_3d<double> bvam_ekf_camera_optimizer_state::get_rotation()
{
  return base_rotation_;
}


vgl_point_3d<double> bvam_ekf_camera_optimizer_state::get_point()
{
  return base_point_;
}

void bvam_ekf_camera_optimizer_state::set_error_covariance(double center_var, double rot_var)
{
  Pk_.fill(0.0);
...
vcl_ostream& operator << (vcl_ostream& os, bvam_ekf_camera_optimizer_state const& ekf_state)
{
...
bool bvam_ekf_camera_optimizer_state::operator == (bvam_ekf_camera_optimizer_state const& other) const
{
