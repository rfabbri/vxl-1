...
MAIN( test_bvam_roi_init_process )
{
  ...
  brdb_value_sptr v2 = new brdb_value_t<bvam_voxel_world_sptr>(world);

  bool good = bprb_batch_process_manager::instance()->init_process("BvamRoiInitProcess");
