// This is /pro/bvam_roi_init_process.h
#ifndef bvam_roi_init_process_h_
#define bvam_roi_init_process_h_
...
class bvam_roi_init_process : public bprb_process
{
 public:
  
   bvam_roi_init_process();

  //: Copy Constructor (no local data)
  bvam_roi_init_process(const bvam_roi_init_process& other)
...
#endif // bvam_roi_init_process_h_
