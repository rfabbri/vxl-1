#include "bvam_detect_changes_process.h"
...
bvam_detect_changes_process::bvam_detect_changes_process()
{
...
bool bvam_detect_changes_process::execute()
{
  ...
  //create metadata:
  bvam_image_metadata observation(img,camera);
