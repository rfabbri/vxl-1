#include "bvam_render_virtual_view_process.h"
...
bvam_render_virtual_view_process::bvam_render_virtual_view_process()
{
...
bool bvam_render_virtual_view_process::execute()
{
  ...
  brdb_value_t<bvam_voxel_world_sptr>* input3 = 
  ...
  bvam_image_metadata obs_og(img_og,camera_og);
