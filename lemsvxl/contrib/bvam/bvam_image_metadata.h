#ifndef _bvam_image_metadata_h_
#define _bvam_image_metadata_h_
...
public:
  ...
  bvam_image_metadata(vil_image_view_base_sptr img_arg, vpgl_camera_double_sptr camera_arg, 
