...
int main(int argc, char* argv[] )
{
    ...
    std::string entropy_dat = result_dir +" \\entropy_dat.dat";

    std::string entropy_bin = result_dir + "\\entropy.bin";

    std::string reduced_feature_mfile = result_dir + "\\reduced_features_mfile.m";
