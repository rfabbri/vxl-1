//this /contrib/bm/dsm2/dsm2_io_transition_map.hxx
...
template<class T1, class T2, class T3>
void vsl_print_summary(std::ostream& os, const dsm2_transition_map<T1,T2,T3> *p)
{
...
template void vsl_print_summary(std::ostream& os, const dsm2_transition_map<T1,T2,T3> *p)
