...
void vsl_b_read(vsl_b_istream &is, dsm_target_neighborhood_map* &p)
{
	...
	if(not_null_ptr)
	{
		p = new dsm_target_neighborhood_map();
		vsl_b_read(is,*p);
	}
	else
		p = 0;
