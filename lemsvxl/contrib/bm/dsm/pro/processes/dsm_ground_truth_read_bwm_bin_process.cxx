...
namespace dsm_ground_truth_read_bwm_bin_process_globals
{
	const unsigned int n_inputs_ = 1;
	const unsigned int n_outputs_ = 1;
}

bool dsm_ground_truth_read_bwm_bin_process_cons( bprb_func_process& pro )
{
...
bool dsm_ground_truth_read_bwm_bin_process( bprb_func_process& pro )
{
	using namespace dsm_ground_truth_read_bwm_bin_process_globals;
	...
	gt_sptr->b_read_bwm_gt(filename);

	pro.set_output_val(0,gt_sptr);
