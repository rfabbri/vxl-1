...
int main()
{
    ...
    std::string data_dir = "/media/DATAPART1/BrandonDataFolder/smw_data/westin/TwoCars_TopCenter";
    
    std::string img_dir = data_dir + "/OriginalData";
    std::string out_dir = data_dir + "/change_mask";
    std::string region_dir = data_dir + "/highlighted_region";
    std::string graph_dir = data_dir + "/graphs";
    ...
    std::string curr_graph_name = graph_dir + "/" + *filename_itr + ".dot";
    ...
    for(;filename_itr!=filename_end;++filename_itr)
    {
        ...
        std::cout << "Saving High lighted region..." << std::endl;
