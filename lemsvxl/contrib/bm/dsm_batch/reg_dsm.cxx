//this is /contrib/bm/dsm_batch/reg_dsm.cxx
#include"reg_dsm.h"
...
#include<dsm/pro/dsm_processes.h>
#include<dsm/pro/dsm_register.h>
...
register_datatypes(PyObject *self, PyObject *args)
{
	...
	dsm_register::register_datatype();
	...
	initdsm_batch(void)
{
	...
	dsm_batch_methods[0] = reg_pro;
	dsm_batch_methods[1] = reg_data;
	
	for( int i = 0; i < METHOD_NUM; ++i )
		dsm_batch_methods[i+2] = batch_methods[i];

	Py_InitModule("dsm_batch", dsm_batch_methods);
