...
public:
	...
	//std::map<unsigned,node_id_mean_map_type>
	...
	//std::map<unsigned,node_id_covar_map_type>
	...
	//std::map<unsigned,dbcl_state_machine_node::transition_table_type>
	...
	//std::map<unsigned, dbcl_temporal_feature_sptr>
    ...
    static void save_change_maps(std::string result_dir, dbcl_image_classifier& image_classifier);

	static void save_change_maps(std::string result_dir, std::string video_glob, dbcl_image_classifier& image_classifier);

	static void save_change_maps(std::string result_dir, std::string video_glob, dbcl_state_machine_image_classifier& image_classifier);

	static void save_target_temporal_prob_dist( std::string result_dir, dbcl_state_machine_classifier_sptr& classifier );

    //dbcl_state_machine_view( std::ofstream& of, dbcl_image_classifier& image_classifier);
