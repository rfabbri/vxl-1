//This is contrib/curve2d/curve2d_gui_menu.cxx

#include "curve2d_gui_menu.h"
#include "geno_app.h"
...
//MENU_ADD_PROCESS_NAME( "Mutual Info Matching", curve_group_menu );
  ...
  vgui_menu  other_group_menu; // Other
    ...
    MENU_ADD_PROCESS_NAME( "Livewire Polygons", other_group_menu );
...
//    MENU_ADD_TOOL( dbru_rcor_tool,                 vsol2D_tools_menu );
