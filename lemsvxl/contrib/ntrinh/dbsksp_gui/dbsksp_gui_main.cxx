...
#include <dbsksp/pro/dbsksp_simplify_xshock_graph_process.h>
...
int main(int argc, char** argv)
{
  ...
  REG_PROCESS( dbsksp_simplify_xshock_graph_process );
  ...
  dbsksp_gui_menu menubar;
  vgui_menu menu_holder = menubar.setup_menu();
  unsigned w = 512, h = 512;
  vcl_string title = "dbsksp_gui GUI";
