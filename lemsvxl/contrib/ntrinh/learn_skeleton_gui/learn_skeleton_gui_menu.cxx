...
vgui_menu
learn_skeleton_gui_menu::setup_menu()
{
  vgui_menu MainMenu;
  ...
  vgui_menu  shockshape_group_menu; // symmetry-shape
    ...
    MENU_ADD_PROCESS_NAME( "Normalize an xgraph", shockshape_group_menu );
    MENU_ADD_PROCESS_NAME( "Mirror an xgraph", shockshape_group_menu );
