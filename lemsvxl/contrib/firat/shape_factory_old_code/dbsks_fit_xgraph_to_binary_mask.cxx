...
int main()
{
    ...
    std::string binary_mask_file = "/home/firat/Desktop/swan-mask.png/swans_be021.mask.0.ppm";
    ...
    std::cout << "***Finish loading image" << std::endl;

    //2. Run contour tracer on the binary image
    std::cout << "***Begin tracing contour" << std::endl;
    ...
    std::cout << "***Finish tracing contour" << std::endl;

    //3. Compute and prune shocks
    std::cout << "***Begin computing/pruning shocks" << std::endl;
    ...
    shock_pro.finish();
    std::vector<bpro1_storage_sptr> shock_results = shock_pro.get_output();
    std::cout << "***Finish computing/pruning shocks" << std::endl;

    //4. Sample shocks
    std::cout << "***Begin sampling shocks" << std::endl;
    ...
    std::vector<bpro1_storage_sptr> pruned_shock_results = sample_sg_pro.get_output();
    std::cout << "***Finish sampling shocks" << std::endl;

    //5. Fit sksp xgraph to sk2d xgraph
    std::cout << "***Begin fitting xgraph" << std::endl;
    ...
    fx_pro.finish();
    std::vector<bpro1_storage_sptr> fit_results = fx_pro.get_output();
    std::cout << "***Finish fitting xgraph" << std::endl;
    ...
    std::cout << "***Begin finding correspondence" << std::endl;
    dbsksp_edit_distance work;
    ...
    std::cout << "***Finish finding correspondence" << std::endl;

    std::cout << "Number of correspondences = " << correspondence.size() << std::endl;
    /*for(int i = 0; i < correspondence.size(); i++)
    {
        std::cout << work.tree1()->tail(correspondence[i].first.first) << ", " << work.tree1()->head(correspondence[i].first.second) << ", " <<
                work.tree2()->tail(correspondence[i].second.first) << ", " << work.tree2()->head(correspondence[i].second.second) << std::endl;
    }
    std::cout << std::endl;
    for(int i = 0; i < correspondence.size(); i++)
    {
        std::cout <<correspondence[i].first.first << ", " << correspondence[i].first.second << ", " <<
                correspondence[i].second.first << ", " << correspondence[i].second.second << std::endl;
    }*/

    std::cout << std::endl;
    std::vector<int> dart_list1;
    std::vector<int> dart_list2;
    dbsksp_xshock_node_sptr start_node;
    std::vector<dbsksp_xshock_edge_sptr> path1;
    std::vector<dbsksp_xshock_edge_sptr> path2;
