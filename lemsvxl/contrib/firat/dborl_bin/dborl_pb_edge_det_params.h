...
public:
  ...
  //io parameters  
  dborl_parameter<std::string> input_dir_;
  dborl_parameter<std::string> input_name_;    // passes the name of the input object
  ...
  //: constructor
  dborl_pb_edge_det_params(std::string algo_name);
};
