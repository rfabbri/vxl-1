...
dbsksp_small_gui_menu::dbsksp_small_gui_menu() 
{
}
...
vgui_menu
dbsksp_small_gui_menu::setup_menu()
{
    vgui_menu MainMenu;
    ...
    MENU_ADD_PROCESS_NAME( "Train xshock geometry model", shockshape_group_menu );
    MENU_ADD_PROCESS_NAME( "Train xshock ccm model", shockshape_group_menu );
    MENU_ADD_PROCESS_NAME( "Transfer xgraph attributes", shockshape_group_menu );
    ...
    MENU_ADD_PROCESS_NAME( "Edit xgraph to common topology",  shock_group_menu );
