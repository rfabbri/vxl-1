...
int main()
{
	...
	if(0)
	{
		...
		for(int i = 0; i < height; i++)
		{
			...
			{
				surface(j,i) = std::sqrt((i-center)*(i-center) + (j-center)*(j-center)) - 2.1;
			}
		}
	}
	else if(0)
	...
	std::FILE* f1 = fopen("/home/firat/Desktop/surface.img", "w");
	std::fwrite(surface_array,sizeof(double),(height*width),f1);
	std::fclose(f1);
	...
	std::ofstream ofs("/home/firat/Desktop/subpixeltrace4.txt");
