...
int main(int argc, char *argv[]) 
{
    ...
    << "\n  course ccm model:        " << vul_file::strip_directory(params->get_xgraph_course_ccm_file())
    << "\n  fine ccm model:        " << vul_file::strip_directory(params->get_xgraph_fine_ccm_file())
    << "\n====================================================================\n";
    ...
    if (choice == 1)
    {
        ...
        //> Set up params
        dbsks_detect_xgraph_course_to_fine m;
        ...
        m.xgraph_course_ccm_file          = params->get_xgraph_course_ccm_file();
        m.xgraph_fine_ccm_file          = params->get_xgraph_fine_ccm_file();
