  ...
  dborl_algo_params(algo_name)
{
  ...
  if (category == "giraffes")
  {
    ...
    this->input_xgraph_course_ccm_filename_.set_values(this->param_list_, "io", "input_xgraph_course_ccm_filename",
      "[CCM] Input xgraph Contour-Chamfer-Matching model filename",
      "giraffes-xgraph_ccm_model-v2-2009aug31-chamfer_4.xml",
      "giraffes-xgraph_ccm_model-v2-2009aug31-chamfer_4.xml");

    //: xgraph Contour-Chamfer-Matching model filename (.xml)
        this->input_xgraph_fine_ccm_filename_.set_values(this->param_list_, "io", "input_xgraph_fine_ccm_filename",
          "[CCM] Input xgraph Contour-Chamfer-Matching model filename",
          "giraffes-xgraph_ccm_model-v2-2009aug31-chamfer_4.xml",
          "giraffes-xgraph_ccm_model-v2-2009aug31-chamfer_4.xml");
...
//:
std::string vox_detect_xgraph_params::
get_xgraph_course_ccm_file() const
{
  std::string xgraph_ccm_file = this->input_xgraph_folder_()+ "/" +this->input_xgraph_course_ccm_filename_();
...
//:
std::string vox_detect_xgraph_params::
get_xgraph_fine_ccm_file() const
{
  std::string xgraph_ccm_file = this->input_xgraph_folder_()+ "/" +this->input_xgraph_fine_ccm_filename_();
  return xgraph_ccm_file;
}
