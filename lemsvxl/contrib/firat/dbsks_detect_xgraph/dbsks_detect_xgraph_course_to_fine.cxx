...
execute()
{
    ...
    for (unsigned i_scale =0; i_scale < xgraph_scales.size(); ++i_scale)
    {
        ...
        vcl_vector<dbsks_det_desc_xgraph_sptr > course_dets; //> List of detections for this scale
        vcl_vector<dbsks_det_desc_xgraph_sptr > fine_dets; //> List of detections for this scale
        ...
        else
        {
                    ...
                    << storage_folder << "\n";
            {
                ...
                vcl_string det_group_id = xgraph_name + "+cdet+" + object_id + "+" + storage_foldername;
                ...
                << storage_folder << "\n";
        {
            // form a unique id for this group of detections
            vcl_string xgraph_name = vul_file::strip_extension(vul_file::strip_directory(xgraph_file));
            vcl_string det_group_id = xgraph_name + "+fdet+" + object_id + "+" + storage_foldername;
            vcl_string model_category = "";
...
load_params_and_models()
{
    ...
    vcl_cout << ">> Checking compatibility between course CCM model and xgraph...";
    ...
    // Check compatibility between Contour Chamfer Matching model and xgraph (are all edges covered)
    vcl_cout << ">> Checking compatibility between fine CCM model and xgraph...";
        ...
        vcl_vector<dbsks_det_desc_xgraph_sptr >& dets)
{
    ...
    for (unsigned iw =0; iw < windows.size(); ++iw)
    {
        ...
        //> Name of folder to store detect records from this scale
        vcl_string storage_dirname = "cdet_ROI" +
                ...
                << storage_dir << "\n";
        {
            // form a unique id for this group of detections
            vcl_string xgraph_name = vul_file::strip_extension(vul_file::strip_directory(xgraph_file));
            vcl_string det_group_id = xgraph_name + "+cdet+" + object_id + "+" + storage_dirname;
            vcl_string model_category = "";
        ...
        vcl_vector<dbsks_det_desc_xgraph_sptr >& dets)
{
    ...
    for (unsigned iw =0; iw < windows.size(); ++iw)
    {
        ...
        //> Name of folder to store detect records from this scale
        vcl_string storage_dirname = "fdet_ROI" +
                vul_sprintf("_%d_%d_%d_%d", window.min_x(), window.min_y(), window.max_x(), window.max_y());
        vcl_string storage_dir = work_dir + "/" + storage_dirname;
                ...
                << storage_dir << "\n";
        {
            // form a unique id for this group of detections
            vcl_string xgraph_name = vul_file::strip_extension(vul_file::strip_directory(xgraph_file));
            vcl_string det_group_id = xgraph_name + "+fdet+" + object_id + "+" + storage_dirname;
            vcl_string model_category = "";
