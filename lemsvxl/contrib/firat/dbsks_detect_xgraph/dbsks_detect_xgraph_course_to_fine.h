// This is /lemsvxl/brcv/seg/dbsks/algo/dbsks_detect_xgraph_course_to_fine.h.
...
#ifndef DBSKS_DETECT_XGRAPH_COURSE_TO_FINE_H_
#define DBSKS_DETECT_XGRAPH_COURSE_TO_FINE_H_
...
class dbsks_detect_xgraph_course_to_fine
{
    public:
        ...
        dbsks_detect_xgraph_course_to_fine(){};
        ~dbsks_detect_xgraph_course_to_fine(){};
    ...
    protected:
        ...
        dbsks_xgraph_ccm_model_sptr xgraph_course_ccm;

        //: Contour chamfer matching (appearance) model
        dbsks_xgraph_ccm_model_sptr xgraph_fine_ccm;

        //: An engine to compute samples of a biarc fast, at the expense of possible inaccuracy
        dbsks_biarc_sampler course_biarc_sampler;

        //: An engine to compute samples of a biarc fast, at the expense of possible inaccuracy
        dbsks_biarc_sampler fine_biarc_sampler;
...
#endif /* DBSKS_DETECT_XGRAPH_COURSE_TO_FINE_H_ */
