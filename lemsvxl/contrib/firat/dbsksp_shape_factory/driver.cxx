...
int main()
{
    ...
    std::vector<dbsksp_xshock_graph_sptr> xgs = factory.generate_random_shapes(num_objects);
    ...
    for(int i = 0; i < xgs.size(); i++)
    {
        ...
        std::sprintf(xyz, "/home/firat/Desktop/db/1000bottles/bottle%d.xml", i);
        ...
        std::sprintf(xyz, "/home/firat/Desktop/db/1000bottles/bottle%d.txt", i);
