...
int main()
{
    ...
    vcl_vector<dbsksp_xshock_graph_sptr> xgs = factory.generate_random_shapes(num_objects, 0);
    ...
    for(int i = 0; i < xgs.size(); i++)
    {
        ...
        vcl_sprintf(xyz, "/home/firat/Desktop/db/100bottles-pert/bottle%d.xml", i);
        ...
        vcl_cout << "Num points in polygon = " << list.size() <<vcl_endl;
        vcl_sprintf(xyz, "/home/firat/Desktop/db/100bottles-pert/bottle%d.txt", i);
    ...
    vcl_cout << "Fixed prototype" << vcl_endl;
