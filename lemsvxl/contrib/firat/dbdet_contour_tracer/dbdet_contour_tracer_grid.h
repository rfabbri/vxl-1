...
public:
	...
	std::vector<dbdet_contour_tracer_xing*> bad_neighbors;
	//Constructor
...
{
private:
	std::vector<dbdet_contour_tracer_xing*>* grid_points_;
	std::vector<dbdet_contour_tracer_xing*>* horiz_lines_;
	std::vector<dbdet_contour_tracer_xing*>* vert_lines_;
	int width_, height_;
...
public:
	...
	std::vector<dbdet_contour_tracer_xing*>& get_grid_points(int x, int y);
	std::vector<dbdet_contour_tracer_xing*>& get_horiz_points(int x, int y);
	std::vector<dbdet_contour_tracer_xing*>& get_vert_points(int x, int y);
	void determine_unambiguous_and_bad_neighbors();
	void get_next_point_candidates(dbdet_contour_tracer_xing* p, std::vector<dbdet_contour_tracer_xing*>& next_point_candidates);
	...
	bool get_associated_cell_ids(dbdet_contour_tracer_xing* p, std::vector<int>& idx, std::vector<int>& idy);
