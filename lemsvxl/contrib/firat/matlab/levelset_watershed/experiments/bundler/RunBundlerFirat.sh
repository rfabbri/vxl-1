...
#
#
# Edited by Firat Kalaycilar, 2013
#
...
BASE_PATH=/home/firat/Software/bundler-v0.4;
...
#cp prepare/list.txt .
sed "s/$/ 0 $2/" list_tmp.txt > list.txt
...
$BUNDLER list.txt --options_file options.txt > $4/out
