% This is /lemsvxl/contrib/firat/matlab/fast_curve_matching/test7.m.
...
image_name = 'bottles_party';

output_base_folder = '/home/firat/Desktop/db/results';


obj_contour = load_contours('/home/firat/Desktop/db/100bottles/bottle1.txt');
query_contours = load_contours(['/home/firat/Desktop/db/ethz_contours_gpb_0.3_kovesi_50/' image_name '_gpb.txt']);
...
for it = 1:length(query_contours)
    ...
    query_image = ['/vision/projects/kimia/shockshape/symseg/results/ETHZ-dataset/reorganized-data/all_originals_resized/' image_name '.png'];
