...
V = readVTK('/vision/images/medical/elbow-dog/data/TransverseCT_rightSide.vtk');
Img = V(:,:,28);
Img=double(Img(:,:,1));
%% parameter setting
...
alfa=6;  % coefficient of the weighted area term A(phi)
...
initialLSF(40:115, 2:75)=-c0;
%initialLSF(65:75, 15:25)=-c0;
phi=initialLSF;
