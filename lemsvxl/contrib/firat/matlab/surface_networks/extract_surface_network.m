% This is extract_surface_network.m
...
function assignment = extract_surface_network(I, sigma)
	[nrows,ncols] = size(I);
	...
	for i = 1:size(assignment,1)
		...
		bp = undetected{i};
		for j = 1:size(bp,1)
			line([saddles(i,1) bp(j,1)], [saddles(i,2) bp(j,2)],'Color', colors(bp(j,3)), 'LineWidth', 2);	
