% This is recons_heat_backward_euler.m
% \file
% \author Firat Kalaycilar (firat_kalaycilar@brown.edu)
% \date May 14, 2012

function R = recons_heat_backward_euler(I, mins, maxs, saddles, slope_lines, assignments, mode)
	...
	subplot(1,3,3);imagesc(R, [min(I(:)) max(I(:))]); colormap gray; axis image; axis off
	%for i = 1:1000
	%	v = CNleft\(CNright*A(:));
