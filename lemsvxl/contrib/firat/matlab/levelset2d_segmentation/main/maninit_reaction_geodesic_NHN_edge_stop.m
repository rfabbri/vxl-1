% This is /lemsvxl/contrib/firat/matlab/levelset2d_segmentation/main/maninit_reaction_geodesic_NHN_edge_stop.m.

% \file
% \author Firat Kalaycilar (firat_kalaycilar@brown.edu)
% \date Aug 19, 2011

function phi = maninit_reaction_geodesic_NHN_edge_stop(I, beta0, alpha, delta_t, num_iter, reinit_freq, hx, hy, edge_thresh, edge_sigma)
	[nrows,ncols] = size(I);
	narrow_band = .5;
	I = double(I);
	%%required paths
