% This is /lemsvxl/contrib/firat/matlab/levelset2d_segmentation/main/autoinit_geodesic_graddt_edge_stop_bubble3.m.

% \file
% \author Firat Kalaycilar (firat_kalaycilar@brown.edu)
% \date Aug 31, 2011

function phi = autoinit_geodesic_graddt_edge_stop_bubble3(I, slice_index, beta0, alpha, delta_t, max_num_iter, hx, hy, narrow_band, edg, edge_length, debug_mode)	
	I_orig = I;
	I = [I(1,:);I];
	I = [I;I(end,:)];
	I = [I(:,1), I];
	...
	phi = auto_bubble_initialization(I, [100 100; 55 28], hx, hy);
