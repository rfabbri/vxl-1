% This is /lemsvxl/contrib/firat/matlab/levelset2d_segmentation/main/autoinit_reaction_geodesic_graddt_edge_stop_bubble2.m.
...
function phi = autoinit_reaction_geodesic_graddt_edge_stop_bubble2(I, beta0, alpha, delta_t, max_num_iter, hx, hy, narrow_band, edg, edge_length, debug_mode)	
	I_orig = I;
	I = [I(1,:);I];
	I = [I;I(end,:)];
	I = [I(:,1), I];
	...
	if edge_length > 0
		edg_FG = lengthen_edges(edg_FG, edge_length);
	end
	%%speed (stop) function	
	S = 1;	
	%%geodesic input computation
	[DT,idx] = subpixelDT_fast(edg_FG(:,1:2), nrows, ncols, hx, hy);
	...
	%phi = auto_bubble_initialization(I, [1 1], hx, hy);
