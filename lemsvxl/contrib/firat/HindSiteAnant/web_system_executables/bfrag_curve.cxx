...
void bfrag_curve::resample(double ds)
{
  ...
  std::cout<<"This fragment not correct"<<std::endl;
  }
}
...
void bfrag_curve::resample_coarsely(double ds)
{
  ...
  compute_properties();
	...
	std::cout<<"aVp was here"<<std::endl;
	}
}
...
{
	//std::cout<<"rotate and translate called on"<<std::endl;
	//std::cout<<this->frag_id_<<std::endl;
  this->rotate(angle);
