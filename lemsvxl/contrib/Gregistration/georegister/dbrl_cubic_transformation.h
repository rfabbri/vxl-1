...
class dbrl_cubic_transformation:public dbrl_transformation
    ...
    public:
        ...
        dbrl_cubic_transformation(std::vector<dbrl_clough_tocher_patch> patchesx,
            std::vector<dbrl_clough_tocher_patch> patchesy);
        ~dbrl_cubic_transformation(){}
        ...
        virtual std::string is_a() const {return "dbrl_cubic_transformation";}

        virtual dbrl_transformation * clone() const;
    protected:
        std::vector<dbrl_clough_tocher_patch> patchesx_;
        std::vector<dbrl_clough_tocher_patch> patchesy_;
