...
protected:
  ...
  class corr_map : public std::map<vgui_displaylist2D_tableau_sptr, bgui_vsol_soview2D_line_seg*>
  {
   public:
    corr_map() : std::map<vgui_displaylist2D_tableau_sptr, bgui_vsol_soview2D_line_seg*>() {}
  };
