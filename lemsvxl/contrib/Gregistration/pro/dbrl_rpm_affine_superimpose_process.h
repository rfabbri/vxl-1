#ifndef _dbrl_rpm_affine_superimpose_process_
#define _dbrl_rpm_affine_superimpose_process_
...
class dbrl_rpm_affine_superimpose_process:public bpro1_process
    {
    public:

        dbrl_rpm_affine_superimpose_process();
        ~dbrl_rpm_affine_superimpose_process();
