...
void multiply()
{
 //define some known gaussian pdfs
  ...
  std::vector<gauss_type> gauss_vec;
  ...
  std::vector<gauss_type> gauss_vec2;
  ...
  std::pair<double, gauss_type> z1 = multiplier.multiply(gauss_vec);
  std::pair<double, gauss_type> z2 = multiplier.multiply(gauss_vec2);
