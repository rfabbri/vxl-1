#include "dbvxm_create_multiscale_voxel_world_process.h"
//:
// \file
...
//: Constructor
dbvxm_create_multiscale_voxel_world_process::dbvxm_create_multiscale_voxel_world_process()
{
  ...
  output_types_[0]= "dbvxm_multi_scale_voxel_world_sptr";
...
//: Execute the process
bool
dbvxm_create_multiscale_voxel_world_process::execute()
{
  // Sanity check
  ...
  dbvxm_multi_scale_voxel_world_sptr vox_world = new dbvxm_multi_scale_voxel_world;
  vox_world->set_params(params);

  brdb_value_sptr output0 = new brdb_value_t<dbvxm_multi_scale_voxel_world_sptr>(vox_world);
