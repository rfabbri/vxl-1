// This is contrib/dbvxm/rec/dbvxm_part_hierarchy.h
#ifndef dbvxm_part_hierarchy_h_
#define dbvxm_part_hierarchy_h_
//:
// \file
...
class dbvxm_part_hierarchy : public dbgrl_graph<dbvxm_part_base , dbvxm_hierarchy_edge> {
public:
