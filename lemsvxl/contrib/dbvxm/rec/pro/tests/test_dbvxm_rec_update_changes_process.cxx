...
MAIN( test_dbvxm_rec_update_changes_process )
{
  unsigned ni = 200;
  unsigned nj = 200;
  ...
  //: test dbvxm_bg_pair_density.h
  //dbvxm_bg_pair_density bgd(vox_world, cam1, "apm_mog_grey", 0, 0, ni, nj);
  //bgd.verbose = true;
  ...
  good = bprb_batch_process_manager::instance()->init_process("dbvxmUpdateChangesProcess");
  ...
  good = good && bprb_batch_process_manager::instance()->set_input(5, v6);
  good = good && bprb_batch_process_manager::instance()->set_input(6, v0);
  good = good && bprb_batch_process_manager::instance()->run_process();
  unsigned id_img2;
  good = good && bprb_batch_process_manager::instance()->commit_output(0, id_img2);
  TEST("run dbvxm update changes process", good ,true);
