#include "dbvxm_rec_density_to_prob_map_process.h"
...
dbvxm_rec_density_to_prob_map_process::dbvxm_rec_density_to_prob_map_process()
{
  //inputs
...
bool dbvxm_rec_density_to_prob_map_process::execute()
{
  // Sanity check
  ...
  dbvxm_bg_pair_density::initialize_bg_map(density_map_f, prob_map, pv, tp);
