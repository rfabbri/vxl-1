// This is brl/bseg/bbgm/pro/dbvxm_prob_map_roc_compute_process.cxx
#include "dbvxm_prob_map_roc_compute_process.h"
//:
// \file
...
//: Constructor
dbvxm_prob_map_roc_compute_process::dbvxm_prob_map_roc_compute_process()
{
  //input
...
//: Execute the process
bool
dbvxm_prob_map_roc_compute_process::execute()
{
  // Sanity check
  if (!this->verify_inputs()){
    std::cerr << "In dbvxm_prob_map_roc_compute_process::execute() -"
             << " invalid inputs\n";
    return false;
  }
  ...
  std::string out_file = input3->value();
