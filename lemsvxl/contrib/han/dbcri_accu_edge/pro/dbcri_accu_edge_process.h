// This is brcv/mvg/dbecl/pro/dbcri_accu_edge_process.h
#ifndef dbcri_accu_edge_process_h_
#define dbcri_accu_edge_process_h_
...
class dbcri_accu_edge_process : public bpro_process
{
private:
  int combination_;
...
public:
  ...
  void d3_build_points( double err, std::vector <vgl_point_3d<double> > &) ;
...
#endif // dbcri_accu_edge_process_h_
