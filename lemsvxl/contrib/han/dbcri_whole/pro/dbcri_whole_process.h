...
private:
  ...
  std::vector <std::vector <vsol_digital_curve_2d_sptr> >veh_con_edge_;
...
public:
  ...
  double cameras_fast( int,int,int,std::vector <vsol_digital_curve_2d_sptr> &dcl,
    std::vector< std::vector <dbecl_episeg_sptr> >&episegl, dbecl_epipole_sptr &epipole);

  double cameras_accu_fast( const std::vector < std::vector <std::vector <vnl_float_3> > >& ,int,int,int,std::vector<std::vector <vsol_digital_curve_2d_sptr> >&dcl,
    std::vector< std::vector <dbecl_episeg_sptr> >&episegl, dbecl_epipole_sptr &epipole,double,double tiny_number=0.1);
  double episeg_simplify( std::vector <std::vector <std::vector <vnl_float_3> > >&);
  ...
  void d3_build_points_edge_con_inside(  double err, std::vector <vgl_point_3d<double> > &, bool clear=true) ;
  ...
  void out_removal_1(std::vector <vgl_point_3d <double> > & pts);

  std::vector< std::string > get_input_type();
  std::vector< std::string > get_output_type();

  void print_bb_and_camera(std::string);
  void print_con_probe(std::string);
  ...
  void spacial_filtering_x_with_z(double &, double &, std::vector <vgl_point_3d<double> >);
  ...
  float solve_z(std::vector <vgl_point_2d <double> >,std::vector <vgl_point_2d <double> >);
  float solve_front_windshield(std::vector <vgl_point_2d <double> >,std::vector <vgl_point_2d <double> >);
  ...
  //in drcri_whole_3D file
    double cameras_fast1( int,int,int,std::vector <vsol_digital_curve_2d_sptr> &dcl,
    std::vector< std::vector <dbecl_episeg_sptr> >&episegl, dbecl_epipole_sptr &epipole);
    void read_edge_map();
