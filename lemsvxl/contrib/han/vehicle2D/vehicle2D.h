// This is contrib/han/vehicle2D.h
#ifndef vehicle2D_h_
#define vehicle2D_h_
...
//:
// \file
// \brief  defines 2D vehicle class constructed from video cameras
...
class vehicle2D
{
 ...
 public:
  //: Default constructor
  vehicle2D(void): color_(0.0, 0.0, 0.0), radius_(1.0) {}
  ...
  void shift(double);
  double overlap(vnl_double_2 a, vnl_double_2 b,vnl_double_2 c, vnl_double_2 d);
  void print();
  void com();//center of mass x-direction
  vnl_double_4 sum(double z_lower_bound, double z_upper_bound);
