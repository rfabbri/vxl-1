...
{ 
  public:
    ...
    vol3d_reader(std::vector<vil_image_resource_sptr> & img_vec,vgl_box_2d<int> const & roi);

    //creating a 3d view from an input text file
    vol3d_reader(std::string input_txt_file);
    ...
    vol3d_reader(std::string input_txt_file, vgl_box_3d<int> const &roi);
