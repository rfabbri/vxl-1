...
{
 // static std::string fname = "C:\\Aug 8 05\\Bio-tree Aug 8 artifact.log";
     static std::string fname = "C:\\Artifact 2\\Artifact 2 .log";
  std::string conics_bin_file_base = "C:\\Aug 8 05\\bins\\Bio-tree Aug 8 artifact0000";
  //std::string conics_bin_file_base = "C:\\test_images\\working\\bins\\test_artifact0000";
...
cali_simulated_scan_resource scan_res = cali_simulated_scan_resource(scan, resources );
 ...
 // std::vector<vil_image_resource_sptr> images = scan_res.simulate_scan("C://test_images", "test_artifact", artf_rot, artf_tr, 22);
 std::vector<vil_image_resource_sptr> images = scan_res.simulate_scan("C://test_images", "test_artifact", artf_rot, artf_tr, 20);
