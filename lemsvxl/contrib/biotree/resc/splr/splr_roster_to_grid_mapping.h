...
void splr_roster_to_grid_mapping(const biob_worldpt_roster_sptr sample_roster, const biob_grid_worldpt_roster & grid_roster,   std::vector<biob_worldpt_index>  & which_sample);
