...
#include "splr_explicit_splat_collection.hxx"
#include "splr_symmetry_splat_collection.hxx"
#include "splr_subset_splat_collection.hxx"
...
splr_basic_pizza_slice_splat_collection<T,F, scan_class, filter_2d_class, filter_3d_class, camera_class>::
  ...
  std::cout << "(splr_basic_pizza_slice_splat_collection.hxx) number of representatives: " << representatives->num_points() << " \n";
  ...
  std::vector<biob_worldpt_index> mapping_from_grid_points_to_sample_pts;
  ...
  std::cout << "\n(splr_basic_pizza_slice_splat_collection.hxx) number of sample points: " << subset_splat_collection_->subset_roster()->num_points() << " \n";
