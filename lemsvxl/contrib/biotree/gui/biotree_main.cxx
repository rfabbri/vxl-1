...
int main(int argc, char** argv)
{
  ...
  // Register BioTree processes
  REG_PROCESS( biocts_process );
  REG_PROCESS( biolung_process );

  
  biotree_menu menubar;
  vgui_menu menu_holder = menubar.setup_menu();
  unsigned w = 512, h = 512;
  vcl_string title = "biotree GUI";
