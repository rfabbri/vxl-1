// GUI menu for biotree
#include "biotree_menu.h"
...
biotree_menu::biotree_menu() 
{
}


vgui_menu
biotree_menu::setup_menu()
{
  vgui_menu MainMenu;
 ...
 // file_menu.add("Save to PostScript", render_ps);
  ...
  vgui_menu  biotree_group_menu; // BioTree
    MENU_ADD_PROCESS_NAME( "CTsim", biotree_group_menu );
    MENU_ADD_PROCESS_NAME( "3DLungModel", biotree_group_menu );
  ...
  processes_menu.add( "BioTree", biotree_group_menu );
