//: This is /contrib/biotree/resc/imgr/file_formats/roi_pick/bin/skyscan_roi_pick_menus.h

#ifndef skyscan_roi_pick_menus_h_
#define skyscan_roi_pick_menus_h_
//:
// \file   skyscan_roi_pick_menus.h
...
public:
  ...
  static void save_bx3_callback();
  static void load_bx3_callback();
  static vgui_menu get_menu();
private:
  skyscan_roi_pick_menus() {}
};

#endif // skyscan_roi_pick_menus_h_
