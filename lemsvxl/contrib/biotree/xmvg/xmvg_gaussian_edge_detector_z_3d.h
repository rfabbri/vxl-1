// This is /contrib/biotree/xmvg/xmvg_gaussian_edge_detector_z_3d.h

#ifndef xmvg_gaussian_edge_detector_z_3d_h
#define xmvg_gaussian_edge_detector_z_3d_h

//:
// \file   xmvg_gaussian_edge_detector_z_3d.h
// \brief  3D gaussian edge detector in z direction.
// \author H. Can Aras
// \date   2005-10-17
//
...
class xmvg_gaussian_edge_detector_z_3d : public xmvg_atomic_filter_3d <double>
{
  // member functions
  public:
    //: Empty Constructor
    xmvg_gaussian_edge_detector_z_3d();
    //: Constructor from the descriptor
    xmvg_gaussian_edge_detector_z_3d(xmvg_gaussian_edge_detector_descriptor& descriptor);
    //: Destructor
    virtual ~xmvg_gaussian_edge_detector_z_3d();
