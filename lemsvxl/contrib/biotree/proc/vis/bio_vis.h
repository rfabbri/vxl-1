...
uint8_t * read_ede_responses(std::string fbase,unsigned int marginx,unsigned int marginy,
                        unsigned int marginz,SbVec3s & dim);
                        

uint8_t *  read_filter_responses(std::string fbase,unsigned int filter_num,unsigned int marginx,
