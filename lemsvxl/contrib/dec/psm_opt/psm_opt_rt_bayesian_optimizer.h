#ifndef psm_opt_rt_bayesian_optimizer_h_
#define psm_opt_rt_bayesian_optimizer_h_
...
class psm_opt_rt_bayesian_optimizer
{
public:

  psm_opt_rt_bayesian_optimizer(psm_scene<APM> &scene, vcl_vector<vcl_string> const& image_ids);

  ~psm_opt_rt_bayesian_optimizer(){}
