//This is lemsvxl/contrib/dec/psm/pro/processes/psm_init_vis_implicit_scene_process.cxx
//:
// \file
// \brief A process for initializing a vis_impicit auxillary scene.
...
namespace psm_init_vis_implicit_aux_scene_process_globals
{
...
bool psm_init_vis_implicit_aux_scene_process_cons(bprb_func_process& pro)
{
  using namespace psm_init_vis_implicit_aux_scene_process_globals;
...
//: Execute the process
bool psm_init_vis_implicit_aux_scene_process(bprb_func_process& pro)
{
    ...
    case PSM_APM_MOG_GREY:
      {
        ...
        scene->init_aux_scene<PSM_AUX_VIS_IMPLICIT>();
        break;
      }
