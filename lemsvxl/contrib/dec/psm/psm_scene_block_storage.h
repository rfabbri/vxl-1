...
public:
  ...
  psm_scene_block_storage(std::string storage_directory) : storage_dir_(storage_directory) {}
  ...
  std::string storage_directory(){return storage_dir_;}

  //: return the filename of the octree at location i,j,k
  std::string storage_filename(int i, int j, int k) 
  {
