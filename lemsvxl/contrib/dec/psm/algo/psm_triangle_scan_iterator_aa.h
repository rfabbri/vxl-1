...
class psm_triangle_scan_iterator_aa : public vgl_region_scan_iterator
{
public:
  //: constructor
  psm_triangle_scan_iterator_aa(double *verts_x, double *verts_y, unsigned int v0 = 0, unsigned int v1 = 1, unsigned int v2 = 2);
