...
{
public:
  psm_cell_visibility_iterator(hsds_fd_tree<psm_sample<APM>,3> const& block, vpgl_perspective_camera<double> const& cam, unsigned int img_ni, unsigned int img_nj, bool reverse_iterator = false); 
