...
void selector_test()
{
  ...
  std::vector<std::vector<int> > class_f_table;
  ...
  float val3 = float((27652.0/801948.0))*float((std::log(val2)/std::log(2.0)));
  ...
  float val5 = float((190.0/801948.0))*float((std::log(val4)/std::log(2.0)));
