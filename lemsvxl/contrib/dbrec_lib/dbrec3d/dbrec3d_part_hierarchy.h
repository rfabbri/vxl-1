...
//public:
//  //dbrec3d_hierarchy() : part_table_(100, std::pair<dbrec_part_sptr, int>(dbrec_part_sptr(0), -1) ), table_populated_(false) {}
//  
...
//  std::vector<std::pair<dbrec_part_sptr, int> > part_table_;
