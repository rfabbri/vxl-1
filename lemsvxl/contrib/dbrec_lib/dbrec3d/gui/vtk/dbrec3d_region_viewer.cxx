...
dbrec3d_region_viewer::  dbrec3d_region_viewer(boxm_scene<boct_tree< short, float > > *scene, std::vector<vgl_box_3d<double> > bboxes, float tf_min, float tf_max, unsigned resolution_level)
{
  scene_= scene;
  ...
  std::vector<boct_cell_data<short, float> > cell_data;
