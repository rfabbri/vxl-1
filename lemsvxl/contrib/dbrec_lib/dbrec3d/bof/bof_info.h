...
public:
  ...
  std::string aux_dir(int scene_id) { return aux_dirs_[scene_id]; }
  ...
  friend void bof_init_scene_categories_xml(std::string bof_dir);
protected:
  ...
  //std::vector < std::vector<unsigned> > categories_;
  ...
  std::string xml_path() { return path_out_ + "/bof_info.xml"; }
