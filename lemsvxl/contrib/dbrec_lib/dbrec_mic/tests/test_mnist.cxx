...
{
/*  std::string path = "C:\\projects\\mnist_digits\\test_imgs\\";
  std::string label_filename = "C:\\projects\\mnist_digits\\test_imgs\\labels.txt";
  std::string out_path = "C:\\projects\\mnist_digits\\test_imgs_flipped\\";
  convert_mnist_files(path, 10000, label_filename, out_path);
*/
  std::string path = "C:\\projects\\roi_1\\sewage_rot_inv\\output_learning_model_params_using_gt\\";
  std::string file = path + "stat_file_class_0_1_2_non_class_stats.txt";
