...
class dbdet_dlvwr_change_params_command : public vgui_command
{
  // member variables
public:
  dbdet_dlvwr_tool* tool_;
public:  
  dbdet_dlvwr_change_params_command(dbdet_dlvwr_tool* tool) :
    tool_(tool)
  {};
  ~dbdet_dlvwr_change_params_command(){}
  dbdet_dlvwr_tool* tool() {return this->tool_; }
  void execute()
  {
    this->tool()->set_current_state(CHANGE_PARAMS);
...
dbdet_dlvwr_params dbdet_dlvwr_tool::last_used_params = dbdet_dlvwr_params();
...
activate() 
{
  ...
  osl_canny_ox_params canny_params;
  dbdet_dlvwr_params iparams = dbdet_dlvwr_tool::last_used_params;
...
handle_freeze_path()
{
  ...
  if (this->current_state() == CHANGE_PARAMS) return false;
...
get_intscissors_params(dbdet_dlvwr_params& iparams, osl_canny_ox_params& params)
{
  ...
  //dbdet_dlvwr_tool::last_used_params = iparams;
}
