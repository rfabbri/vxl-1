...
#include <world_model/poly_lidar_menu.h>
#include <world_model/poly_lidar_manager.h>
...
int main(int argc, char** argv)
{
  ...
  // Set up the app_menu
  vgui_menu main_menu;
  poly_lidar_menu app_menu;
  vgui_menu menu_holder = app_menu.add_to_menu (main_menu);
  
  vgui_grid_tableau_sptr grid = vgui_grid_tableau_new (1,1); 
  poly_lidar_manager* mgr = poly_lidar_manager::instance();
  ...
  delete poly_lidar_manager::instance();
