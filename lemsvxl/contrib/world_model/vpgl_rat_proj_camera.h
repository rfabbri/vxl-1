#ifndef vpgl_rat_proj_camera_h_
#define vpgl_rat_proj_camera_h_

#include <vpgl/vpgl_rational_camera.h>
#include <vpgl/vpgl_perspective_camera.h>
#include <vpgl/algo/vpgl_camera_compute.h>

class vpgl_rat_proj_camera
{
public:
  vpgl_rat_proj_camera(){}

  vpgl_rat_proj_camera(vpgl_rational_camera<double>& rat_cam);
...
private:
  ...
  //vpgl_perspective_camera_compute pcc_;
