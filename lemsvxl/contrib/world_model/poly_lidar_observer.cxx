...
poly_lidar_observer::poly_lidar_observer(bgui_image_tableau_sptr const& img, const char* n)
    :poly_observer(img, n)//vgui_easy2D_tableau(img)
{
...
void poly_lidar_observer::set_lvcs(double lat, double lon, double elev)
{
//  if (lvcs_ != 0)
 //    delete lvcs_;
...
void poly_lidar_observer::proj_point(vsol_point_3d_sptr p3d, 
...
//: transforms a given 3d world point to image plane
void poly_lidar_observer::backproj_point(vsol_point_2d_sptr p2d, 
                                        ...
                                        vsol_polygon_3d_sptr& poly3d)
{
  ...
  poly3d = poly_utils::move_points_to_plane(vertices); //new vsol_polygon_3d (vertices);
}

void poly_lidar_observer::set_ground_plane(unsigned int x1, unsigned int y1, unsigned int x2, unsigned int y2)
{
