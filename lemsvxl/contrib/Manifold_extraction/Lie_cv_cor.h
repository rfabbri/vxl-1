...
#ifndef _Lie_cv_cor_h
#define _Lie_cv_cor_h
...
class Lie_cv_cor : public vbl_ref_count
{
public:
  //: constructors
  ...
  Lie_cv_cor();
    ...
    Lie_cv_cor(const dbsol_interp_curve_2d_sptr c1, 
  ...
  virtual vcl_string is_a() const {return "Lie_cv_cor";}
