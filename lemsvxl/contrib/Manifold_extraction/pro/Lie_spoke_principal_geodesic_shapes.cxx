/*************************************************************************
*    NAME: pradeep
*    FILE: Lie_spoke_principal_geodesic_shapes.cxx
*    DATE: 06 August 2007
*************************************************************************/
#include "Lie_spoke_principal_geodesic_shapes.h"
...
/*************************************************************************
* Function Name: Lie_spoke_principal_geodesic_shapes::Lie_spoke_principal_geodesic_shapes
* Parameters: 
* Effects: 
*************************************************************************/

Lie_spoke_principal_geodesic_shapes::Lie_spoke_principal_geodesic_shapes()
    {
...
//: Clone the process
bpro1_process*
Lie_spoke_principal_geodesic_shapes::clone() const
    {
    return new Lie_spoke_principal_geodesic_shapes(*this);
    }

/*************************************************************************
* Function Name: Lie_spoke_principal_geodesic_shapes::execute
* Parameters:
* Returns: bool
* Effects:
*************************************************************************/
...
bool Lie_spoke_principal_geodesic_shapes::execute()
    {
    clear_output();
    ...
    parameters()->get_value( "-max_val" ,range);
