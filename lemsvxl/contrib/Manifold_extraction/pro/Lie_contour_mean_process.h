/*************************************************************************
 *    NAME: pradeep
 *    FILE: Lie_contour_mean_process.h
 *    DATE: 04 July 2007
 // brief:  process to find out the intrinsic mean curve (in Lie sense) given a set of 
 //         contour files having the same number of sample points
 *************************************************************************/

#ifndef Lie_contour_mean_process_header
#define Lie_contour_mean_process_header
...
class Lie_contour_mean_process : public bpro1_process 
{
protected:
...
public:
  ...
  virtual ~Lie_contour_mean_process() {}
