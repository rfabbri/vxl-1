//---------------------------------------------------------------------
// \file
// \brief some operations on Lie groups 
//
//
// \author
//  Pradeep- June 2007
...
//finds the Lie algebra element of a given group element for 3D transformations
//works for scaling right now...should be upgraded to handle other cases 
...
//finds the Lie group element of a given algebra element for 3D transformations
//works for scaling right now...should be upgraded to handle other cases
...
//      there would be one unknown scalar associated with each generator and there can be atmost 81 different
//      generator coefficients for a 9x9 algebra element.so this gives 81 unknowns.
//      for projecting each of the elements,there would be one unknown scalar associated.
//      so this gives 'n' unknowns where 'n' is the number of elements
