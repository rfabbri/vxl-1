...
dbsksp_weighted_avg_n_xgraphs_one_node_cost_function(
  ...
  const vcl_vector<vcl_vector<pathtable_key > >&       dart_corr_parent_to_model,  // correspondence between parent trees and model tree
...
f(const vnl_vector<double >& x)
{
  ...
  return vcl_sqrt(fx.squared_magnitude() / this->num_parents_);
}
