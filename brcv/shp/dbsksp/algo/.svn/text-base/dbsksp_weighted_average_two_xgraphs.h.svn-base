// This is brcv/shp/dbsksp/algo/dbsksp_weighted_average_two_xgraphs.h

#ifndef dbsksp_weighted_average_two_xgraphs_h_
#define dbsksp_weighted_average_two_xgraphs_h_
...
class dbsksp_weighted_average_two_xgraphs
{
public:
  ...
  //: Destructor
  virtual ~dbsksp_weighted_average_two_xgraphs() {}
  ...
  //: Relative error of the model xgraph
  double relative_error() const { return this->relative_error_; }
...
protected:
  ...
  //: Weights of the parent xgraphs
  double parent_weight_[2];
  ...
  //: Distance tolerance in fitting xgraph
  float fit_xgraph_tol_;
  ...
  double distance_btw_trimmed_xgraphs_;

  // Target distance from trimmed xgraphs to model xgraph
  double target_distance_trimmed_to_model_[2];

  //: Actual distance from trimmed xgrpah to model xgraph
  double distance_trimmed_to_model_[2];
};

#endif // dbsksp_weighted_average_two_xgraphs_h_
