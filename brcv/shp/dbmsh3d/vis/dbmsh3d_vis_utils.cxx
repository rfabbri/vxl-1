//: This is lemsvxlsrc/brcv/shp/dbmsh3d/vis/dbmsh3d_vis_utility.cxx
//  MingChing Chang
//  May 03, 2005.
...
extern SbColor UNMATCHED_COLOR = SbColor (0.5f, 0.5f, 0.5f); //Gray
...
SbColor get_rand_color_no_red_blue (const double& th)
{
  float r, g, b;
  double rms_r, rms_b;
  do {
    r = (float) colrand.drand32 (0, 1);
    g = (float) colrand.drand32 (0, 1);
    b = (float) colrand.drand32 (0, 1);
    rms_r = dist_rms_color (r, g, b, 1, 0, 0);
    rms_b = dist_rms_color (r, g, b, 0, 0, 1);
  }
  while (rms_r<th || rms_b<th);
