...
SoSeparator* dbsk3d_pro_vis::vis_ms_graph (const bool idv)
{
  ...
  soswitch->addChild (draw_ms_graph (ms_hypg_, 
                         ms_vis_param_.A1A3_color_, ms_vis_param_.A14_color_,
                         ms_vis_param_.Dege_A1A3_color_, ms_vis_param_.Dege_A14_color_, 
                         ms_vis_param_.Loop_vertex_color_,
                         ms_vis_param_.ball_size_, ms_vis_param_.A3_rib_color_, 
                         ms_vis_param_.A13_axial_color_, ms_vis_param_.Dege_axial_color_, 
                         ms_vis_param_.A3_loop_color_, ms_vis_param_.A13_loop_color_,
                         ms_vis_param_.Vc_color_,
...
SoSeparator* dbsk3d_pro_vis::vis_ms_graph_2 (const bool idv)
{
  ...
  soswitch->addChild (draw_ms_graph (sg_sa_, ///ms_hypg_, 
                         ms_vis_param_.A1A3_color_2_, ms_vis_param_.A14_color_2_,
                         ms_vis_param_.Dege_A1A3_color_2_, ms_vis_param_.Dege_A14_color_2_, 
                         ms_vis_param_.Loop_vertex_color_2_,
                         ms_vis_param_.ball_size_, ms_vis_param_.A3_rib_color_2_, 
                         ms_vis_param_.A13_axial_color_2_, ms_vis_param_.Dege_axial_color_2_, 
                         ms_vis_param_.A3_loop_color_2_, ms_vis_param_.A13_loop_color_2_,
                         ms_vis_param_.Vc_color_2_,
                         ms_vis_param_.curve_width_, idv, 
                         ms_vis_param_.vertex_show_id_, ms_vis_param_.curve_show_id_,
                         false,
                         user_defined_class_));
...
SoSeparator* dbsk3d_pro_vis::vis_ms_hypg (const int option, const int color_seed, const bool idv)
{
  ...
  if (option==0 || option==3) {
    ...
    soswitch->addChild (draw_ms_sheets_ctable (ms_hypg_, ms_vis_param_.sheets_ctable_, 
                            ...
                            ms_vis_param_.sheet_show_id_, 
                            user_defined_class_));
  }
  else if (option==1 || option==4) {
    //Visualize using m_face_ccode_.
    SbColor color = color_from_code (m_face_ccode_);
  ...
  if (option==0 || option==1 || option==2 || option==10) 
    soswitch->addChild (draw_ms_graph (ms_hypg_,     
                            ms_vis_param_.A1A3_color_, ms_vis_param_.A14_color_,
                            ms_vis_param_.Dege_A1A3_color_, ms_vis_param_.Dege_A14_color_, 
                            ms_vis_param_.Loop_vertex_color_,
  ...
  if (option==8)
    //distinguish A13-2 saddle and A13-3 relay curves.
    soswitch->addChild (draw_ms_graph_flow (ms_hypg_,   
                            ms_vis_param_.A1A3_color_, ms_vis_param_.A14_color_,
                            ms_vis_param_.Dege_A1A3_color_, ms_vis_param_.Dege_A14_color_, 
                            ms_vis_param_.Loop_vertex_color_,
                            ms_vis_param_.ball_size_, ms_vis_param_.A3_rib_color_, 
                            ms_vis_param_.A13_axial_color_, ms_vis_param_.A13_axial2_color_, 
                            ms_vis_param_.A13_axial3_color_, ms_vis_param_.A13_axial4_color_, 
                            ms_vis_param_.Dege_axial_color_, 
                            ms_vis_param_.A3_loop_color_, ms_vis_param_.A13_loop_color_,
                            ms_vis_param_.Vc_color_2_,
                            ms_vis_param_.curve_width_, idv,
                            ms_vis_param_.vertex_show_id_, ms_vis_param_.curve_show_id_,
