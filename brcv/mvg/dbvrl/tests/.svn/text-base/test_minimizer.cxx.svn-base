...
{
  dbvrl_world_roi test_roi(255,255,vgl_point_2d<double>(0.0,0.0), 
                          vgl_vector_2d<double>(0.95,0.0),
                          vgl_vector_2d<double>(0.0,0.95));
  //dbvrl_world_roi test_roi(255,255);
  ...
  dbvrl_lsqr_cost_func test_cost_func(image1, image2, test_roi, init_xform);
                      ...
                      const vil_image_view<float>& img2 )
{
  ...
  dbvrl_cost_func test_cost_func(img1, img2, test_roi, init_xform);
...
void test_minimizer( const vil_image_view<float>& img1,
                     const vil_image_view<float>& img2 )
{
  dbvrl_world_roi test_roi(200,200,vgl_point_2d<double>(20.0,20.0),
  ...
  vimt_image_2d_of<float> image1(img1, vimt_transform_2d());
  vimt_image_2d_of<float> image2(img1, vimt_transform_2d());
  dbvrl_minimizer minimizer(image1, image2, test_roi);
