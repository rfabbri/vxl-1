// This is lemsvxlsrc/brcv/mvg/dbvrl/pro/dbvrl_compute_homography_fast_process.h
#ifndef dbvrl_compute_homography_fast_process_h_
#define dbvrl_compute_homography_fast_process_h_

//:
// \file
// \brief 
// \author Dan Crispell(dec@lems.brown.edu)
// \date 11/11/03
//
// \verbatim
//  Based on dbvrl_compute_homography_process.h by Vishal Jain
//  Modifications
// \endverbatim
...
class dbvrl_compute_homography_fast_process : public bpro1_process {

public:

  dbvrl_compute_homography_fast_process();
  ~dbvrl_compute_homography_fast_process();
