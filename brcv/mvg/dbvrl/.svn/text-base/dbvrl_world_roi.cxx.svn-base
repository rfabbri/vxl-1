...
//: Constructor
dbvrl_world_roi::dbvrl_world_roi( unsigned int n_u,  unsigned int n_v,
...
vnl_vector<double> 
dbvrl_world_roi::sample( const vimt_image_2d_of<float>& image) const
{
...
vnl_vector<double>
dbvrl_world_roi::sample_weights( const vimt_image_2d_of<float>& image) const
{
...
dbvrl_world_roi::resample( const vimt_image_2d_of<float>& image) const
{
