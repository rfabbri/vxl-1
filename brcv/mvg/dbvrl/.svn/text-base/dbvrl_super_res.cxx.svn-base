// This is algo/dbvrl/dbvrl_super_res.cxx
//:
// \file
...
dbvrl_region_sptr 
dbvrl_super_res::compute_region(double area_mag)
{
...
void
dbvrl_super_res::compute_weights( vnl_matrix<double>& data, 
                                 vnl_matrix<double>& weights,
...
double 
dbvrl_super_res::point_spread( const vgl_point_2d<double>& m, 
