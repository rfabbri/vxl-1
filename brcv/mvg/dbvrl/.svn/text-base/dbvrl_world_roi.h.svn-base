// This is algo/dbvrl/dbvrl_world_roi.h
#ifndef dbvrl_world_roi_h_
#define dbvrl_world_roi_h_
//:
// \file
...
class dbvrl_world_roi : public vbl_ref_count
{
public:
  //: Constructor
  dbvrl_world_roi( unsigned int n_u,  unsigned int n_v,
