// This is algo/dbvrl/dbvrl_cost_func.cxx
//:
// \file

#include "dbvrl_cost_func.h"
...
//: Constructor
dbvrl_cost_func::dbvrl_cost_func( const vil_image_view<float>& image1,
...
//: The main function.
double
dbvrl_cost_func::f(vnl_vector<double> const& x)
{
...
dbvrl_cost_func::last_xformed_image()
{
