// This is seg/dbsks/dbsks_ccm_subpix.h
#ifndef dbsks_ccm_subpix_h_
#define dbsks_ccm_subpix_h_
...
public:
  ...
  //: constructor
  dbsks_ccm_subpix(): search_window_width_ (3.0f){};

  //: destructor
  virtual ~dbsks_ccm_subpix(){};
  ...
  float search_window_width() const {return this->search_window_width_; }

  //: Set search window width
  void set_search_window_width(float new_width)
  { this->search_window_width_ = new_width; }
...
#endif // seg/dbsks/dbsks_ccm_subpix.h
