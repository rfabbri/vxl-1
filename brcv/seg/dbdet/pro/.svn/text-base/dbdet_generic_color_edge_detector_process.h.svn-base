// This is brcv/seg/dbdet/pro/dbdet_generic_color_edge_detector_process.h
#ifndef dbdet_generic_color_edge_detector_process_h_
#define dbdet_generic_color_edge_detector_process_h_
...
class dbdet_generic_color_edge_detector_process : public bpro1_process 
{
public:

  dbdet_generic_color_edge_detector_process();
  virtual ~dbdet_generic_color_edge_detector_process();
