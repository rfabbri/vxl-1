// This is brcv/seg/dbacm3d/dbacm3d_edge_trough_levelset_func.h

#ifndef dbacm3d_edge_trough_levelset_func_h_
#define dbacm3d_edge_trough_levelset_func_h_

//:
// \file
// \brief A levelset function that computes data at all levels
// \author Jesse Funaro (jdfunaro@lems.brown.edu)
//         (after dbacm/dbacm_edge_trough_levelset_func by  Nhon Trinh (ntrinh@lems.brown.edu))
// \date 12/22/2005
// \verbatim
//  Modifications
// \endverbatim
...
class dbacm3d_edge_trough_levelset_func : public dbacm3d_levelset_func
{ 
public:
  //: Constructor
  dbacm3d_edge_trough_levelset_func(const vil3d_image_view<float> &edges,
      const vil3d_image_view<float> &troughs,
      const vil3d_image_view<bool> &no_go_image 
      ):edges_(edges),troughs_(troughs),no_go_image_(no_go_image) {}
  
  //: Destructor
  virtual ~dbacm3d_edge_trough_levelset_func() {}
...
protected:
  ...
  //: Trough Map
  vil3d_image_view<float> troughs_;
...
#endif // dbacm3d_edge_trough_levelset_func_h_
