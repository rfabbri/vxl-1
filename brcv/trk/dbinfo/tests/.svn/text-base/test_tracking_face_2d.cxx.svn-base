...
static void test_tracking_face_2d(int argc, char* argv[])
{
  ...
  //Testing ...
#if 0
  dbinfo_tracking_face_2d(vtol_face_2d_sptr const& face,
  ...
  for (int r = 1; r<2; ++r)
  {
    ...
    tf = new dbinfo_tracking_face_2d(hole_f,
                                   model_image_uni,
                                   null, null,
                                   null, null,
                                   0, 0.5, 16,8,8);
  ...
  for (int r = 3; r<4; ++r)
  {
    ...
    dbinfo_tracking_face_2d_sptr bf = new dbinfo_tracking_face_2d(back_f,
                                                              model_image_uni,
                                                              null, null,
                                                              null, null,
                                                              0, 0,16,8,8);
    //  bf->print_pixels(obs_image_uni);
    dbinfo_tracking_face_2d_sptr obf = new dbinfo_tracking_face_2d(hole_f,
                                   model_image_uni,
                                 null, null,
                                 null, null,
                                 0, 0,16,8,8);
