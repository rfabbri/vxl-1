...
dbcvr_cv_cor::dbcvr_cv_cor() : final_cost_(0), final_norm_cost_(0), length1_(-1), length2_(-1)
{
  open_curve_matching_ = false;
}

dbcvr_cv_cor::dbcvr_cv_cor(const bsol_intrinsic_curve_2d_sptr c1, 
...
double dbcvr_cv_cor::get_arclength_on_curve2(double s1) {
...
double dbcvr_cv_cor::get_arclength_on_curve1(double s2) {
...
bool dbcvr_cv_cor::write_correspondence(vcl_string file_name, int increment) 
{
...
void dbcvr_cv_cor::b_write(vsl_b_ostream &os) const
{
...
void dbcvr_cv_cor::b_read(vsl_b_istream &is)
{
  short ver;
  vsl_b_read(is, ver);
  switch (ver)
