// This is rec/dbskr/dbskr_edit_distance_shock_tree.cxx
...
#include "dbskr_edit_distance_shock_tree.h"

#include <dbskr/dbskr_directed_tree.h>
#include <dbskr/dbskr_shock_tree.h>
...
//------------------------------------------------------------------------------
//: Constructor
dbskr_edit_distance_shock_tree::
...
//------------------------------------------------------------------------------
//: Get tree1
dbskr_shock_tree_sptr dbskr_edit_distance_shock_tree::
tree1() const
{
  return static_cast<dbskr_shock_tree* >(this->tree1_.ptr());
}


//------------------------------------------------------------------------------
//: Set tree 1
void dbskr_edit_distance_shock_tree::
set_tree1(const dbskr_shock_tree_sptr& tree1) 
{
...
//: Set tree 2
void dbskr_edit_distance_shock_tree::
set_tree2(const dbskr_shock_tree_sptr& tree2)
{
...
tree2() const
{
  return static_cast<dbskr_shock_tree* >(this->tree2_.ptr());
}
...
//------------------------------------------------------------------------------
//: Read path
bool dbskr_edit_distance_shock_tree::
...
float dbskr_edit_distance_shock_tree::
...
dbskr_sm_cor_sptr dbskr_edit_distance_shock_tree::
