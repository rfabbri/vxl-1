// This is brcv/rec/dbskr/dbskr_shock_tree.h

#ifndef dbskr_shock_tree_h_
#define dbskr_shock_tree_h_
...
//
//  Ozge C Ozcanli October 30, 07        Re-added scurve pair class, it is used when localized matching option is on in dbskr_shock_tree_edit
//   
...
class dbskr_shock_tree : public dbskr_directed_tree
{
public:
  // Constructors / Destructors / Initializers----------------------------------
  
  //: Constructor
  dbskr_shock_tree(float scurve_sample_ds=5.0f, float interpolate_ds=1.0f, float matching_R=6.0f);

  //: Destructor;
  virtual ~dbskr_shock_tree() 
  { this->clear(); }
