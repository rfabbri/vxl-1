...
int main(int argc, char *argv[]) {
  ...
  dborl_example_algo_params_sptr params = new dborl_example_algo_params("dborl_example_algo");  // constructs with the default values;
  ...
  dborl_example_algo algo(params);
