...
int main(int argc, char *argv[]) {
  ...
  dborl_extract_patch_processor e;
  dborl_cluster<dborl_extract_patch_processor_input, dborl_extract_patch_processor, char> cluster(&e);
  ...
  try
  {
    ...
    vcl_vector<dborl_extract_patch_processor_input> things; 
