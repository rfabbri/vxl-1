// This is dborl/algo/mpi/symseg/dborl_sks_match_shape_main.cxx
...
int main(int argc, char *argv[]) {
  ...
  dborl_sks_match_shape_processor e;
  dborl_cluster<dborl_sks_match_shape_processor_input, dborl_sks_match_shape_processor, float> cluster(&e);
  ...
  try
  {
    ...
    vcl_vector<dborl_sks_match_shape_processor_input> things; 
