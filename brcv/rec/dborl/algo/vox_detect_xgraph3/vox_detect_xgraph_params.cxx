  ...
  dborl_algo_params(algo_name) 
{
  ...
  this->input_image_folder_.set_values(this->param_list_, "io", "input_image_folder",
    ...
    "/media/New_Volume/Research/Project_skeleton/Detect_xshock_BMS/v2_img_all");
  ...
  if(category == "mouse")
  {
    ...
    this->input_object_dir_.set_values(this->param_list_, "io", "input_object_dir",
      "input object folder", 
      "/media/New_Volume/Research/Project_skeleton/Detect_xshock_BMS", 
      "/media/New_Volume/Research/Project_skeleton/Detect_xshock_BMS",
      0, // for 0th input object
  ...
  this->appearance_prototype_filename_.set_values(this->param_list_, "io", "appearance_prototype_filename",
          "appearance prototype filename (full path)",
  ...
  else if (category == "giraffes")
  {
    ...
    this->input_object_dir_.set_values(this->param_list_, "io", "input_object_dir",
      ...
      "/media/New_Volume/Research/Project_skeleton/Detect_xshock_test/vox-upload/giraffes_green",
      0, // for 0th input object
      dborl_parameter_system_info::INPUT_OBJECT_DIR);
    ...
    this->input_xgraph_folder_.set_values(this->param_list_, "io", "input_xgraph_folder",
      ...
      "/media/New_Volume/Research/Project_skeleton/Detect_xshock_test/xshock-graph-firat/giraffes");
  ...
  else if (category == "bottles")
  {
    ...
    this->input_object_dir_.set_values(this->param_list_, "io", "input_object_dir",
      ...
      "/media/New_Volume/Research/Project_skeleton/Detect_xshock_test/vox-upload/bottles_acaw",
      0, // for 0th input object
      dborl_parameter_system_info::INPUT_OBJECT_DIR);
    ...
    this->input_xgraph_folder_.set_values(this->param_list_, "io", "input_xgraph_folder",
      ...
      "/media/New_Volume/Research/Project_skeleton/Detect_xshock_test/xshock-graph-firat/bottles");
  ...
  else if (category == "swans")
  {
    ...
    this->input_object_dir_.set_values(this->param_list_, "io", "input_object_dir",
      ...
      "/media/New_Volume/Research/Project_skeleton/Detect_xshock_test/vox-upload/swans_aal",
      0, // for 0th input object
      dborl_parameter_system_info::INPUT_OBJECT_DIR);
    ...
    this->input_xgraph_folder_.set_values(this->param_list_, "io", "input_xgraph_folder",
      ...
      "/media/New_Volume/Research/Project_skeleton/Detect_xshock_test/xshock-graph-firat/swans");
  ...
  else if (category == "mugs")
  {
    ...
    this->input_object_dir_.set_values(this->param_list_, "io", "input_object_dir",
      ...
      "/media/New_Volume/Research/Project_skeleton/Detect_xshock_test/vox-upload/mugs_tdnkitchen",
      0, // for 0th input object
      dborl_parameter_system_info::INPUT_OBJECT_DIR);
    ...
    this->input_xgraph_folder_.set_values(this->param_list_, "io", "input_xgraph_folder",
      ...
      "/media/New_Volume/Research/Project_skeleton/Detect_xshock_test/xshock-graph-firat/mugs");
  ...
  else if (category == "applelogos")
  {
    ...
    this->input_object_dir_.set_values(this->param_list_, "io", "input_object_dir",
      ...
      "/media/New_Volume/Research/Project_skeleton/Detect_xshock_test/vox-upload/applelogos_another",
      0, // for 0th input object
      dborl_parameter_system_info::INPUT_OBJECT_DIR);
    ...
    this->input_xgraph_folder_.set_values(this->param_list_, "io", "input_xgraph_folder",
      ...
      "/media/New_Volume/Research/Project_skeleton/Detect_xshock_test/xshock-graph-firat/applelogos");
  ...
  this->output_object_folder_.set_values(this->param_list_, "io", "output_object_folder", 
    ...
    "/media/New_Volume/Research/Project_skeleton/Detect_xshock_BMS/xshock_output/vox-output10",
    "/media/New_Volume/Research/Project_skeleton/Detect_xshock_BMS/xshock_output/vox-output10");
  ...
  this->detection_window_width_.set_values(this->param_list_, "io", 
    ...
    "[IMPL] Width of detection window", int(160), int(160)); //int(512), int(512));

  //: Height of detection window
  this->detection_window_height_.set_values(this->param_list_, "io", 
    "detection_window_height", 
    "[IMPL] Height of detection window", int(160), int(160)); //int(512), int(512));
  ...
  this->run_nms_based_on_overlap_.set_values(this->param_list_, "io",
    ...
    "[POSTPROC] Run NMS based on overlap?", false, false);
