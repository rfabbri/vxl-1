...
// \date July 12, 2009
// \brief An algorithm to visualize the results of shock patch matching
//  
// \verbatim
// \endverbatim
...
int main(int argc, char *argv[]) 
{
    ...
    vox_visualize_patch_matches_params_sptr params = 
        new vox_visualize_patch_matches_params("vox_visualize_patch_matches");  
    ...
    //******************** Match Shock Graphs ****************************
    vcl_cout<<"************  Visualize Matches  *************"<<vcl_endl;

    // Kick of process
    bool proc_status(false);
    vox_visualize_patch_matches algo(params);
    ...
    if ( !proc_status )
    {
        ...
        vcl_cerr<<"Visualization of Shock Patch Matches Failed"<<vcl_endl;
        
        // Finish off by updating status results
        params->percent_completed = 0.0f;
        params->exit_code = 1;
        params->exit_message = "Visualization of Shock Patches Failed !";
    ...
    else
    {
        ...
        params->exit_code = 0;
        params->exit_message = 
            "Html files of Matching generated with success!";
        params->print_status_xml();
