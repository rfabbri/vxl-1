%{
This code aims to reconstruc the Lena image by retaining certain points and their intensities from
the original image.
...
subplot(3,2,3);
imagesc(IRr);
title('Reconstructed Image from 5');
