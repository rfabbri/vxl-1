%{
Code to reconstruct Cheetah Image by fixing points using the following methods
1)Maxima and Minima
...
%Read the image, convert to grayscale, and equalise x and y pixels range.
img=imread('E:\USA Trip\Work\Original Images\cheetah.jpg');
img=rgb2gray(img);
img=img(:,1:270);
oimg=img;
