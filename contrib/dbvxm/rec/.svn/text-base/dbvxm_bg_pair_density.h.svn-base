//:
// \file
// \brief dbvxm background pair model 
//
...
#if !defined(_dbvxm_bg_pair_density_H)
#define _dbvxm_bg_pair_density_H
...
class dbvxm_bg_pair_density : public dbvxm_pair_density
{
...
public:
  ...
  //  world, camera etc.
  dbvxm_bg_pair_density(unsigned ni, unsigned nj) : dbvxm_pair_density(), world_(0), cam_(0), 
...
#endif  //_dbvxm_bg_pair_density_H
