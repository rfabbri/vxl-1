// This is contrib/dbvxm/rec/dbvxm_hierarchy_edge.h
#ifndef dbvxm_hierarchy_edge_h_
#define dbvxm_hierarchy_edge_h_
//:
// \file
...
class dbvxm_hierarchy_edge : public dbgrl_edge<dbvxm_part_base> 
{
public:
  ...
  dbvxm_hierarchy_edge(dbvxm_part_base_sptr v1, dbvxm_part_base_sptr v2) : dbgrl_edge<dbvxm_part_base>(v1, v2), to_central_(true), min_stad_dev_dist_(2.0f), min_stad_dev_angle_(10.0f) {};
  ...
  void calculate_dist_angle(dbvxm_part_instance_sptr pi, vnl_vector_fixed<float,2>& dif_to_center, float& dist, float& angle);
