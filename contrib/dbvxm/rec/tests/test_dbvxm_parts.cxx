...
static void test_dbvxm_parts()
{
  ...
  theta = 135.0f;
  TEST("testing dbvxm parts ", extract_gaussian_primitives(img, lambda0, lambda1, theta, bright, 0.1f, 3, parts), true);

  //: construct a hierarchy by hand starting from the primitives, construct one to recognize 8
  dbvxm_part_hierarchy_sptr h_8 = new dbvxm_part_hierarchy();
  ...
  dbvxm_part_gaussian_sptr pi_0_1 = new dbvxm_part_gaussian(0.0f, 0.0f, 0.0f, 2.0f, 1.0f, 90.0f, false, 1);
  ...
  dbvxm_hierarchy_edge_sptr e_1_0_to_central = new dbvxm_hierarchy_edge(p_1_0, p_0_1);
  ...
  dbvxm_hierarchy_edge_sptr e_1_0_to_second = new dbvxm_hierarchy_edge(p_1_0, p_0_1);     //  p_1_0
  ...
  dbvxm_part_hierarchy::generate_map(parts_0_1, map, type_map);
...
*/
  ...
  TEST_NEAR("extracting layer 1", parts_1_0.size(), 5, 0.1);
