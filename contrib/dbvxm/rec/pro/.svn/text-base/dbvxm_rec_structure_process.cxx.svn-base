#include "dbvxm_rec_structure_process.h"
...
dbvxm_rec_structure_process::dbvxm_rec_structure_process()
{
  //inputs
...
bool dbvxm_rec_structure_process::execute()
{
  // Sanity check
  ...
  dbvxm_part_hierarchy::generate_output_img(parts_upper_most, orig_img, output_img);
