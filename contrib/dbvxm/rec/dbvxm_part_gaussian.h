// This is contrib/dbvxm/rec/dbvxm_part_gaussian.h
#ifndef dbvxm_part_gaussian_h_
#define dbvxm_part_gaussian_h_
//:
// \file
...
class dbvxm_part_gaussian : public dbvxm_part_instance {

public:

  dbvxm_part_gaussian(float x, float y, float strength, float lambda0, float lambda1, float theta, bool bright, unsigned type) : dbvxm_part_instance(0, type, dbvxm_part_instance_kind::GAUSSIAN, x, y, strength), lambda0_(lambda0), lambda1_(lambda1), theta_(theta), bright_(bright) {};
