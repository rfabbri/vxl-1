#include "dbvxm_detect_multiscale_process.h"
...
dbvxm_detect_multiscale_process::dbvxm_detect_multiscale_process()
{
...
bool dbvxm_detect_multiscale_process::execute()
{
  ...
  camera=dbvxm_util::downsample_camera( camera, req_scale);
...
vpgl_camera_double_sptr dbvxm_detect_multiscale_process::downsample_camera_by_two(vpgl_camera_double_sptr camera)
{
