...
void dbvxm_util::compute_plane_image_H(vpgl_camera_double_sptr const& cam, bvxm_world_params_sptr world_params, unsigned z_idx, vgl_h_matrix_2d<double> &H_plane_to_image, vgl_h_matrix_2d<double> &H_image_to_plane,unsigned scale)
{
...
void dbvxm_util::bilinear_weights(vgl_h_matrix_2d<double> invH, unsigned nx_out, unsigned ny_out, vnl_matrix<unsigned> &xvals, vnl_matrix<unsigned> &yvals, vnl_matrix<float> &weights)
{
...
vil_image_view_base_sptr dbvxm_util::downsample_image_by_two(vil_image_view_base_sptr image)
{
...
void dbvxm_util::fill_1d_array(vil_image_view<float> const& input,
                          int y, float* output)
{
  unsigned w = input.ni();
...
void dbvxm_util::half_resolution_1d(const float* input, unsigned width,
...
dbvxm_util::half_resolution(vil_image_view<float> const& input,
                                    float filter_coef)
{
...
vpgl_camera_double_sptr dbvxm_util::downsample_camera(vpgl_camera_double_sptr camera,unsigned int scale)
{
...
vpgl_camera_double_sptr dbvxm_util::downsample_persp_camera(vpgl_camera_double_sptr camera,unsigned int scale)
{
