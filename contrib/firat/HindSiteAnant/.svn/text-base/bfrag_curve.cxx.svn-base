...
void bfrag_curve::resample(double ds)
{
  ...
  vcl_cout<<"This fragment not correct"<<vcl_endl;
  }
}
...
void bfrag_curve::resample_coarsely(double ds)
{
  ...
  compute_properties();
	...
	vcl_cout<<"aVp was here"<<vcl_endl;
	}
}
...
{
	//vcl_cout<<"rotate and translate called on"<<vcl_endl;
	//vcl_cout<<this->frag_id_<<vcl_endl;
  this->rotate(angle);
