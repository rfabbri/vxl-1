% This is /lemsvxl/contrib/firat/matlab/fast_curve_matching/scale_invariant_match5.m.

% \file
% \author Firat Kalaycilar (firat@lems.brown.edu)
% \date Feb 15, 2011

function [cf_center, cf_len, cf_rev] = scale_invariant_match5(C1, C2, N, K, num_scales, maxN)
    if mod(N,2) == 0
        N = N+1;
    end
    ...
    for i = round(num_scales/10):num_scales-1
        ...
        R1 = normalized_cross_correlation(S2, S111);
        R2 = normalized_cross_correlation(S2, S121);
