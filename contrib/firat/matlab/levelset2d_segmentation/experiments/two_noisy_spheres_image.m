% This is /lemsvxl/contrib/firat/matlab/levelset2d_segmentation/experiments/two_noisy_spheres_image.m.

% \file
% \author Firat Kalaycilar (firat_kalaycilar@brown.edu)
% \date Sep 16, 2011

function [V, radius, cx, cy, cz] = two_noisy_spheres_image(nrows, ncols, nbands, scale, FG, BG, radius)
    M = nrows*scale;
	N = ncols*scale;
	R = nbands*scale;
	cx = N/2 - 0.8;
