% This is /lemsvxl/contrib/firat/matlab/levelset2d_segmentation/main/maninit_reaction_geodesic_HgradI_contour.m.

% \file
% \author Firat Kalaycilar (firat_kalaycilar@brown.edu)
% \date Aug 14, 2011

function maninit_reaction_geodesic_HgradI_contour(I, beta0, alpha, delta_t, num_iter, reinit_freq, hx, hy)
	narrow_band = 1;
	I = double(I);
	[nrows,ncols] = size(I);
	...
	%figure; imagesc(S);colormap gray; axis image; pause
	...
	%S(mag_F > 0.01) = S(mag_F > 0.01)/10;
	%imagesc(mag_F);axis image; pause
	RUR = 1;
