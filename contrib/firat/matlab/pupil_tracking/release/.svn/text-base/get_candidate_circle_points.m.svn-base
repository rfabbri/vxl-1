...
function points = get_candidate_circle_points(I0, x, y, edge_window, num_neighbors)    
    s = edge_window;
    ...
    if length(sort_index) >= num_neighbors
        hist_index = sort_index(1:num_neighbors);
    else
        hist_index = sort_index;
    end
