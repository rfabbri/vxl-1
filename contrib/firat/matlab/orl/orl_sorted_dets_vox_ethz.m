...
if(0) %use appearance / last funnel stage
    addpath ~/lemsvxl/src/contrib/firat/appearance
    dataset_path = '/vision/projects/kimia/shockshape/symseg/results/ETHZ-dataset/reorganized-data/all_originals';
    det_list = apply_appearance_verification(detection_result_folder, det_list, dataset_path);
end
