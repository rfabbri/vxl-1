...
function [S, mins, maxs, saddles] = get_critical_points(I, sigma)
	%%options
	use_suppression = 0;
	show_points = 1;
	reflect_first = 0;
	...
	if show_points
		...
		hold on;	
		if compute_boundary
			plot(min_c-1, min_r-1, 'o', 'MarkerSize', 5, 'MarkerEdgeColor',[0, 127, 255]/255, 'LineWidth', 2);
			plot(max_c-1, max_r-1, '^', 'MarkerSize', 5, 'MarkerEdgeColor',[0, 127, 255]/255, 'LineWidth', 2);		
			plot(sad_c-1, sad_r-1, '+', 'MarkerSize', 5, 'MarkerEdgeColor',[0, 127, 255]/255, 'LineWidth', 2);	
		else
			...
			plot(sad_c, sad_r, '+', 'MarkerSize', 5, 'MarkerEdgeColor',[0, 127, 255]/255, 'LineWidth', 2);
