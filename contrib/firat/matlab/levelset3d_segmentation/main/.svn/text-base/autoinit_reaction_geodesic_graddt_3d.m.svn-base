% This is /lemsvxl/contrib/firat/matlab/levelset3d_segmentation/main/autoinit_reaction_geodesic_graddt.m.

% \file
% \author Firat Kalaycilar (firat_kalaycilar@brown.edu)
% \date Sep 13, 2011

function phi = autoinit_reaction_geodesic_graddt_3d(I, beta0, alpha, delta_t, max_num_iter, hx, hy, hz, narrow_band, edg, debug_mode)	
	I_orig = I;
