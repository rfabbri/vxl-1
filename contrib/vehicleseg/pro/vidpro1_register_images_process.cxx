...
//: Constructor
vidpro1_register_images_process::vidpro1_register_images_process(void): bpro1_process(),total_xform()
{
...
//: Destructor
vidpro1_register_images_process::~vidpro1_register_images_process()
{
}
...
int
vidpro1_register_images_process::input_frames()
{
    return 1;
}
...
int
vidpro1_register_images_process::output_frames()
{
    return 1;
}
...
//: Clone the process
bpro1_process*
vidpro1_register_images_process::clone() const
{
    return new vidpro1_register_images_process(*this);
}

bool
vidpro1_register_images_process::finish()
{
