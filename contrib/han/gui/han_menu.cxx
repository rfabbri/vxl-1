...
han_menu::setup_menu()
{
  ...
  FILE_MENU_ADD_PROCESS_NAME( "V&C", "Load Video and Con", load_menu );
  ...
  MENU_ADD_PROCESS_NAME( "Cross Ratio Inv Calibration", other_group_menu);

  vgui_menu  cri_group_menu;
  MENU_ADD_PROCESS_NAME( "ACCURATE Edge Cross Ratio Inv Calibration", cri_group_menu);
  MENU_ADD_PROCESS_NAME( "ACCURATE Cross Ratio Inv Calibration", cri_group_menu);
  MENU_ADD_PROCESS_NAME( "Cross Ratio Inv Calibration", cri_group_menu);
   MENU_ADD_PROCESS_NAME( "dbcri_whole", cri_group_menu);///****!!!!!!!!  dbcri_whole and dbcri_whole_flip.... careful!!
  MENU_ADD_PROCESS_NAME( "dbcri_whole_flip", cri_group_menu);///****!!!!!!!!  dbcri_whole and dbcri_whole_flip.... careful!!
  MENU_ADD_PROCESS_NAME( "dbshadow", cri_group_menu);
  

  processes_menu.add( "CRI",  cri_group_menu);
