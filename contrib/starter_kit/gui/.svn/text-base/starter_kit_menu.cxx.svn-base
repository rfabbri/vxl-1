// GUI menu for starter_kit
#include "starter_kit_menu.h"
...
starter_kit_menu::starter_kit_menu() 
{
}
...
starter_kit_menu::setup_menu()
{
  ...
  vgui_menu vsol2D_tools_menu, vsol2D_draw_tools_menu;
    ...
    MENU_ADD_TOOL( bvis_vsol2D_adjust_tool,         vsol2D_tools_menu, bvis_video_manager );
