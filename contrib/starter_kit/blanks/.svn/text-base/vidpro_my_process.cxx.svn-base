// This is contrib/starter_kit/vidpro_my_process.cxx

//:
// \file

#include "vidpro_my_process.h"
...
//: Constructor
vidpro_my_process::vidpro_my_process()
{
...
int
vidpro_my_process::input_frames()
{
...
int
vidpro_my_process::output_frames()
{
...
vidpro_my_process::execute()
{
  ...
  vidpro_image_storage_sptr curr_frame_image, prev_frame_image;
