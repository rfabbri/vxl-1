...
en292_gui_menu::en292_gui_menu() 
{
}

vgui_menu
en292_gui_menu::setup_menu()
{
  vgui_menu MainMenu;
  ...
  vgui_menu  tracking_group_menu; // Tracking across video frames
    MENU_ADD_PROCESS_NAME( "KLT Tracking", tracking_group_menu );
    MENU_ADD_PROCESS_NAME( "Compute Plane Homography", tracking_group_menu );
    MENU_ADD_PROCESS_NAME( "Homography 2D Pre-image", tracking_group_menu );
    MENU_ADD_PROCESS_NAME( "Homography 2D Transform", tracking_group_menu );
    MENU_ADD_PROCESS_NAME( "Compute homography 2D from rectangle", tracking_group_menu );
    MENU_ADD_PROCESS_NAME( "Image Homography Transformation", tracking_group_menu );
  ...
  processes_menu.add( "Feature Tracking",   tracking_group_menu );
  ...
  vgui_menu vsol2D_tools_menu, vsol2D_draw_tools_menu;
    ...
    // MENU_ADD_TOOL( dbsol_arc_tool,  vsol2D_draw_tools_menu );
