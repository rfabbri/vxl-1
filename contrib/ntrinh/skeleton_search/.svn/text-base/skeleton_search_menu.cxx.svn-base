...
#include "skeleton_search_menu.h"
...
#include <dbsks/vis/dbsks_xshock_cost_tool.h>
#include <dbsks/vis/dbsks_examine_graph_cost_tool.h>
#include <dbsks/vis/dbsks_examine_xgraph_cost_tool.h>


skeleton_search_menu::
skeleton_search_menu() 
{
}
...
vgui_menu
skeleton_search_menu::setup_menu()
{
  vgui_menu MainMenu;
  ...
  FILE_MENU_ADD_PROCESS_NAME( "xgraph XML", "Load xgraph XML", load_menu);
  
  FILE_MENU_ADD_PROCESS_NAME( ".CON", "Save .CON File", save_menu);
  FILE_MENU_ADD_PROCESS_NAME( "xgraph XML", "Save xgraph XML", save_menu);
  ...
  vgui_menu  shockshape_group_menu; // symmetry-shape
    ...
    MENU_ADD_PROCESS_NAME( "Fit sksp_xgraph to sk2d_xgraph", shockshape_group_menu );
    MENU_ADD_PROCESS_NAME( "Edit distance between two xgraphs", shockshape_group_menu );
    MENU_ADD_PROCESS_NAME( "Average two xshock graphs", shockshape_group_menu );
    MENU_ADD_PROCESS_NAME( "Resample an xgraph", shockshape_group_menu );
  ...
  vgui_menu  search_igraph_group_menu; // symmetry-shape
    MENU_ADD_PROCESS_NAME( "Compute Symmetry Points", search_igraph_group_menu );
    MENU_ADD_PROCESS_NAME( "Detect Shape", search_igraph_group_menu );
    MENU_ADD_PROCESS_NAME( "Compute arc cost", search_igraph_group_menu );
    MENU_ADD_PROCESS_NAME( "Save arc cost", search_igraph_group_menu );
    MENU_ADD_PROCESS_NAME( "Load arc cost", search_igraph_group_menu );
    MENU_ADD_PROCESS_NAME( "Save DP results", search_igraph_group_menu );
    MENU_ADD_PROCESS_NAME( "Load DP results", search_igraph_group_menu );
    MENU_ADD_PROCESS_NAME( "Load shock graph XML", search_igraph_group_menu);
    MENU_ADD_PROCESS_NAME( "Trace opt graph boundary", search_igraph_group_menu);
    MENU_ADD_PROCESS_NAME( "Local Match", search_igraph_group_menu);
    MENU_ADD_PROCESS_NAME( "Write shapematch to PS", search_igraph_group_menu);
    MENU_ADD_PROCESS_NAME( "Compute shock graph statistics", search_igraph_group_menu);


  vgui_menu  search_xgraph_group_menu; // symmetry-shape
    MENU_ADD_PROCESS_NAME( "Train xshock geometry model", search_xgraph_group_menu );
    MENU_ADD_PROCESS_NAME( "Train xshock ccm model", search_xgraph_group_menu );
...
//  processes_menu.add( "Shape Modelling",  shockshape_group_menu );
  processes_menu.add( "Search igraph",     search_igraph_group_menu );
  processes_menu.add( "Search xgraph",     search_xgraph_group_menu );
...
//
  ...
  vgui_menu dbsks_tools_menu;
    ...
    MENU_ADD_TOOL( dbsks_xshock_cost_tool, dbsks_tools_menu );
    MENU_ADD_TOOL( dbsks_examine_xgraph_cost_tool, dbsks_tools_menu );
  ...
  tools.add("Skeleton Search", dbsks_tools_menu);
