...
#include    "dbseg_mean_shift_msImageProcessor.h"
...
dbseg_mean_shift_msImageProcessor::dbseg_mean_shift_msImageProcessor( void )
{
...
void dbseg_mean_shift_msImageProcessor::DefineImage(byte *data_, imageType type, int height_, int width_)
{
...
void dbseg_mean_shift_msImageProcessor::DefineBgImage(byte* data_, imageType type, int height_, int width_)
{
...
void dbseg_mean_shift_msImageProcessor::SetWeightMap(float *wm, float eps)
{
...
void dbseg_mean_shift_msImageProcessor::RemoveWeightMap( void )
{
...
void dbseg_mean_shift_msImageProcessor::Filter(int sigmaS, float sigmaR, SpeedUpLevel speedUpLevel)
{
...
void dbseg_mean_shift_msImageProcessor::FuseRegions(float sigmaS, int minRegion)
{
...
void dbseg_mean_shift_msImageProcessor::Segment(int sigmaS, float sigmaR, int minRegion, SpeedUpLevel speedUpLevel)
{
...
void dbseg_mean_shift_msImageProcessor::RGBtoLUV(byte *rgbVal, float *luvVal)
{
...
void dbseg_mean_shift_msImageProcessor::LUVtoRGB(float *luvVal, byte *rgbVal)
{
...
void dbseg_mean_shift_msImageProcessor::GetRawData(float *outputImageData)
{
...
void dbseg_mean_shift_msImageProcessor::GetResults(byte *outputImage)
{
...
RegionList *dbseg_mean_shift_msImageProcessor::GetBoundaries( void )
{
...
int dbseg_mean_shift_msImageProcessor::GetRegions(int **labels_out, float **modes_out, int **MPC_out)
{
...
void dbseg_mean_shift_msImageProcessor::NonOptimizedFilter(float sigmaS, float sigmaR)
{
...
void dbseg_mean_shift_msImageProcessor::OptimizedFilter1(float sigmaS, float sigmaR)
{
...
void dbseg_mean_shift_msImageProcessor::OptimizedFilter2(float sigmaS, float sigmaR)
{
...
void dbseg_mean_shift_msImageProcessor::Connect( void )
{
...
void dbseg_mean_shift_msImageProcessor::Fill(int regionLoc, int label)
{
...
void dbseg_mean_shift_msImageProcessor::BuildRAM( void )
{
...
void dbseg_mean_shift_msImageProcessor::DestroyRAM( void )
{
...
void dbseg_mean_shift_msImageProcessor::TransitiveClosure( void )
{
...
void dbseg_mean_shift_msImageProcessor::ComputeEdgeStrengths( void )
{
...
void dbseg_mean_shift_msImageProcessor::Prune(int minRegion)
{
...
void dbseg_mean_shift_msImageProcessor::DefineBoundaries( void )
{
...
bool dbseg_mean_shift_msImageProcessor::InWindow(int mode1, int mode2)
{
    int        k        = 1, s    = 0, p;
    double    diff    = 0, el;
...
float dbseg_mean_shift_msImageProcessor::SqDistance(int mode1, int mode2)
{
...
void dbseg_mean_shift_msImageProcessor::InitializeOutput( void )
{
...
void dbseg_mean_shift_msImageProcessor::DestroyOutput( void )
{
...
// NEW
void dbseg_mean_shift_msImageProcessor::NewOptimizedFilter1(float sigmaS, float sigmaR)
{
    // Declare Variables
...
// NEW
void dbseg_mean_shift_msImageProcessor::NewOptimizedFilter2(float sigmaS, float sigmaR)
{
    // Declare Variables
    int        iterationCount, i, j, k, modeCandidateX, modeCandidateY, modeCandidate_i;
    double    mvAbs, diff, el;
...
void dbseg_mean_shift_msImageProcessor::NewNonOptimizedFilter(float sigmaS, float sigmaR)
{
...
void dbseg_mean_shift_msImageProcessor::SetSpeedThreshold(float speedUpThreshold)
{
