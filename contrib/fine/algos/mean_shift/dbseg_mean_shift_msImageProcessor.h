...
#ifndef dbseg_mean_shift_msImageProcessor_H
#define dbseg_mean_shift_msImageProcessor_H

//include mean shift library
#include    "dbseg_mean_shift_ms.h"
...
//define prototype
class dbseg_mean_shift_msImageProcessor: public MeanShift {
...
public:
  ...
  dbseg_mean_shift_msImageProcessor( void );        //Default Constructor
 ~dbseg_mean_shift_msImageProcessor( void );        //Class Destructor
