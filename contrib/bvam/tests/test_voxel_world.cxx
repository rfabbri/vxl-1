...
static void test_voxel_world()
{
 ...
 bvam_world_params::appearance_model_type apm_type = bvam_world_params::mog_grey;
  ...
  // create the world
  bvam_voxel_world world;
  world.set_params(params);

  // initialize the data
  bvam_mog_grey_processor::apm_datatype init_apm;
 ...
 /* float init_ocp = 1.0f/120;
  ...
  // run the executable for the test file from lemsvxl/build/contrib/bvam/tests/  to find the following cam file
  ...
  // run the executable for the test file from lemsvxl/build/contrib/bvam/tests/
  ...
  //create metadata:
  bvam_image_metadata observation(view_sptr,camera);
