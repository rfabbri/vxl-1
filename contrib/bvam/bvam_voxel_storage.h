#ifndef bvam_voxel_storage_h_
#define bvam_voxel_storage_h_
...
template<class T> 
class bvam_voxel_storage
{
public:
  //: Constructor
  bvam_voxel_storage(vgl_vector_3d<unsigned int> grid_size) : grid_size_(grid_size) {}
  virtual ~bvam_voxel_storage(){};
  ...
  virtual bvam_voxel_slab<T> get_slab(unsigned slice_idx, unsigned slab_thickness) = 0;
