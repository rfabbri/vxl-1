...
bvam_rpc_registration_process::bvam_rpc_registration_process()
{
...
bool bvam_rpc_registration_process::execute()
{
  // Sanity check
  ...
  if(rpc_correction_flag){
    ...
    bvam_image_metadata camera_metadata_inp(dummy_img,camera_inp);
  ...
  bvam_image_metadata camera_metadata_out(cedt_image_sptr,camera_inp);
