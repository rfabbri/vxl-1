#include "bvam_roi_init_process.h"
...
bvam_roi_init_process::bvam_roi_init_process()
{
...
bool bvam_roi_init_process::execute()
{
  ...
  bvam_voxel_world_sptr voxel_world = input2->value();
  ...
  bvam_world_params_sptr world_params = voxel_world->get_params();
...
vgl_box_2d<double>*
bvam_roi_init_process::project_box(vpgl_rational_camera<double>* cam,
                                                  bgeo_lvcs_sptr lvcs, 
