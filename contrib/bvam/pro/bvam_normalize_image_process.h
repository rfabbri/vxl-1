// This is /pro/bvam_normalize_image_process.h
#ifndef bvam_normalize_image_process_h_
#define bvam_normalize_image_process_h_
...
class bvam_normalize_image_process : public bprb_process
{
 public:
  ...
  bvam_normalize_image_process();

  //: Copy Constructor (no local data)
  bvam_normalize_image_process(const bvam_normalize_image_process& other): bprb_process(*static_cast<const bprb_process*>(&other)){};
