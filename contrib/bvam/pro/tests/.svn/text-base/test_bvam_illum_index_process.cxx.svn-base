...
#include "../bvam_illum_index_process.h"
...
MAIN( test_bvam_illum_index_process )
{
  ...
  // 1. Run process using Process Manager
  {
    ...
    bool good = bprb_batch_process_manager::instance()->init_process("BvamIllumIndexProcess");
  ...
  {
    bvam_illum_index_process *p1 = new bvam_illum_index_process();
