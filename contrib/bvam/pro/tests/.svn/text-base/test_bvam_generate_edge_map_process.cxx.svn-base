...
MAIN( test_bvam_generate_edge_map_process )
{
  ...
  bool good = bprb_batch_process_manager::instance()->init_process("BvamGenerateEdgeMapProcess");
  ...
  TEST("run bvam_generate_edge_map_process", good ,true);
