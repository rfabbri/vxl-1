...
#include "../bvam_change_detection_display_process.h"
...
MAIN( test_bvam_change_detection_display_process )
{
  REG_PROCESS(bvam_change_detection_display_process, bprb_batch_process_manager);
  ...
  bool good = bprb_batch_process_manager::instance()->init_process("BvamChangeDetectionDisplayProcess");
