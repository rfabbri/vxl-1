#include "bvam_render_expected_image_process.h"
...
bvam_render_expected_image_process::bvam_render_expected_image_process()
{
...
bool bvam_render_expected_image_process::execute()
{
  ...
  brdb_value_t<bvam_voxel_world_sptr>* input1 = 
  ...
  bvam_image_metadata camera_metadata(dummy_img,camera);
  //render image
  bool result;
