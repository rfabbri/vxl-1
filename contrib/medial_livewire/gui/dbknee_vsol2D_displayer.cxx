// This is breye1/bvis1/displayer/dbknee_vsol2D_displayer.cxx
...
vgui_tableau_sptr
dbknee_vsol2D_displayer::make_tableau( bpro1_storage_sptr storage) const
{
  ...
  if(!vsol2D_storage->attributes_defined()||!mapper_)
    {
      ...
      style_vector.push_back(vgui_style::new_style(1,0,0, 1.5, 1.5));
      style_vector.push_back(vgui_style::new_style(0,1,0, 1.5, 1.5));
      style_vector.push_back(vgui_style::new_style(0,0,1, 1.5, 1.5));
      style_vector.push_back(vgui_style::new_style(0,0.5,0.5, 1.5, 1.5));
      style_vector.push_back(vgui_style::new_style(0.5,0,0.5, 1.5, 1.5));
      style_vector.push_back(vgui_style::new_style(0.0,0.5,0.5, 1.5, 1.5));

      char ind = *vsol2D_storage->name().rbegin();
