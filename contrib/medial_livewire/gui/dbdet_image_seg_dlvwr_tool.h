// This is brcv/seg/dbdet/vis/dbdet_image_seg_dlvwr_tool.h
#ifndef dbdet_image_seg_dlvwr_tool_h_
#define dbdet_image_seg_dlvwr_tool_h_
//:
// \file
// \brief 
...
enum dbdet_image_seg_state{
  image_seg_NORMAL,
  image_seg_CHANGE_PARAMS
};

//: An abstract base class for tools in this file
class dbdet_image_seg_dlvwr_tool : public dbdet_image_seg_tool
{
public:
  ...
  //: Set current state
  void set_current_state( const dbdet_image_seg_state& new_state )
...
protected:
  ...
  dbdet_image_seg_state current_state_;
...
#endif // dbdet_image_seg_dlvwr_tool_h_
