...
//#include <dbsol/vis/dbsol_arc_tool.h>


levelset_seg_menu::levelset_seg_menu() 
{
}
...
levelset_seg_menu::setup_menu()
{
  ...
  MENU_ADD_PROCESS_NAME( "Binary Osl Canny edges", edge_detection_group_menu );
  MENU_ADD_PROCESS_NAME( "Geodesic Active Contour", edge_detection_group_menu );
  MENU_ADD_PROCESS_NAME( "Knee cartilage seg", edge_detection_group_menu );
