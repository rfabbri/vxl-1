// This is dbrl/dbbas/dbocl/opencl_manager.txx
#ifndef opencl_manager_txx_
#define opencl_manager_txx_
...
template <class T>
T* opencl_manager<T>::instance()
{
  if (!instance_) {
    instance_ = new T();
    instance_->initialize_cl();
  }
  return opencl_manager::instance_;
}

template <class T>
void opencl_manager<T>::clear_cl()
{
...
//: Destructor
template <class T>
opencl_manager<T>::~opencl_manager()
{
  this->clear_cl();
}
...
template <class T>
bool opencl_manager<T>::initialize_cl()
{
...
#undef OPENCL_MANAGER_INSTANTIATE
#define OPENCL_MANAGER_INSTANTIATE(T) \
template <class T > T* opencl_manager<T >::instance_ = 0; \
template class opencl_manager<T >


#endif // opencl_manager_txx_
