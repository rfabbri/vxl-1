...
int main(int argc, char* argv[])
{
  ...
  dbpro_db_value_t<dbpro_storage_sptr> dbpro_storage_sptr_examplar;
//  dbpro_db_value_t<double> double_examplar(10.56);
  dbpro_db_value_t<bool> bool_example(false);
  ...
  dbpro_db_value_t<vcl_string> string_val("I am a string");
  ...
  if(float_val.is_a() == vcl_string("float") && string_val == vcl_string("I am a string"))
  {
