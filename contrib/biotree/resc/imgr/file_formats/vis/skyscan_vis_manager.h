//: This is /contrib/biotree/resc/imgr/file_formats/vis/skyscan_vis_manager.h

#ifndef skyscan_vis_manager_h_
#define skyscan_vis_manager_h_
//:
// \file
// \brief  Manager for displaying SkyScan files
// \author H. Can Aras
//
...
class skyscan_vis_manager : public vgui_wrapper_tableau
{
public:
  typedef vgui_wrapper_tableau base;
  skyscan_vis_manager();
  ~skyscan_vis_manager();
  static skyscan_vis_manager *instance();
  void quit();
  void load_view_3d();
  void init();
...
private:
  ...
  vcl_vector< vgl_box_2d<double> > img_filter_box_;
