...
#include "spatemp_backward_beta_process.h"
...
//: Constructor
spatemp_backward_beta_process::spatemp_backward_beta_process(void): bpro1_process()
    {
...
//: Destructor
spatemp_backward_beta_process::~spatemp_backward_beta_process()
    {
...
int
spatemp_backward_beta_process::input_frames()
    {
        int nframes=1;
...
void
spatemp_backward_beta_process::set_forward_input_frames()
    {
...
int
spatemp_backward_beta_process::output_frames()
    {
    return 1;
    }
...
//: Execute the process
bool
spatemp_backward_beta_process::execute()
    {
        int nframes=1;
        parameters()->get_value("-nframes",nframes);
...
//: Clone the process
bpro1_process*
spatemp_backward_beta_process::clone() const
{
    return new spatemp_backward_beta_process(*this);
}

bool
spatemp_backward_beta_process::finish()
{
    return true;
}
