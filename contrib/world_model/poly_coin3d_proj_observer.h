#ifndef poly_coin3d_proj_observer_h_
#define poly_coin3d_proj_observer_h_
...
class poly_coin3d_proj_observer : public vgui_observer, public bgui3d_project2d_tableau
{
public:
  //: constructors
  poly_coin3d_proj_observer(const vpgl_proj_camera<double>& camera,
                            SoNode* scene_root = NULL);

  virtual ~poly_coin3d_proj_observer() {}
