...
bool texture_map_generator::generate_texture_map(obj_observable* obj, vcl_string texture_filename, bgeo_lvcs lvcs)
{
  ...
  dbmsh3d_textured_mesh_mc* mesh = new dbmsh3d_textured_mesh_mc(obj->get_object());
...
vgl_vector_3d<double> texture_map_generator::compute_face_normal_lvcs(dbmsh3d_face* face, bgeo_lvcs lvcs) {
  ...
  double vx,vy,vz;
  dbmsh3d_vertex* last_v = (dbmsh3d_vertex*) verts.back();
  ...
  for (unsigned i=0; i < verts.size(); i++) {
    dbmsh3d_vertex* v = (dbmsh3d_vertex*) verts[i];
