...
utm_lat_lon::utm_lat_lon()
  :   _a(6378137), _b(6356752.3142) //WGS-84 by default
{}

utm_lat_lon::utm_lat_lon(const utm_lat_lon& t)
  :    _a(t._a), _b(t._b)
{}
...
void utm_lat_lon::transform(int utm_zone, double x, double y, double z,
...
void utm_lat_lon::transform(int utm_zone, double x, double y,
...
void utm_lat_lon::transform(double lat, double lon,
