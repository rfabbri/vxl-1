// This is bm/bmocl/bmocl_manager.cxx


#include "bmocl_manager.h"
//:
// \file
...
bmocl_manager* bmocl_manager::instance_ = NULL;
bmocl_manager* bmocl_manager::instance()
{
  if (!instance_) {
    instance_ = new bmocl_manager();
    instance_->initialize_cl();
  }
  return bmocl_manager::instance_;
}


void bmocl_manager::clear_cl()
{
...
//: Destructor
bmocl_manager::~bmocl_manager()
{
  this->clear_cl();
}


bool bmocl_manager::initialize_cl()
{
