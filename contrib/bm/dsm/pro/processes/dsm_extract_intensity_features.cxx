//this is /contrib/bm/dsm/pro/processes/dsm_extract_intensity_features.cxx
...
bool dsm_extract_intensity_features_process_cons(bprb_func_process& pro)
{
	...
	return true;
}//end dsm_extract_intensity_features_process_cons

bool dsm_extract_intensity_features_process(bprb_func_process& pro)
{
	using namespace dsm_extract_intensity_features_globals;
	...
	features_sptr->extract_intensity_features();

	pro.set_output_val(0,features_sptr);

	return true;
}//end dsm_extract_intensity_features_process
