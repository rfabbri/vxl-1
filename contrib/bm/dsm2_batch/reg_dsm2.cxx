//this is /contrib/bm/dsm2_batch/reg_dsm2.cxx
#include"reg_dsm2.h"
...
register_processes(PyObject *self, PyObject *args)
{
	...
	dsm2_register::register_process();
	vil_register::register_process();
    dts_register::register_process();
	Py_INCREF(Py_None);
	return Py_None;
}
...
register_datatypes(PyObject *self, PyObject *args)
{
	...
	dsm2_register::register_datatype();
	vil_register::register_datatype();
    dts_register::register_datatype();
	Py_INCREF(Py_None);
	return Py_None;
}
	...
	initdsm2_batch(void)
{
	...
	dsm2_batch_methods[0] = reg_pro;
	dsm2_batch_methods[1] = reg_data;
	
	for( int i = 0; i < METHOD_NUM; ++i )
		dsm2_batch_methods[i+2] = batch_methods[i];

	Py_InitModule("dsm2_batch", dsm2_batch_methods);
