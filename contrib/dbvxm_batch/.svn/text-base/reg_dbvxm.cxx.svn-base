#include <bseg/bvxm_batch/batch_bvxm.h>
#include <bprb/bprb_macros.h>
#include <bprb/bprb_batch_process_manager.h>
#include <dbvxm/pro/dbvxm_detect_scale_process.h>
#include <dbvxm/pro/dbvxm_create_multiscale_voxel_world_process.h>
#include <dbvxm/pro/dbvxm_update_multiscale_process.h>
#include <dbvxm/pro/dbvxm_detect_multiscale_process.h>

#include <dbvxm/dbvxm_multi_scale_voxel_world.h>
#include <dbvxm/pro/bvxm_save_multiscale_occupancy_raw_process.h>

#include <dbvxm/pro/dbvxm_detect_instance_process.h>
#include <dbvxm/pro/dbvxm_register_feature_process.h>

#include <dbvxm/rec/pro/dbvxm_rec_update_changes_process.h>
#include <dbvxm/rec/pro/dbvxm_rec_density_to_prob_map_process.h>
#include <dbvxm/rec/pro/dbvxm_prob_map_roc_compute_process.h>
#include <dbvxm/rec/pro/dbvxm_prob_map_threshold_process.h>
#include <dbvxm/rec/pro/dbvxm_rec_structure_process.h>
#include <dbvxm/rec/pro/dbvxm_prob_map_supress_process.h>
#include <dbvxm/rec/pro/dbvxm_prob_map_area_process.h>
...
register_processes(PyObject *self, PyObject *args)
{
  ...
  REG_PROCESS(dbvxm_create_multiscale_voxel_world_process, bprb_batch_process_manager);
  REG_PROCESS(dbvxm_update_multiscale_process, bprb_batch_process_manager);
  REG_PROCESS(dbvxm_detect_multiscale_process, bprb_batch_process_manager);
  REG_PROCESS(dbvxm_detect_instance_process, bprb_batch_process_manager);
  REG_PROCESS(dbvxm_register_feature_process, bprb_batch_process_manager);
  REG_PROCESS(dbvxm_rec_update_changes_process, bprb_batch_process_manager);
  REG_PROCESS(dbvxm_prob_map_roc_compute_process, bprb_batch_process_manager);
  REG_PROCESS(dbvxm_rec_density_to_prob_map_process, bprb_batch_process_manager);
  REG_PROCESS(dbvxm_rec_structure_process, bprb_batch_process_manager);
  REG_PROCESS(dbvxm_prob_map_threshold_process, bprb_batch_process_manager);
  REG_PROCESS(dbvxm_prob_map_supress_process, bprb_batch_process_manager);
  REG_PROCESS(dbvxm_prob_map_area_process, bprb_batch_process_manager);
...
register_datatypes(PyObject *self, PyObject *args)
{
  ...
  REGISTER_DATATYPE( dbvxm_multi_scale_voxel_world_sptr );
