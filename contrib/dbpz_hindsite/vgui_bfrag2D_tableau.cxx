...
void vgui_bfrag2D_tableau::add_popup(vgui_menu& menu){
    ...
    if( myIndex != -1 && numPairs > 1){
        ...
        //popup.add( "&Change Importance of this Pair", changeOrdering, (vgui_key)'C', vgui_CTRL ); 
        // vgui_command_bound_method< object_t, data_t >::action_t)(data_t)
        //do a move UP and a move DOWN??
        ...
        //deletion choices
        vgui_menu deleteMenu;
            deleteMenu.add( "This One", new vgui_command_simple<vgui_bfrag2D_tableau>(this,&vgui_bfrag2D_tableau::deleteMePuzzle) );
            deleteMenu.add( "All Selected", new vgui_command_simple<vgui_bfrag2D_tableau>(this,&vgui_bfrag2D_tableau::deleteSelectedPuzzles) );
        menu.add( "Delete...", deleteMenu );
    }
...
void vgui_bfrag2D_tableau::addCurve( Curve<double,double>* theCurve, const vgui_style_sptr& style ){
    ...
    for (int i=0; i < theCurve->numPoints(); i++) {
        curPoint = theCurve->point(i);
        //add_vertex(x,y);
        vsol_point_2d_sptr newPt = new vsol_point_2d (curPoint.x(), curPoint.y());
