...
int bfrag2D::loadCEM( vcl_string fn, vsol_polygon_2d_sptr &givenContour, Curve<double,double> &givenCurve ){
...
int bfrag2D::loadCON( vcl_string fn, vsol_polygon_2d_sptr &givenContour, Curve<double,double> &givenCurve ){
...
void bfrag2D::calcCenter(){
    ...
    //vcl_cout << "x [min/max] : [" << minX << "," << maxX << "]    y : [" << minY << "," << maxY << "]" << vcl_endl;
    //vcl_cout << "center is: (" << _centerX << "," << _centerY << ")" << vcl_endl;
