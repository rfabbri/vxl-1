...
bvis1_brown_eyes_menu::setup_menu()
{
  ...
  vgui_menu  dbccl_group_menu; // Camera computation
    MENU_ADD_PROCESS_NAME( "Manual Camera Computation", dbccl_group_menu );
  ...
  processes_menu.add( "Camera Computation", dbccl_group_menu);
