...
for i = 1:data.imnum
    ...
    if DEBUG
        imwrite(full(data.edgemap{i}), ['../debug/frog_edge67/' 'edgemap_' int2strfixed(i,4) '.png']);
    end
...
if DEBUG
    save('../debug/frog_edge67/programdata.mat');
end

[pts3drawcell, confrawcell] = struct_from_sil(data,1,10,'frog_edge67');
