...
for i = 1:data.imnum
    ...
    if DEBUG
        imwrite(full(data.edgemap{i}), ['../debug/pig_edge42/' 'edgemap_' int2strfixed(i,4) '.png']);
    end
...
if DEBUG
    save('../debug/pig_edge42/programdata.mat');
end

[pts3drawcell, confrawcell] = struct_from_sil(data,1,10,'pig_edge42');
