#ifndef _dbrl_match_set_storage_
#define _dbrl_match_set_storage_

#include <bpro1/bpro1_storage.h>
#include <georegister/dbrl_match_set_sptr.h>
#include "dbrl_match_set_storage_sptr.h"

class dbrl_match_set_storage: public bpro1_storage
    {
    public:
...
//: Create a smart-pointer to a dbrl_match_set_storage.
struct dbrl_match_set_storage_new : public dbrl_match_set_storage_sptr
{
  typedef dbrl_match_set_storage_sptr base;

  //: Constructor - creates a default dbbgm_distribution_image_storage_sptr.
  dbrl_match_set_storage_new() : base(new dbrl_match_set_storage()) { }

  //: Constructor - creates a dbbgm_distribution_image_storage_sptr with data.
  dbrl_match_set_storage_new(const dbrl_match_set_sptr & dms)
   : base(new dbrl_match_set_storage(dms)) { }
};
