// This is pro/dbrl_edge_point_tangent_bg_model_process.cxx

//:
// \file
#include "dbrl_edge_point_tangent_bg_model_process.h"
...
//: Constructor
dbrl_edge_point_tangent_bg_model_process::dbrl_edge_point_tangent_bg_model_process(): model_(NULL)
{
...
//: Destructor
dbrl_edge_point_tangent_bg_model_process::~dbrl_edge_point_tangent_bg_model_process()
{
...
int
dbrl_edge_point_tangent_bg_model_process::input_frames()
{
    return 1;
}
...
int
dbrl_edge_point_tangent_bg_model_process::output_frames()
{
    return 1;
}
...
//: Execute the process
bool
dbrl_edge_point_tangent_bg_model_process::execute()
{
...
//: Clone the process
bpro1_process*
dbrl_edge_point_tangent_bg_model_process::clone() const
{
    return new dbrl_edge_point_tangent_bg_model_process(*this);
}

bool
dbrl_edge_point_tangent_bg_model_process::finish()
{
