...
////: A tool for corresponding lines
class bvis1_correspond_line_tool : public bvis1_tool {
public:
  
  //: Constructor
  bvis1_correspond_line_tool( const vgui_event_condition& 
                              select = vgui_event_condition(vgui_LEFT, 
                                                            vgui_MODIFIER_NULL, 
                                                            true) );
  //: Destructor
  virtual ~bvis1_correspond_line_tool();
...
protected:
  ...
  bool set_curr_corr(const bgui_vsol_soview2D_line_seg* pt);
  ...
  bool modify_;
  bgui_vsol_soview2D_line_seg* object_;
  ...
  class corr_map : public vcl_map<vgui_displaylist2D_tableau_sptr, bgui_vsol_soview2D_line_seg*>
  {
   public:
    corr_map() : vcl_map<vgui_displaylist2D_tableau_sptr, bgui_vsol_soview2D_line_seg*>() {}
  };
