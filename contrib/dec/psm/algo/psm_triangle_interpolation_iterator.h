...
template<class T>
class psm_triangle_interpolation_iterator : public vgl_region_scan_iterator
{
public:
  //: constructor
  psm_triangle_interpolation_iterator(double *verts_x, double *verts_y, T *values, unsigned int v0 = 0, unsigned int v1 = 1, unsigned int v2 = 2);
