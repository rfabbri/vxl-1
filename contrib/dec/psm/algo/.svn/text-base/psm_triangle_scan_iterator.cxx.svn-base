...
//: constructor
psm_triangle_scan_iterator::psm_triangle_scan_iterator(double *verts_x, double *verts_y, unsigned int v0, unsigned int v1, unsigned int v2)
: tri_it_()
{
...
void psm_triangle_scan_iterator::reset()
{
  tri_it_.reset();
}
...
bool psm_triangle_scan_iterator::next()
{
  return tri_it_.next();
}

//: y-coordinate of the current scan line.
int psm_triangle_scan_iterator::scany() const
{
...
int psm_triangle_scan_iterator::startx() const
{
...
int  psm_triangle_scan_iterator::endx() const
{
