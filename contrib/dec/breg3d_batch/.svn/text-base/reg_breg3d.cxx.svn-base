...
#include <breg3d/pro/breg3d_ekf_camera_optimize_process.h>
#include <breg3d/pro/breg3d_init_ekf_camera_optimizer_process.h>
#include <breg3d/pro/breg3d_init_ekf_camera_optimizer_planar_process.h>
#include <breg3d/pro/breg3d_set_occupancy_plane_process.h>
#include <breg3d/pro/breg3d_zero_occupancy_borders_process.h>
...
register_processes(PyObject *self, PyObject *args)
{
  ...
  REG_PROCESS(breg3d_ekf_camera_optimize_process, bprb_batch_process_manager);
  REG_PROCESS(breg3d_init_ekf_camera_optimizer_process, bprb_batch_process_manager);
  REG_PROCESS(breg3d_init_ekf_camera_optimizer_planar_process, bprb_batch_process_manager);
  REG_PROCESS(breg3d_set_occupancy_plane_process, bprb_batch_process_manager);
  REG_PROCESS(breg3d_zero_occupancy_borders_process, bprb_batch_process_manager);
...
register_datatypes(PyObject *self, PyObject *args)
{
  ...
  REGISTER_DATATYPE( breg3d_ekf_camera_optimizer_state );
  Py_INCREF(Py_None);
  return Py_None;
}
