...
world_dir = "/Volumes/Experiments/object_recognition/bvpl/CapitolSiteHigh/world_dan"
results_dir ="/Volumes/Experiments/object_recognition/bvpl/CapitolSiteHigh/world_dan";


print("------------------------------------------")
print("Merging Mixtures");
bvxm_batch.init_process("bvxmMergeMogProcess");
bvxm_batch.set_input_string(0,world_dir + "/apm_mog_grey_bin_0_scale_0.vox");
