...
visualize_all = 1;
non_max = 1;
data_dir =  "c:/Experiments/object_recognition/bvpl/CapitolSiteHigh_sfm/few_windows/corner2d_apm/0+45-360_plane_010_scale_442"
output_dir = "c:/Experiments/object_recognition/bvpl/CapitolSiteHigh_sfm/few_windows/corner2d_apm/0+45-360_plane_010_scale_442/non_max"
...
bvpl_batch.set_input_unsigned(0, 4);  #half length
...
if (not(non_max)):
  ...
  output_dir = "c:/Experiments/object_recognition/bvpl/CapitolSiteHigh_sfm/front_wall/results/corner2d_apm/0+45-360_plane_010_scale_221"
  if visualize_all :
