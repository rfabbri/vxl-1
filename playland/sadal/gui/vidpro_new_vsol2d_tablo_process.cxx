// This is playland/sadal/vidpro_new_vsol2d_tablo_process.cxx

//:
// \file

#include "vidpro_new_vsol2d_tablo_process.h"
...
//: Constructor
vidpro_new_vsol2d_tablo_process::vidpro_new_vsol2d_tablo_process()
{
...
vidpro_process* vidpro_new_vsol2d_tablo_process:: clone() const
{
    return new vidpro_new_vsol2d_tablo_process(*this);
}

//: Return the name of this process
vcl_string
vidpro_new_vsol2d_tablo_process::name()
{
...
int
vidpro_new_vsol2d_tablo_process::input_frames()
{
...
int
vidpro_new_vsol2d_tablo_process::output_frames()
{
...
vidpro_new_vsol2d_tablo_process::get_input_type()
{
...
vcl_vector< vcl_string > 
vidpro_new_vsol2d_tablo_process::get_output_type()
{  
...
//: Execute the process
bool
vidpro_new_vsol2d_tablo_process::execute()
{
  // verify that the number of input frames is correct
  if ( input_data_.size() != 0 ){
    vcl_cout << "In vidpro_new_vsol2d_tablo_process::execute() - not exactly"
...
//: Finish
bool
vidpro_new_vsol2d_tablo_process::finish()
{
